...
function thirdScreen() {
    ...
    popupContent.innerHTML = `
      <div class="sun" id="screen3">
        <div class="popup-content-header">
          <h2>Size and Dimensions</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Sun size and dimensions paragraph
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function fourthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="sun" id="screen4">
        <div class="popup-content-header">
          <h2>No Life on Sun</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about life on Sun
          </p>
        </div>
...
function fifthScreen() {
    const popupContent = document.querySelector('.popup-content');
    popupContent.innerHTML = `
      <div class="sun" id="screen5">
        <div class="popup-content-header">
          <h2>Surface of Sun</h2>
        </div>
        <div class="popup-content-body">
          <p>
           Paragraph about the surface of Sun
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function sixthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="sun" id="screen6">
        <div class="popup-content-header">  
          <h2>Orbit and Rotation</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about Sun's orbit and rotation
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function seventhScreen() {
  ...
  popupContent.innerHTML = `
  <div class="sun" id="screen7">
    <div class="popup-content-header">  
      <h2>Structure of Sun</h2>
    </div>
    <div class="popup-content-body">
      <p>
        Paragraph about the Structure of Sun
      </p>
    </div>
    <div class="popup-buttons">
      <button id="prevButton">Previous</button>
...
function eighthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="sun" id="screen8">
        <div class="popup-content-header">
        <h2>No Moons Orbiting Sun</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the moons orbiting Sun
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function ninthScreen() {
    ...
    popupContent.innerHTML = `
    <div class="sun" id="screen9">
      <div class="popup-content-header">
        <h2>Rings of Sun</h2>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about the rings of Sun
        </p>
      </div>
      <div class="popup-buttons">
        <button id="prevButton">Previous</button>
...
function tenthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="sun" id="screen10">
        <div class="popup-content-header">
          <h2>Sun's Atmosphere</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the atmosphere of Sun
          </p>
          </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>

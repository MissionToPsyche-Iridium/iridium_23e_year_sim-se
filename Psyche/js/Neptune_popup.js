...
* Neptune_popup.js
* 
* This Neptune_popup.js creates the popup windows that display information to the user. The user
...
function firstScreen() {
    ...
    <div class="neptune" id="screen1">
        <h1>Neptune</h1>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about Neptune
        </p>
      </div>
...
function thirdScreen() {
    ...
    popupContent.innerHTML = `
      <div class="neptune" id="screen3">
        <div class="popup-content-header">
          <h2>Size and Dimensions</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Neptune size and dimensions paragraph
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function fourthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="neptune" id="screen4">
        <div class="popup-content-header">
          <h2>No Life on Neptune</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about life on Neptune
          </p>
        </div>
...
function fifthScreen() {
    const popupContent = document.querySelector('.popup-content');
    popupContent.innerHTML = `
      <div class="neptune" id="screen5">
        <div class="popup-content-header">
          <h2>Surface of Neptune</h2>
        </div>
        <div class="popup-content-body">
          <p>
           Paragraph about the surface of Neptune
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function sixthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="neptune" id="screen6">
        <div class="popup-content-header">  
          <h2>Orbit and Rotation</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about Neptune's orbit and rotation
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function seventhScreen() {
  ...
  popupContent.innerHTML = `
  <div class="neptune" id="screen7">
    <div class="popup-content-header">  
      <h2>Structure of Neptune</h2>
    </div>
    <div class="popup-content-body">
      <p>
        Paragraph about the Structure of Neptune
      </p>
    </div>
    <div class="popup-buttons">
      <button id="prevButton">Previous</button>
...
function eighthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="neptune" id="screen8">
        <div class="popup-content-header">
        <h2>No Moons Orbiting Neptune</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the moons orbiting Neptune
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function ninthScreen() {
    ...
    popupContent.innerHTML = `
    <div class="neptune" id="screen9">
      <div class="popup-content-header">
        <h2>Rings of Neptune</h2>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about the rings of Neptune
        </p>
      </div>
      <div class="popup-buttons">
        <button id="prevButton">Previous</button>
...
function tenthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="neptune" id="screen10">
        <div class="popup-content-header">
          <h2>Neptune's Atmosphere</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the atmosphere of Neptune
          </p>
          </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>

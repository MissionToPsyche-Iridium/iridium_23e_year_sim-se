...
* Saturn_popup.js
* 
* This Saturn_popup.js creates the popup windows that display information to the user. The user
...
function thirdScreen() {
    ...
    popupContent.innerHTML = `
      <div class="saturn" id="screen3">
        <div class="popup-content-header">
          <h2>Size and Dimensions</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Saturn size and dimensions paragraph
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function fourthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="Saturn" id="screen4">
        <div class="popup-content-header">
          <h2>No Life on Saturn</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about life on Saturn
          </p>
        </div>
...
function fifthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="neptune" id="screen5">
        <div class="popup-content-header">
          <h2>Surface of Saturn</h2>
        </div>
        <div class="popup-content-body">
          <p>
           Paragraph about the surface of Saturn
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function sixthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="saturn" id="screen6">
        <div class="popup-content-header">  
          <h2>Orbit and Rotation</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about Saturn's orbit and rotation
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function seventhScreen() {
  ...
  popupContent.innerHTML = `
  <div class="Saturn" id="screen7">
    <div class="popup-content-header">  
      <h2>Structure of Saturn</h2>
    </div>
    <div class="popup-content-body">
      <p>
        Paragraph about the Structure of Saturn
      </p>
    </div>
    <div class="popup-buttons">
      <button id="prevButton">Previous</button>
...
function eighthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="Saturn" id="screen8">
        <div class="popup-content-header">
        <h2>No Moons Orbiting Saturn</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the moons orbiting Saturn
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function ninthScreen() {
    ...
    popupContent.innerHTML = `
    <div class="Saturn" id="screen9">
      <div class="popup-content-header">
        <h2>Rings of Saturn</h2>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about the rings of Saturn
        </p>
      </div>
      <div class="popup-buttons">
        <button id="prevButton">Previous</button>
...
function tenthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="saturn" id="screen10">
        <div class="popup-content-header">
          <h2>Saturn's Atmosphere</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the atmosphere of Saturn
          </p>
          </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>

document.addEventListener("DOMContentLoaded", function() {
    ...
    function createPopup() {
        ...
        <h1>References</h1>
            ...
            <br>
            <ul>
        <div style="font-size: 12px; color: orange">Sponsored by the <a href="https://psyche.asu.edu" target="_blank">NASA Psyche Mission</a></div>
        <div style="font-size: 12px; color: orange">Asteroid model by <a href="https://nasa.gov" target="_blank">NASA</a></div>
        <div style="font-size:12px; color: orange">Simulation inspired by <a href="http://blender.org" target ="_blank">Blender</a></div>
        <div style="font-size: 12px; color: orange">Created with <a href="https://threejs.org/docs/" target="_blank">Three.js</a></div>
            </ul>

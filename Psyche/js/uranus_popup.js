 ...
 * firstScreen
 * 
 * This function populates and displays the first summary information popup for Uranus.
...
function firstScreen() {
    ...
    <div class="uranus" id="screen1">
        <h1>Uranus</h1>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about Uranus
        </p>
      </div>
 ...
 * secondScreen()
 * 
 * This function populates and displays the second summary information popup for Uranus.
 * Information displayed is the Size and Dimensions of Uranus. 
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
 *  none
 ...
 * thirdScreen()
 * 
 * This function populates and displays the third summary information popup for Uranus.
...
function thirdScreen() {
    ...
    popupContent.innerHTML = `
      <div class="uranus" id="screen3">
        <div class="popup-content-header">
          <h2>Size and Dimensions</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Uranus size and dimensions paragraph
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
 ...
 * forthScreen()
 * 
 * This function populates and displays the forth summary information popup for Uranus.
 * No information is populated for this screen currently. 
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
...
function fourthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="uranus" id="screen4">
        <div class="popup-content-header">
          <h2>No Life on Uranus</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about life on Uranus
          </p>
        </div>
 ...
 * fifthScreen()
 * 
 * This function populates and displays the fifth summary information popup for Uranus.
 * No information is populated for this screen currently. 
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
...
function fifthScreen() {
    const popupContent = document.querySelector('.popup-content');
    popupContent.innerHTML = `
      <div class="uranus" id="screen5">
        <div class="popup-content-header">
          <h2>Surface of Uranus</h2>
        </div>
        <div class="popup-content-body">
          <p>
           Paragraphy about the surface of Uranus
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
 ...
 * sixthScreen()
 * 
 * This function populates and displays the sixth summary information popup for Uranus.
 * No information is populated for this screen currently. 
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
...
function sixthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="uranus" id="screen6">
        <div class="popup-content-header">  
          <h2>Orbit and Rotation</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about Uranus' orbit and rotation
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
 ...
 * seventhScreen()
 * 
 * This function populates and displays the seventh summary information popup for Uranus.
 * No information is populated for this screen currently. 
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
...
function seventhScreen() {
  ...
  popupContent.innerHTML = `
  <div class="uranus" id="screen7">
    <div class="popup-content-header">  
      <h2>Structure of Uranus</h2>
    </div>
    <div class="popup-content-body">
      <p>
        Paragraph about the Structure of Uranus
      </p>
    </div>
    <div class="popup-buttons">
      <button id="prevButton">Previous</button>
 ...
 * eighthScreen()
 * 
 * This function populates and displays the eighth summary information popup for Uranus.
...
function eighthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="uranus" id="screen8">
        <div class="popup-content-header">
        <h2>No Moons Orbiting Uranus</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the moons orbiting Uranus
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
 ...
 * ninthScreen()
 * 
 * This function populates and displays the ninth summary information popup for Uranus.
 * The ring information is displayed for Uranus. 
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
 *  none
...
function ninthScreen() {
    ...
    popupContent.innerHTML = `
    <div class="uranus" id="screen9">
      <div class="popup-content-header">
        <h2>Rings of Uranus</h2>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about the rings of Uranus
        </p>
      </div>
      <div class="popup-buttons">
        <button id="prevButton">Previous</button>
 ...
 * tenthScreen()
 * 
 * This function populates and displays the tenth summary information popup for Uranus.
 * The atmosphere information is displayed for Uranus.
 * (Elements that are populated were initialized in the openPopup().) 
 * 
 * arguments:
 *  none
...
function tenthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="uranus" id="screen10">
        <div class="popup-content-header">
          <h2>Uranus' Atmosphere</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the atmosphere of Uranus
          </p>
          </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>

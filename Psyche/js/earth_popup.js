...
function thirdScreen() {
    ...
    popupContent.innerHTML = `
      <div class="earth" id="screen3">
        <div class="popup-content-header">
          <h2>Size and Dimensions</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Earth size and dimensions paragraph
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function fourthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="earth" id="screen4">
        <div class="popup-content-header">
          <h2>No Life on Earth</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about life on Earth
          </p>
        </div>
...
function fifthScreen() {
    const popupContent = document.querySelector('.popup-content');
    popupContent.innerHTML = `
      <div class="earth" id="screen5">
        <div class="popup-content-header">
          <h2>Surface of Earth</h2>
        </div>
        <div class="popup-content-body">
          <p>
           Paragraph about the surface of Earth
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function sixthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="earth" id="screen6">
        <div class="popup-content-header">  
          <h2>Orbit and Rotation</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about Earth's orbit and rotation
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function seventhScreen() {
  ...
  popupContent.innerHTML = `
  <div class="earth" id="screen7">
    <div class="popup-content-header">  
      <h2>Structure of Earth</h2>
    </div>
    <div class="popup-content-body">
      <p>
        Paragraph about the Structure of Earth
      </p>
    </div>
    <div class="popup-buttons">
      <button id="prevButton">Previous</button>
...
function eighthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="earth" id="screen8">
        <div class="popup-content-header">
        <h2>No Moons Orbiting Earth</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the moons orbiting Earth
          </p>
        </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>
...
function ninthScreen() {
    ...
    popupContent.innerHTML = `
    <div class="earth" id="screen9">
      <div class="popup-content-header">
        <h2>Rings of Earth</h2>
      </div>
      <div class="popup-content-body">
        <p>
          Paragraph about the rings of Earth
        </p>
      </div>
      <div class="popup-buttons">
        <button id="prevButton">Previous</button>
...
function tenthScreen() {
    ...
    popupContent.innerHTML = `
      <div class="earth" id="screen10">
        <div class="popup-content-header">
          <h2>Earth's Atmosphere</h2>
        </div>
        <div class="popup-content-body">
          <p>
            Paragraph about the atmosphere of Earth
          </p>
          </div>
        <div class="popup-buttons">
          <button id="prevButton">Previous</button>

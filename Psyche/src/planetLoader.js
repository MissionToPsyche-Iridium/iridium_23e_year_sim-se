...
//   ];
//   // const planetData = [
//   //   { name: "Sun", path: "src/assets/models/sun1.glb", size: 0.5, orbitRadius: 0.0, orbitSpeed: 0, rotationSpeed: 0.009, eccentricity: 0, inclination: 0 },
//   //   { name: "Mercury", path: "src/assets/models/mercury1.glb", size: 5, orbitRadius: 0.26, orbitSpeed: 0.24, rotationSpeed: 1, eccentricity: 0.205, inclination: 7.01 },
//   //   { name: "Venus", path: "src/assets/models/venus1.glb", size: 2, orbitRadius: 0.48, orbitSpeed: 0.18, rotationSpeed: 1, eccentricity: 0.007, inclination: 3.39 },
//   //   { name: "Earth", path: "src/assets/models/earth1.glb", size: 3, orbitRadius: 0.67, orbitSpeed: 0.1, rotationSpeed: 1, eccentricity: 0.017, inclination: 0.0 },
//   //   { name: "Mars", path: "src/assets/models/mars1.glb", size: 2, orbitRadius: 1.01, orbitSpeed: 0.08, rotationSpeed: 1, eccentricity: 0.093, inclination: 1.85 },
//   //   { name: "Jupiter", path: "src/assets/models/jupiter1.glb", size: 0.5, orbitRadius: 3.46, orbitSpeed: 0.04, rotationSpeed: 1, eccentricity: 0.049, inclination: 1.3 },
//   //   { name: "Saturn", path: "src/assets/models/saturn1.glb", size: 0.5, orbitRadius: 5.07, orbitSpeed: 0.03, rotationSpeed: 1, eccentricity: 0.056, inclination: 2.49 },
//   //   { name: "Uranus", path: "src/assets/models/uranus1.glb", size: 0.8, orbitRadius: 7.94, orbitSpeed: 0.02, rotationSpeed: 1, eccentricity: 0.046, inclination: 0.77 },
//   //   { name: "Neptune", path: "src/assets/models/neptune1.glb", size: 0.8, orbitRadius: 10.0, orbitSpeed: 0.01, rotationSpeed: 1, eccentricity: 0.01, inclination: 1.77 }
//   // ];
...
export async function loadPlanets(scene, onProgress) {
  ...
  const planetData = [
    ...
    { name: "Mercury", path: "src/assets/models/mercury1.glb", size: 5, orbitRadius: 3.935, orbitSpeed: 0.24, rotationSpeed: 1, eccentricity: 0.205, inclination: 7.01 },
    { name: "Venus", path: "src/assets/models/venus1.glb", size: 2, orbitRadius: 4.615, orbitSpeed: 0.18, rotationSpeed: 1, eccentricity: 0.007, inclination: 3.39 },
    { name: "Earth", path: "src/assets/models/earth1.glb", size: 3, orbitRadius: 6, orbitSpeed: 0.1, rotationSpeed: 1, eccentricity: 0.017, inclination: 0.00 },
    ...
    { name: "Jupiter", path: "src/assets/models/jupiter1.glb", size: 0.5, orbitRadius: 9.015, orbitSpeed: 0.04, rotationSpeed: 1, eccentricity: 0.049, inclination: 1.30 },
    { name: "Saturn", path: "src/assets/models/saturn1.glb", size: 0.5, orbitRadius: 10.1485, orbitSpeed: 0.03, rotationSpeed: 1, eccentricity: 0.056, inclination: 2.49 },
    { name: "Uranus", path: "src/assets/models/uranus1.glb", size: 0.8, orbitRadius: 11.715, orbitSpeed: 0.02, rotationSpeed: 1, eccentricity: 0.046, inclination: 0.77 },
    { name: "Neptune", path: "src/assets/models/neptune1.glb", size: 0.8, orbitRadius: 13.17, orbitSpeed: 0.01, rotationSpeed: 1, eccentricity: 0.010, inclination: 1.77 }
];

  let loaded = 0;
  const totalAssets = planetData.length + 1;

  const backgroundSphere = await new Promise((resolve, reject) => {
    const loader = new TextureLoader();
    loader.load("src/assets/images/textures/8k_stars_milky_way.jpg", 
      (texture) => {
        const geometry = new SphereGeometry(10000, 16, 16);
        const material = new MeshBasicMaterial({
          map: texture,
          side: BackSide,
        });
  ...
  for (const data of planetData) {
    try {
      const planet = await new Promise((resolve, reject) => {
        const planetHandler = new PlanetHandler(
          data.name, data.path, data.size, data.orbitRadius, data.orbitSpeed, 
          data.rotationSpeed, data.eccentricity, data.inclination, scene
        );
  ...
  return { planets, backgroundSphere };
}

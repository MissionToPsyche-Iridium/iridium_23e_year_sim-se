...
let __tla = (async () => {
  ...
  const cu = "173", Um = 0, xh = 1, Om = 2, vd = 1, Fm = 2, ai = 3, Si = 0, nn = 1, Vn = 2, xi = 0, Qr = 1, ba = 2, vh = 3, yh = 4, Bm = 5, fr = 100, zm = 101, km = 102, Vm = 103, Hm = 104, Gm = 200, Wm = 201, Xm = 202, qm = 203, Yl = 204, Kl = 205, Ym = 206, Km = 207, $m = 208, jm = 209, Zm = 210, Jm = 211, Qm = 212, eg = 213, tg = 214, $l = 0, jl = 1, Zl = 2, ls = 3, Jl = 4, Ql = 5, ec = 6, tc = 7, yd = 0, ng = 1, ig = 2, ki = 0, rg = 1, sg = 2, og = 3, ag = 4, lg = 5, cg = 6, ug = 7, Sh = "attached", hg = "detached", Sd = 300, cs = 301, us = 302, nc = 303, ic = 304, Va = 306, hs = 1e3, Ui = 1001, wa = 1002, Zt = 1003, Md = 1004, Hs = 1005, mn = 1006, ha = 1007, mi = 1008, Mi = 1009, Td = 1010, Ed = 1011, ao = 1012, uu = 1013, Tr = 1014, Un = 1015, vi = 1016, hu = 1017, fu = 1018, fs = 1020, bd = 35902, wd = 1021, Ad = 1022, bn = 1023, Rd = 1024, Cd = 1025, es = 1026, ds = 1027, du = 1028, pu = 1029, Pd = 1030, mu = 1031, gu = 1033, fa = 33776, da = 33777, pa = 33778, ma = 33779, rc = 35840, sc = 35841, oc = 35842, ac = 35843, lc = 36196, cc = 37492, uc = 37496, hc = 37808, fc = 37809, dc = 37810, pc = 37811, mc = 37812, gc = 37813, _c = 37814, xc = 37815, vc = 37816, yc = 37817, Sc = 37818, Mc = 37819, Tc = 37820, Ec = 37821, ga = 36492, bc = 36494, wc = 36495, Ld = 36283, Ac = 36284, Rc = 36285, Cc = 36286, lo = 2300, co = 2301, Ja = 2302, Mh = 2400, Th = 2401, Eh = 2402, fg = 2500, dg = 0, Dd = 1, Pc = 2, pg = 3200, mg = 3201, Id = 0, gg = 1, Ii = "", Ut = "srgb", Qt = "srgb-linear", Aa = "linear", lt = "srgb", Dr = 7680, bh = 519, _g = 512, xg = 513, vg = 514, Nd = 515, yg = 516, Sg = 517, Mg = 518, Tg = 519, Lc = 35044, wh = "300 es", gi = 2e3, Ra = 2001;
  class As {
  ...
  let Ah = 1234567;
  const $s = Math.PI / 180, ps = 180 / Math.PI;
  function An() {
  ...
  const kg = {
    ...
    ceilPowerOfTwo: Fg,
    floorPowerOfTwo: Bg,
    setQuaternionFromProperEuler: zg,
    normalize: st,
    denormalize: In
  };
  class ee {
  ...
  class ze {
    ...
    multiplyMatrices(e, t) {
      const n = e.elements, i = t.elements, s = this.elements, o = n[0], a = n[3], l = n[6], c = n[1], u = n[4], h = n[7], f = n[2], d = n[5], _ = n[8], g = i[0], m = i[3], p = i[6], S = i[1], v = i[4], x = i[7], b = i[2], w = i[5], A = i[8];
      return s[0] = o * g + a * S + l * b, s[3] = o * m + a * v + l * w, s[6] = o * p + a * x + l * A, s[1] = c * g + u * S + h * b, s[4] = c * m + u * v + h * w, s[7] = c * p + u * x + h * A, s[2] = f * g + d * S + _ * b, s[5] = f * m + d * v + _ * w, s[8] = f * p + d * x + _ * A, this;
    }
    multiplyScalar(e) {
  ...
  function Xg() {
    const r = {
      ...
      convert: function(i, s, o) {
        return this.enabled === false || s === o || !s || !o || (this.spaces[s].transfer === lt && (i.r = yi(i.r), i.g = yi(i.g), i.b = yi(i.b)), this.spaces[s].primaries !== this.spaces[o].primaries && (i.applyMatrix3(this.spaces[s].toXYZ), i.applyMatrix3(this.spaces[o].fromXYZ)), this.spaces[o].transfer === lt && (i.r = ts(i.r), i.g = ts(i.g), i.b = ts(i.b))), i;
      },
      ...
      getTransfer: function(i) {
        return i === Ii ? Aa : this.spaces[i].transfer;
      },
  ...
  class qg {
    static getDataURL(e) {
      ...
      if (e instanceof HTMLCanvasElement) t = e;
        ...
        Ir === void 0 && (Ir = uo("canvas")), Ir.width = e.width, Ir.height = e.height;
    ...
    static sRGBToLinear(e) {
      if (typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap) {
        ...
        for (let o = 0; o < s.length; o++) s[o] = yi(s[o] / 255) * 255;
        return n.putImageData(i, 0, 0), t;
      } else if (e.data) {
        const t = e.data.slice(0);
        for (let n = 0; n < t.length; n++) t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[n] = Math.floor(yi(t[n] / 255) * 255) : t[n] = yi(t[n]);
        return {
          data: t,
          width: e.width,
          height: e.height
  ...
  function el(r) {
    return typeof HTMLImageElement < "u" && r instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && r instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && r instanceof ImageBitmap ? qg.getDataURL(r) : r.data ? {
  ...
  let Kg = 0;
  class Ct extends As {
    constructor(e = Ct.DEFAULT_IMAGE, t = Ct.DEFAULT_MAPPING, n = Ui, i = Ui, s = mn, o = mi, a = bn, l = Mi, c = Ct.DEFAULT_ANISOTROPY, u = Ii) {
  ...
  class et {
    ...
    setAxisAngleFromRotationMatrix(e) {
      ...
      let S = Math.sqrt((m - _) * (m - _) + (h - g) * (h - g) + (f - u) * (f - u));
      return Math.abs(S) < 1e-3 && (S = 1), this.x = (m - _) / S, this.y = (h - g) / S, this.z = (f - u) / S, this.w = Math.acos((c + d + p - 1) / 2), this;
    }
  ...
  class Fd extends Ct {
    constructor(e = null, t = 1, n = 1, i = 1) {
      super(null), this.isDataArrayTexture = true, this.image = {
        ...
        height: n,
        depth: i
      }, this.magFilter = Zt, this.minFilter = Zt, this.wrapR = Ui, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1, this.layerUpdates = /* @__PURE__ */ new Set();
    }
    addLayerUpdate(e) {
  ...
  class jg extends Ct {
    constructor(e = null, t = 1, n = 1, i = 1) {
      super(null), this.isData3DTexture = true, this.image = {
        ...
        height: n,
        depth: i
      }, this.magFilter = Zt, this.minFilter = Zt, this.wrapR = Ui, this.generateMipmaps = false, this.flipY = false, this.unpackAlignment = 1;
    }
  }
  class qi {
    constructor(e = 0, t = 0, n = 0, i = 1) {
    ...
    static slerpFlat(e, t, n, i, s, o, a) {
      ...
      if (h !== g || l !== f || c !== d || u !== _) {
        let m = 1 - a;
        const p = l * f + c * d + u * _ + h * g, S = p >= 0 ? 1 : -1, v = 1 - p * p;
        if (v > Number.EPSILON) {
          const b = Math.sqrt(v), w = Math.atan2(b, p * S);
  ...
  class bi {
    ...
    expandByObject(e, t = false) {
      ...
      if (n !== void 0) {
        ...
        else e.boundingBox !== void 0 ? (e.boundingBox === null && e.computeBoundingBox(), Do.copy(e.boundingBox)) : (n.boundingBox === null && n.computeBoundingBox(), Do.copy(n.boundingBox)), Do.applyMatrix4(e.matrixWorld), this.union(Do);
      }
      const i = e.children;
    ...
    intersectsTriangle(e) {
      ...
      this.getCenter(Ds), Io.subVectors(this.max, Ds), Nr.subVectors(e.a, Ds), Ur.subVectors(e.b, Ds), Or.subVectors(e.c, Ds), wi.subVectors(Ur, Nr), Ai.subVectors(Or, Ur), Ji.subVectors(Nr, Or);
      let t = [
        0,
        -wi.z,
        wi.y,
      ...
      return !nl(t, Nr, Ur, Or, Io) || (t = [
        ...
        0,
        1
      ], !nl(t, Nr, Ur, Or, Io)) ? false : (No.crossVectors(wi, Ai), t = [
        No.x,
        No.y,
        No.z
      ], nl(t, Nr, Ur, Or, Io));
  ...
  const ei = [
    ...
    new D(),
    new D()
  ], Pn = new D(), Do = new bi(), Nr = new D(), Ur = new D(), Or = new D(), wi = new D(), Ai = new D(), Ji = new D(), Ds = new D(), Io = new D(), No = new D(), Qi = new D();
  function nl(r, e, t, n, i) {
    for (let s = 0, o = r.length - 3; s <= o; s += 3) {
      Qi.fromArray(r, s);
      const a = i.x * Math.abs(Qi.x) + i.y * Math.abs(Qi.y) + i.z * Math.abs(Qi.z), l = e.dot(Qi), c = t.dot(Qi), u = n.dot(Qi);
      if (Math.max(-Math.max(l, c, u), Math.min(l, c, u)) > a) return false;
    }
    return true;
  }
  const Zg = new bi(), Is = new D(), il = new D();
  class $n {
    ...
    setFromPoints(e, t) {
      const n = this.center;
      t !== void 0 ? n.copy(t) : Zg.setFromPoints(e).getCenter(n);
      let i = 0;
    ...
    union(e) {
      return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === true ? this.radius = Math.max(this.radius, e.radius) : (il.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(Is.copy(e.center).add(il)), this.expandByPoint(Is.copy(e.center).sub(il))), this);
    }
    equals(e) {
  ...
  const ti = new D(), rl = new D(), Uo = new D(), Ri = new D(), sl = new D(), Oo = new D(), ol = new D();
  class Eo {
    ...
    distanceSqToSegment(e, t, n, i) {
      rl.copy(e).add(t).multiplyScalar(0.5), Uo.copy(t).sub(e).normalize(), Ri.copy(this.origin).sub(rl);
      const s = e.distanceTo(t) * 0.5, o = -this.direction.dot(Uo), a = Ri.dot(this.direction), l = -Ri.dot(Uo), c = Ri.lengthSq(), u = Math.abs(1 - o * o);
      let h, f, d, _;
      ...
      return n && n.copy(this.origin).addScaledVector(this.direction, h), i && i.copy(rl).addScaledVector(Uo, f), d;
    }
    intersectSphere(e, t) {
      ti.subVectors(e.center, this.origin);
      const n = ti.dot(this.direction), i = ti.dot(ti) - n * n, s = e.radius * e.radius;
      if (i > s) return null;
    ...
    intersectTriangle(e, t, n, i, s) {
      sl.subVectors(t, e), Oo.subVectors(n, e), ol.crossVectors(sl, Oo);
      ...
      const l = a * this.direction.dot(Oo.crossVectors(Ri, Oo));
      if (l < 0) return null;
      const c = a * this.direction.dot(sl.cross(Ri));
  ...
  class Fe {
    ...
    extractRotation(e) {
      const t = this.elements, n = e.elements, i = 1 / Fr.setFromMatrixColumn(e, 0).length(), s = 1 / Fr.setFromMatrixColumn(e, 1).length(), o = 1 / Fr.setFromMatrixColumn(e, 2).length();
    ...
    makeRotationFromQuaternion(e) {
      return this.compose(Jg, e, Qg);
    }
    lookAt(e, t, n) {
      const i = this.elements;
      return hn.subVectors(e, t), hn.lengthSq() === 0 && (hn.z = 1), hn.normalize(), Ci.crossVectors(n, hn), Ci.lengthSq() === 0 && (Math.abs(n.z) === 1 ? hn.x += 1e-4 : hn.z += 1e-4, hn.normalize(), Ci.crossVectors(n, hn)), Ci.normalize(), Fo.crossVectors(hn, Ci), i[0] = Ci.x, i[4] = Fo.x, i[8] = hn.x, i[1] = Ci.y, i[5] = Fo.y, i[9] = hn.y, i[2] = Ci.z, i[6] = Fo.z, i[10] = hn.z, this;
    }
    multiply(e) {
      return this.multiplyMatrices(this, e);
    }
    ...
    multiplyMatrices(e, t) {
      const n = e.elements, i = t.elements, s = this.elements, o = n[0], a = n[4], l = n[8], c = n[12], u = n[1], h = n[5], f = n[9], d = n[13], _ = n[2], g = n[6], m = n[10], p = n[14], S = n[3], v = n[7], x = n[11], b = n[15], w = i[0], A = i[4], P = i[8], y = i[12], M = i[1], L = i[5], G = i[9], O = i[13], V = i[2], q = i[6], B = i[10], $ = i[14], H = i[3], oe = i[7], ce = i[11], ge = i[15];
      return s[0] = o * w + a * M + l * V + c * H, s[4] = o * A + a * L + l * q + c * oe, s[8] = o * P + a * G + l * B + c * ce, s[12] = o * y + a * O + l * $ + c * ge, s[1] = u * w + h * M + f * V + d * H, s[5] = u * A + h * L + f * q + d * oe, s[9] = u * P + h * G + f * B + d * ce, s[13] = u * y + h * O + f * $ + d * ge, s[2] = _ * w + g * M + m * V + p * H, s[6] = _ * A + g * L + m * q + p * oe, s[10] = _ * P + g * G + m * B + p * ce, s[14] = _ * y + g * O + m * $ + p * ge, s[3] = S * w + v * M + x * V + b * H, s[7] = S * A + v * L + x * q + b * oe, s[11] = S * P + v * G + x * B + b * ce, s[15] = S * y + v * O + x * $ + b * ge, this;
    }
    multiplyScalar(e) {
      const t = this.elements;
    ...
    compose(e, t, n) {
      const i = this.elements, s = t._x, o = t._y, a = t._z, l = t._w, c = s + s, u = o + o, h = a + a, f = s * c, d = s * u, _ = s * h, g = o * u, m = o * h, p = a * h, S = l * c, v = l * u, x = l * h, b = n.x, w = n.y, A = n.z;
      return i[0] = (1 - (g + p)) * b, i[1] = (d + x) * b, i[2] = (_ - v) * b, i[3] = 0, i[4] = (d - x) * w, i[5] = (1 - (f + p)) * w, i[6] = (m + S) * w, i[7] = 0, i[8] = (_ + v) * A, i[9] = (m - S) * A, i[10] = (1 - (f + g)) * A, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this;
    }
    decompose(e, t, n) {
      const i = this.elements;
      let s = Fr.set(i[0], i[1], i[2]).length();
      const o = Fr.set(i[4], i[5], i[6]).length(), a = Fr.set(i[8], i[9], i[10]).length();
    ...
    makePerspective(e, t, n, i, s, o, a = gi) {
      const l = this.elements, c = 2 * s / (t - e), u = 2 * s / (n - i), h = (t + e) / (t - e), f = (n + i) / (n - i);
      let d, _;
      if (a === gi) d = -(o + s) / (o - s), _ = -2 * o * s / (o - s);
      else if (a === Ra) d = -o / (o - s), _ = -o * s / (o - s);
    ...
    makeOrthographic(e, t, n, i, s, o, a = gi) {
      const l = this.elements, c = 1 / (t - e), u = 1 / (n - i), h = 1 / (o - s), f = (t + e) * c, d = (n + i) * u;
      let _, g;
      if (a === gi) _ = (o + s) * h, g = -2 * h;
      else if (a === Ra) _ = s * h, g = -1 * h;
  ...
  const Fr = new D(), Ln = new Fe(), Jg = new D(0, 0, 0), Qg = new D(1, 1, 1), Ci = new D(), Fo = new D(), hn = new D(), Dh = new Fe(), Ih = new qi();
  class Fn {
  ...
  let e_ = 0;
  const Nh = new D(), Br = new qi(), ni = new Fe(), Bo = new D(), Ns = new D(), t_ = new D(), n_ = new qi(), Uh = new D(1, 0, 0), Oh = new D(0, 1, 0), Fh = new D(0, 0, 1), Bh = {
    type: "added"
  }, i_ = {
    type: "removed"
  }, zr = {
  ...
  class gt extends As {
    constructor() {
      ...
      const e = new D(), t = new Fn(), n = new qi(), i = new D(1, 1, 1);
      function s() {
    ...
    worldToLocal(e) {
      return this.updateWorldMatrix(true, false), e.applyMatrix4(ni.copy(this.matrixWorld).invert());
    }
    lookAt(e, t, n) {
      e.isVector3 ? Bo.copy(e) : Bo.set(e, t, n);
      const i = this.parent;
      this.updateWorldMatrix(true, false), Ns.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? ni.lookAt(Ns, Bo, this.up) : ni.lookAt(Bo, Ns, this.up), this.quaternion.setFromRotationMatrix(ni), i && (ni.extractRotation(i.matrixWorld), Br.setFromRotationMatrix(ni), this.quaternion.premultiply(Br.invert()));
    }
    add(e) {
      ...
      return e === this ? (console.error("THREE.Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(Bh), zr.child = e, this.dispatchEvent(zr), zr.child = null) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", e), this);
    }
    remove(e) {
      if (arguments.length > 1) {
      ...
      return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(i_), al.child = e, this.dispatchEvent(al), al.child = null), this;
    }
    removeFromParent() {
      const e = this.parent;
    ...
    attach(e) {
      return this.updateWorldMatrix(true, false), ni.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(true, false), ni.multiply(e.parent.matrixWorld)), e.applyMatrix4(ni), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(false, true), e.dispatchEvent(Bh), zr.child = e, this.dispatchEvent(zr), zr.child = null, this;
    }
    getObjectById(e) {
    ...
    getWorldQuaternion(e) {
      return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(Ns, e, t_), e;
    }
    getWorldScale(e) {
      return this.updateWorldMatrix(true, false), this.matrixWorld.decompose(Ns, n_, e), e;
    }
    getWorldDirection(e) {
  ...
  const Dn = new D(), ii = new D(), ll = new D(), ri = new D(), kr = new D(), Vr = new D(), zh = new D(), cl = new D(), ul = new D(), hl = new D(), fl = new et(), dl = new et(), pl = new et();
  class Nn {
    ...
    static getBarycoord(e, t, n, i, s) {
      Dn.subVectors(i, t), ii.subVectors(n, t), ll.subVectors(e, t);
      const o = Dn.dot(Dn), a = Dn.dot(ii), l = Dn.dot(ll), c = ii.dot(ii), u = ii.dot(ll), h = o * c - a * a;
    ...
    static getInterpolation(e, t, n, i, s, o, a, l) {
      return this.getBarycoord(e, t, n, i, ri) === null ? (l.x = 0, l.y = 0, "z" in l && (l.z = 0), "w" in l && (l.w = 0), null) : (l.setScalar(0), l.addScaledVector(s, ri.x), l.addScaledVector(o, ri.y), l.addScaledVector(a, ri.z), l);
    }
    static getInterpolatedAttribute(e, t, n, i, s, o) {
      return fl.setScalar(0), dl.setScalar(0), pl.setScalar(0), fl.fromBufferAttribute(e, t), dl.fromBufferAttribute(e, n), pl.fromBufferAttribute(e, i), o.setScalar(0), o.addScaledVector(fl, s.x), o.addScaledVector(dl, s.y), o.addScaledVector(pl, s.z), o;
    }
    static isFrontFacing(e, t, n, i) {
      return Dn.subVectors(n, t), ii.subVectors(e, t), Dn.cross(ii).dot(i) < 0;
    }
    set(e, t, n) {
    ...
    getArea() {
      return Dn.subVectors(this.c, this.b), ii.subVectors(this.a, this.b), Dn.cross(ii).length() * 0.5;
    }
    getMidpoint(e) {
    ...
    closestPointToPoint(e, t) {
      ...
      let o, a;
      kr.subVectors(i, n), Vr.subVectors(s, n), cl.subVectors(e, n);
      const l = kr.dot(cl), c = Vr.dot(cl);
      if (l <= 0 && c <= 0) return t.copy(n);
      ul.subVectors(e, i);
      const u = kr.dot(ul), h = Vr.dot(ul);
      if (u >= 0 && h <= u) return t.copy(i);
      const f = l * h - u * c;
      if (f <= 0 && l >= 0 && u <= 0) return o = l / (l - u), t.copy(n).addScaledVector(kr, o);
      hl.subVectors(e, s);
      const d = kr.dot(hl), _ = Vr.dot(hl);
      if (_ >= 0 && d <= _) return t.copy(s);
      const g = d * c - l * _;
      if (g <= 0 && c >= 0 && _ <= 0) return a = c / (c - _), t.copy(n).addScaledVector(Vr, a);
      const m = u * _ - d * h;
      if (m <= 0 && h - u >= 0 && d - _ >= 0) return zh.subVectors(s, i), a = (h - u) / (h - u + (d - _)), t.copy(i).addScaledVector(zh, a);
      const p = 1 / (m + g + f);
      return o = g * p, a = f * p, t.copy(n).addScaledVector(kr, o).addScaledVector(Vr, a);
    }
    equals(e) {
  ...
  class Re {
    ...
    setHSL(e, t, n, i = Ye.workingColorSpace) {
      if (e = _u(e, 1), t = He(t, 0, 1), n = He(n, 0, 1), t === 0) this.r = this.g = this.b = n;
      else {
        const s = n <= 0.5 ? n * (1 + t) : n + t - n * t, o = 2 * n - s;
        this.r = ml(o, s, e + 1 / 3), this.g = ml(o, s, e), this.b = ml(o, s, e - 1 / 3);
      }
    ...
    offsetHSL(e, t, n) {
      return this.getHSL(Pi), this.setHSL(Pi.h + e, Pi.s + t, Pi.l + n);
    }
    add(e) {
      return this.r += e.r, this.g += e.g, this.b += e.b, this;
    }
    ...
    lerpHSL(e, t) {
      this.getHSL(Pi), e.getHSL(zo);
      const n = js(Pi.h, zo.h, t), i = js(Pi.s, zo.s, t), s = js(Pi.l, zo.l, t);
  ...
  class Xn extends As {
    constructor() {
      super(), this.isMaterial = true, Object.defineProperty(this, "id", {
        value: r_++
      }), this.uuid = An(), this.name = "", this.type = "Material", this.blending = Qr, this.side = Si, this.vertexColors = false, this.opacity = 1, this.transparent = false, this.alphaHash = false, this.blendSrc = Yl, this.blendDst = Kl, this.blendEquation = fr, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Re(0, 0, 0), this.blendAlpha = 0, this.depthFunc = ls, this.depthTest = true, this.depthWrite = true, this.stencilWriteMask = 255, this.stencilFunc = bh, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Dr, this.stencilZFail = Dr, this.stencilZPass = Dr, this.stencilWrite = false, this.clippingPlanes = null, this.clipIntersection = false, this.clipShadows = false, this.shadowSide = null, this.colorWrite = true, this.precision = null, this.polygonOffset = false, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = false, this.alphaToCoverage = false, this.premultipliedAlpha = false, this.forceSinglePass = false, this.visible = true, this.toneMapped = true, this.userData = {}, this.version = 0, this._alphaTest = 0;
    }
    get alphaTest() {
  ...
  class Jt {
    constructor(e, t, n = false) {
      ...
      this.isBufferAttribute = true, Object.defineProperty(this, "id", {
        value: s_++
      }), this.name = "", this.array = e, this.itemSize = t, this.count = e !== void 0 ? e.length / t : 0, this.normalized = n, this.usage = Lc, this.updateRanges = [], this.gpuType = Un, this.version = 0;
    }
    onUploadCallback() {
    }
    set needsUpdate(e) {
    ...
    applyMatrix3(e) {
      if (this.itemSize === 2) for (let t = 0, n = this.count; t < n; t++) ko.fromBufferAttribute(this, t), ko.applyMatrix3(e), this.setXY(t, ko.x, ko.y);
    ...
    toJSON() {
      ...
      return this.name !== "" && (e.name = this.name), this.usage !== Lc && (e.usage = this.usage), e;
    }
  }
  class zd extends Jt {
    constructor(e, t, n) {
  ...
  let o_ = 0;
  const Mn = new Fe(), gl = new gt(), Hr = new D(), fn = new bi(), Us = new bi(), Dt = new D();
  class cn extends As {
    constructor() {
    ...
    computeBoundingSphere() {
      this.boundingSphere === null && (this.boundingSphere = new $n());
      const e = this.attributes.position, t = this.morphAttributes.position;
      if (e && e.isGLBufferAttribute) {
      ...
      if (e) {
        ...
        if (t) for (let s = 0, o = t.length; s < o; s++) {
          ...
          for (let c = 0, u = a.count; c < u; c++) Dt.fromBufferAttribute(a, c), l && (Hr.fromBufferAttribute(e, c), Dt.add(Hr)), i = Math.max(i, n.distanceToSquared(Dt));
        }
    ...
    computeTangents() {
      ...
      function p(P, y, M) {
        c.fromBufferAttribute(n, P), u.fromBufferAttribute(n, y), h.fromBufferAttribute(n, M), f.fromBufferAttribute(s, P), d.fromBufferAttribute(s, y), _.fromBufferAttribute(s, M), u.sub(c), h.sub(c), d.sub(f), _.sub(f);
        const L = 1 / (d.x * _.y - _.x * d.y);
        isFinite(L) && (g.copy(u).multiplyScalar(_.y).addScaledVector(h, -d.y).multiplyScalar(L), m.copy(h).multiplyScalar(d.x).addScaledVector(u, -_.x).multiplyScalar(L), a[P].add(g), a[y].add(g), a[M].add(g), l[P].add(m), l[y].add(m), l[M].add(m));
      }
      let S = this.groups;
      S.length === 0 && (S = [
        {
      ...
      for (let P = 0, y = S.length; P < y; ++P) {
        const M = S[P], L = M.start, G = M.count;
      ...
      function A(P) {
        ...
        const y = a[P];
        v.copy(y), v.sub(b.multiplyScalar(b.dot(y))).normalize(), x.crossVectors(w, y);
  ...
  const kh = new Fe(), er = new Eo(), Vo = new $n(), Vh = new D(), Ho = new D(), Go = new D(), Wo = new D(), _l = new D(), Xo = new D(), Hh = new D(), qo = new D();
  class Rt extends gt {
    constructor(e = new cn(), t = new Gn()) {
    ...
    getVertexPosition(e, t) {
      ...
      if (s && a) {
        ...
        for (let l = 0, c = s.length; l < c; l++) {
          const u = a[l], h = s[l];
          u !== 0 && (_l.fromBufferAttribute(h, e), o ? Xo.addScaledVector(_l, u) : Xo.addScaledVector(_l.sub(t), u));
        }
        t.add(Xo);
      }
      return t;
    ...
    raycast(e, t) {
      ...
      i !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Vo.copy(n.boundingSphere), Vo.applyMatrix4(s), er.copy(e.ray).recast(e.near), !(Vo.containsPoint(er.origin) === false && (er.intersectSphere(Vo, Vh) === null || er.origin.distanceToSquared(Vh) > (e.far - e.near) ** 2)) && (kh.copy(s).invert(), er.copy(e.ray).applyMatrix4(kh), !(n.boundingBox !== null && er.intersectsBox(n.boundingBox) === false) && this._computeIntersections(e, t, er)));
    }
    _computeIntersections(e, t, n) {
      ...
      if (a !== null) if (Array.isArray(o)) for (let _ = 0, g = f.length; _ < g; _++) {
        const m = f[_], p = o[m.materialIndex], S = Math.max(m.start, d.start), v = Math.min(a.count, Math.min(m.start + m.count, d.start + d.count));
        for (let x = S, b = v; x < b; x += 3) {
          const w = a.getX(x), A = a.getX(x + 1), P = a.getX(x + 2);
          i = Yo(this, p, e, n, c, u, h, w, A, P), i && (i.faceIndex = Math.floor(x / 3), i.face.materialIndex = m.materialIndex, t.push(i));
        }
      }
      else {
        const _ = Math.max(0, d.start), g = Math.min(a.count, d.start + d.count);
        for (let m = _, p = g; m < p; m += 3) {
          const S = a.getX(m), v = a.getX(m + 1), x = a.getX(m + 2);
          i = Yo(this, o, e, n, c, u, h, S, v, x), i && (i.faceIndex = Math.floor(m / 3), t.push(i));
        }
      }
      else if (l !== void 0) if (Array.isArray(o)) for (let _ = 0, g = f.length; _ < g; _++) {
        const m = f[_], p = o[m.materialIndex], S = Math.max(m.start, d.start), v = Math.min(l.count, Math.min(m.start + m.count, d.start + d.count));
        for (let x = S, b = v; x < b; x += 3) {
        ...
        for (let m = _, p = g; m < p; m += 3) {
          const S = m, v = m + 1, x = m + 2;
          i = Yo(this, o, e, n, c, u, h, S, v, x), i && (i.faceIndex = Math.floor(m / 3), t.push(i));
        }
      }
    }
  }
  function a_(r, e, t, n, i, s, o, a) {
    let l;
    if (e.side === nn ? l = n.intersectTriangle(o, s, i, true, a) : l = n.intersectTriangle(i, s, o, e.side === Si, a), l === null) return null;
    qo.copy(a), qo.applyMatrix4(r.matrixWorld);
  ...
  function Yo(r, e, t, n, i, s, o, a, l, c) {
    r.getVertexPosition(a, Ho), r.getVertexPosition(l, Go), r.getVertexPosition(c, Wo);
    const u = a_(r, e, t, n, Ho, Go, Wo, Hh);
    if (u) {
      const h = new D();
      Nn.getBarycoord(Hh, Ho, Go, Wo, h), i && (u.uv = Nn.getInterpolatedAttribute(i, a, l, c, h, new ee())), s && (u.uv1 = Nn.getInterpolatedAttribute(s, a, l, c, h, new ee())), o && (u.normal = Nn.getInterpolatedAttribute(o, a, l, c, h, new D()), u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1));
      const f = {
        a,
        b: l,
        c,
      ...
      Nn.getNormal(Ho, Go, Wo, f.normal), u.face = f, u.barycoord = h;
    }
    return u;
  }
  class wr extends cn {
    constructor(e = 1, t = 1, n = 1, i = 1, s = 1, o = 1) {
      ...
      function _(g, m, p, S, v, x, b, w, A, P, y) {
        ...
        for (let ce = 0; ce < B; ce++) {
          ...
          for (let Le = 0; Le < q; Le++) {
            const Ke = Le * M - G;
            oe[g] = Ke * S, oe[m] = ge * v, oe[p] = V, c.push(oe.x, oe.y, oe.z), oe[g] = 0, oe[m] = 0, oe[p] = w > 0 ? 1 : -1, u.push(oe.x, oe.y, oe.z), h.push(Le / A), h.push(1 - ce / P), $ += 1;
          }
        }
  ...
  class Gt extends Xn {
    constructor(e) {
      super(), this.isShaderMaterial = true, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = c_, this.fragmentShader = u_, this.linewidth = 1, this.wireframe = false, this.wireframeLinewidth = 1, this.fog = false, this.lights = false, this.clipping = false, this.forceSinglePass = true, this.extensions = {
  ...
  class Hd extends gt {
    constructor() {
      super(), this.isCamera = true, this.type = "Camera", this.matrixWorldInverse = new Fe(), this.projectionMatrix = new Fe(), this.projectionMatrixInverse = new Fe(), this.coordinateSystem = gi;
    }
    copy(e, t) {
  ...
  const Li = new D(), Gh = new ee(), Wh = new ee();
  class $t extends Hd {
    ...
    getEffectiveFOV() {
      return ps * 2 * Math.atan(Math.tan($s * 0.5 * this.fov) / this.zoom);
    }
    getFilmWidth() {
    ...
    getViewBounds(e, t, n) {
      Li.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse), t.set(Li.x, Li.y).multiplyScalar(-e / Li.z), Li.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse), n.set(Li.x, Li.y).multiplyScalar(-e / Li.z);
    }
    getViewSize(e, t) {
    ...
    updateProjectionMatrix() {
      const e = this.near;
      let t = e * Math.tan($s * 0.5 * this.fov) / this.zoom, n = 2 * t, i = this.aspect * n, s = -0.5 * i;
      const o = this.view;
  ...
  class h_ extends gt {
    constructor(e, t, n) {
      ...
      const i = new $t(Gr, Wr, e, t);
      i.layers = this.layers, this.add(i);
      const s = new $t(Gr, Wr, e, t);
      s.layers = this.layers, this.add(s);
      const o = new $t(Gr, Wr, e, t);
      o.layers = this.layers, this.add(o);
      const a = new $t(Gr, Wr, e, t);
      a.layers = this.layers, this.add(a);
      const l = new $t(Gr, Wr, e, t);
      l.layers = this.layers, this.add(l);
      const c = new $t(Gr, Wr, e, t);
      c.layers = this.layers, this.add(c);
    }
    updateCoordinateSystem() {
      const e = this.coordinateSystem, t = this.children.concat(), [n, i, s, o, a, l] = t;
      for (const c of t) this.remove(c);
      if (e === gi) n.up.set(0, 1, 0), n.lookAt(1, 0, 0), i.up.set(0, 1, 0), i.lookAt(-1, 0, 0), s.up.set(0, 0, -1), s.lookAt(0, 1, 0), o.up.set(0, 0, 1), o.lookAt(0, -1, 0), a.up.set(0, 1, 0), a.lookAt(0, 0, 1), l.up.set(0, 1, 0), l.lookAt(0, 0, -1);
      else if (e === Ra) n.up.set(0, -1, 0), n.lookAt(-1, 0, 0), i.up.set(0, -1, 0), i.lookAt(1, 0, 0), s.up.set(0, 0, 1), s.lookAt(0, 1, 0), o.up.set(0, 0, -1), o.lookAt(0, -1, 0), a.up.set(0, -1, 0), a.lookAt(0, 0, 1), l.up.set(0, -1, 0), l.lookAt(0, 0, -1);
  ...
  class f_ extends On {
    ...
    fromEquirectangularTexture(e, t) {
      ...
      return t.minFilter === mi && (t.minFilter = mn), new h_(1, 10, this).update(e, o), t.minFilter = a, o.geometry.dispose(), o.material.dispose(), this;
    }
    clear(e, t, n, i) {
  ...
  class xl {
    ...
    getHandSpace() {
      return this._hand === null && (this._hand = new _r(), this._hand.matrixAutoUpdate = false, this._hand.visible = false, this._hand.joints = {}, this._hand.inputState = {
        pinching: false
      }), this._hand;
    }
    getTargetRaySpace() {
      return this._targetRay === null && (this._targetRay = new _r(), this._targetRay.matrixAutoUpdate = false, this._targetRay.visible = false, this._targetRay.hasLinearVelocity = false, this._targetRay.linearVelocity = new D(), this._targetRay.hasAngularVelocity = false, this._targetRay.angularVelocity = new D()), this._targetRay;
    }
    getGripSpace() {
      return this._grip === null && (this._grip = new _r(), this._grip.matrixAutoUpdate = false, this._grip.visible = false, this._grip.hasLinearVelocity = false, this._grip.linearVelocity = new D(), this._grip.hasAngularVelocity = false, this._grip.angularVelocity = new D()), this._grip;
    }
    dispatchEvent(e) {
  ...
  class m_ {
    constructor(e, t) {
      this.isInterleavedBuffer = true, this.array = e, this.stride = t, this.count = e !== void 0 ? e.length / t : 0, this.usage = Lc, this.updateRanges = [], this.version = 0, this.uuid = An();
    }
    onUploadCallback() {
    }
    set needsUpdate(e) {
  ...
  const Xh = new D(), qh = new et(), Yh = new et(), g_ = new D(), Kh = new Fe(), Ko = new D(), vl = new $n(), $h = new Fe(), yl = new Eo();
  class __ extends Rt {
    constructor(e, t) {
    ...
    computeBoundingBox() {
      ...
      for (let n = 0; n < t.count; n++) this.getVertexPosition(n, Ko), this.boundingBox.expandByPoint(Ko);
    }
    computeBoundingSphere() {
      const e = this.geometry;
      this.boundingSphere === null && (this.boundingSphere = new $n()), this.boundingSphere.makeEmpty();
      const t = e.getAttribute("position");
      for (let n = 0; n < t.count; n++) this.getVertexPosition(n, Ko), this.boundingSphere.expandByPoint(Ko);
    }
    copy(e, t) {
    ...
    raycast(e, t) {
      ...
      n !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), vl.copy(this.boundingSphere), vl.applyMatrix4(i), e.ray.intersectsSphere(vl) !== false && ($h.copy(i).invert(), yl.copy(e.ray).applyMatrix4($h), !(this.boundingBox !== null && yl.intersectsBox(this.boundingBox) === false) && this._computeIntersections(e, t, yl)));
    }
    getVertexPosition(e, t) {
    ...
    updateMatrixWorld(e) {
      super.updateMatrixWorld(e), this.bindMode === Sh ? this.bindMatrixInverse.copy(this.matrixWorld).invert() : this.bindMode === hg ? this.bindMatrixInverse.copy(this.bindMatrix).invert() : console.warn("THREE.SkinnedMesh: Unrecognized bindMode: " + this.bindMode);
    }
    applyBoneTransform(e, t) {
      ...
      for (let s = 0; s < 4; s++) {
        ...
        if (o !== 0) {
          ...
          Kh.multiplyMatrices(n.bones[a].matrixWorld, n.boneInverses[a]), t.addScaledVector(g_.copy(Xh).applyMatrix4(Kh), o);
        }
      }
  ...
  class yu {
    ...
    update() {
      ...
      for (let s = 0, o = e.length; s < o; s++) {
        const a = e[s] ? e[s].matrixWorld : x_;
        jh.multiplyMatrices(a, t[s]), jh.toArray(n, s * 16);
      }
  ...
  const Xr = new Fe(), Zh = new Fe(), $o = [], Jh = new bi(), v_ = new Fe(), Os = new Rt(), Fs = new $n();
  class y_ extends Rt {
    constructor(e, t, n) {
      super(e, t), this.isInstancedMesh = true, this.instanceMatrix = new Dc(new Float32Array(n * 16), 16), this.instanceColor = null, this.morphTexture = null, this.count = n, this.boundingBox = null, this.boundingSphere = null;
      for (let i = 0; i < n; i++) this.setMatrixAt(i, v_);
    }
    computeBoundingBox() {
      const e = this.geometry, t = this.count;
      this.boundingBox === null && (this.boundingBox = new bi()), e.boundingBox === null && e.computeBoundingBox(), this.boundingBox.makeEmpty();
      for (let n = 0; n < t; n++) this.getMatrixAt(n, Xr), Jh.copy(e.boundingBox).applyMatrix4(Xr), this.boundingBox.union(Jh);
    }
    computeBoundingSphere() {
      const e = this.geometry, t = this.count;
      this.boundingSphere === null && (this.boundingSphere = new $n()), e.boundingSphere === null && e.computeBoundingSphere(), this.boundingSphere.makeEmpty();
      for (let n = 0; n < t; n++) this.getMatrixAt(n, Xr), Fs.copy(e.boundingSphere).applyMatrix4(Xr), this.boundingSphere.union(Fs);
    }
    copy(e, t) {
    ...
    raycast(e, t) {
      ...
      if (Os.geometry = this.geometry, Os.material = this.material, Os.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), Fs.copy(this.boundingSphere), Fs.applyMatrix4(n), e.ray.intersectsSphere(Fs) !== false)) for (let s = 0; s < i; s++) {
        this.getMatrixAt(s, Xr), Zh.multiplyMatrices(n, Xr), Os.matrixWorld = Zh, Os.raycast(e, $o);
    ...
    setColorAt(e, t) {
      this.instanceColor === null && (this.instanceColor = new Dc(new Float32Array(this.instanceMatrix.count * 3).fill(1), 3)), t.toArray(this.instanceColor.array, e * 3);
    }
    setMatrixAt(e, t) {
    ...
    setMorphAt(e, t) {
      ...
      this.morphTexture === null && (this.morphTexture = new Xd(new Float32Array(i * this.count), i, this.count, du, Un));
  ...
  const Sl = new D(), S_ = new D(), M_ = new ze();
  class lr {
    ...
    setFromCoplanarPoints(e, t, n) {
      const i = Sl.subVectors(n, t).cross(S_.subVectors(e, t)).normalize();
    ...
    intersectLine(e, t) {
      const n = e.delta(Sl), i = this.normal.dot(n);
    ...
    applyMatrix4(e, t) {
      const n = t || M_.getNormalMatrix(e), i = this.coplanarPoint(Sl).applyMatrix4(e), s = this.normal.applyMatrix3(n).normalize();
  ...
  const tr = new $n(), jo = new D();
  class Su {
    constructor(e = new lr(), t = new lr(), n = new lr(), i = new lr(), s = new lr(), o = new lr()) {
      this.planes = [
        e,
        t,
        n,
    ...
    setFromProjectionMatrix(e, t = gi) {
      const n = this.planes, i = e.elements, s = i[0], o = i[1], a = i[2], l = i[3], c = i[4], u = i[5], h = i[6], f = i[7], d = i[8], _ = i[9], g = i[10], m = i[11], p = i[12], S = i[13], v = i[14], x = i[15];
      if (n[0].setComponents(l - s, f - c, m - d, x - p).normalize(), n[1].setComponents(l + s, f + c, m + d, x + p).normalize(), n[2].setComponents(l + o, f + u, m + _, x + S).normalize(), n[3].setComponents(l - o, f - u, m - _, x - S).normalize(), n[4].setComponents(l - a, f - h, m - g, x - v).normalize(), t === gi) n[5].setComponents(l + a, f + h, m + g, x + v).normalize();
      else if (t === Ra) n[5].setComponents(a, h, g, v).normalize();
      else throw new Error("THREE.Frustum.setFromProjectionMatrix(): Invalid coordinate system: " + t);
      return this;
    }
    intersectsObject(e) {
      if (e.boundingSphere !== void 0) e.boundingSphere === null && e.computeBoundingSphere(), tr.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
      else {
        const t = e.geometry;
        t.boundingSphere === null && t.computeBoundingSphere(), tr.copy(t.boundingSphere).applyMatrix4(e.matrixWorld);
      }
    ...
    intersectsBox(e) {
      ...
      for (let n = 0; n < 6; n++) {
        const i = t[n];
        if (jo.x = i.normal.x > 0 ? e.max.x : e.min.x, jo.y = i.normal.y > 0 ? e.max.y : e.min.y, jo.z = i.normal.z > 0 ? e.max.z : e.min.z, i.distanceToPoint(jo) < 0) return false;
      }
      return true;
    }
    containsPoint(e) {
  ...
  const Pa = new D(), La = new D(), Qh = new Fe(), Bs = new Eo(), Zo = new $n(), Ml = new D(), ef = new D();
  class Mu extends gt {
    ...
    computeLineDistances() {
      ...
      if (e.index === null) {
        ...
        for (let i = 1, s = t.count; i < s; i++) Pa.fromBufferAttribute(t, i - 1), La.fromBufferAttribute(t, i), n[i] = n[i - 1], n[i] += Pa.distanceTo(La);
    ...
    raycast(e, t) {
      ...
      Qh.copy(i).invert(), Bs.copy(e.ray).applyMatrix4(Qh);
      ...
      if (u !== null) {
        ...
        for (let g = d, m = _ - 1; g < m; g += c) {
          const p = u.getX(g), S = u.getX(g + 1), v = Jo(this, e, Bs, l, p, S, g);
          v && t.push(v);
        }
        if (this.isLineLoop) {
  ...
  function Jo(r, e, t, n, i, s, o) {
    ...
    if (Pa.fromBufferAttribute(a, i), La.fromBufferAttribute(a, s), t.distanceSqToSegment(Pa, La, Ml, ef) > n) return;
  ...
  const rf = new Fe(), Ic = new Eo(), Qo = new $n(), ea = new D();
  class Yd extends gt {
    constructor(e = new cn(), t = new Tu()) {
    ...
    raycast(e, t) {
      ...
      if (n.boundingSphere === null && n.computeBoundingSphere(), Qo.copy(n.boundingSphere), Qo.applyMatrix4(i), Qo.radius += s, e.ray.intersectsSphere(Qo) === false) return;
      rf.copy(i).invert(), Ic.copy(e.ray).applyMatrix4(rf);
      ...
      if (c !== null) {
        ...
        for (let _ = f, g = d; _ < g; _++) {
          const m = c.getX(_);
          ea.fromBufferAttribute(h, m), sf(ea, m, l, i, e, t, this);
        }
      } else {
        const f = Math.max(0, o.start), d = Math.min(h.count, o.start + o.count);
        for (let _ = f, g = d; _ < g; _++) ea.fromBufferAttribute(h, _), sf(ea, _, l, i, e, t, this);
      }
    }
    updateMorphTargets() {
      const t = this.geometry.morphAttributes, n = Object.keys(t);
  ...
  function sf(r, e, t, n, i, s, o) {
    const a = Ic.distanceSqToPoint(r);
    if (a < t) {
      const l = new D();
      Ic.closestPointToPoint(r, l), l.applyMatrix4(n);
  ...
  class Kd extends Ct {
    constructor(e, t, n, i, s, o, a, l, c, u = es) {
      if (u !== es && u !== ds) throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");
      n === void 0 && u === es && (n = Tr), n === void 0 && u === ds && (n = fs), super(null, i, s, o, a, l, u, n, c), this.isDepthTexture = true, this.image = {
        width: e,
        height: t
  ...
  const ta = new D(), Tl = new bu(), El = new bu(), bl = new bu();
  class A_ extends jn {
    ...
    getPoint(e, t = new D()) {
      ...
      let c, u;
      this.closed || a > 0 ? c = i[(a - 1) % s] : (ta.subVectors(i[0], i[1]).add(i[0]), c = ta);
      const h = i[a % s], f = i[(a + 1) % s];
      if (this.closed || a + 2 < s ? u = i[(a + 2) % s] : (ta.subVectors(i[s - 1], i[s - 2]).add(i[s - 1]), u = ta), this.curveType === "centripetal" || this.curveType === "chordal") {
        ...
        g < 1e-4 && (g = 1), _ < 1e-4 && (_ = g), m < 1e-4 && (m = g), Tl.initNonuniformCatmullRom(c.x, h.x, f.x, u.x, _, g, m), El.initNonuniformCatmullRom(c.y, h.y, f.y, u.y, _, g, m), bl.initNonuniformCatmullRom(c.z, h.z, f.z, u.z, _, g, m);
      } else this.curveType === "catmullrom" && (Tl.initCatmullRom(c.x, h.x, f.x, u.x, this.tension), El.initCatmullRom(c.y, h.y, f.y, u.y, this.tension), bl.initCatmullRom(c.z, h.z, f.z, u.z, this.tension));
      return n.set(Tl.calc(l), El.calc(l), bl.calc(l)), n;
    }
    copy(e) {
  ...
  function Js(r, e, t, n, i) {
    return L_(r, e) + D_(r, t) + I_(r, n) + N_(r, i);
  }
  class $d extends jn {
    ...
    getPoint(e, t = new ee()) {
      ...
      return n.set(Js(e, i.x, s.x, o.x, a.x), Js(e, i.y, s.y, o.y, a.y)), n;
    }
    copy(e) {
  ...
  class U_ extends jn {
    ...
    getPoint(e, t = new D()) {
      const n = t, i = this.v0, s = this.v1, o = this.v2, a = this.v3;
      return n.set(Js(e, i.x, s.x, o.x, a.x), Js(e, i.y, s.y, o.y, a.y), Js(e, i.z, s.z, o.z, a.z)), n;
    }
    copy(e) {
      return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this.v3.copy(e.v3), this;
    }
  ...
  class Zd extends jn {
    ...
    getPoint(e, t = new ee()) {
      ...
      return n.set(Zs(e, i.x, s.x, o.x), Zs(e, i.y, s.y, o.y)), n;
    }
    copy(e) {
  ...
  class F_ extends jn {
    ...
    getPoint(e, t = new D()) {
      const n = t, i = this.v0, s = this.v1, o = this.v2;
      return n.set(Zs(e, i.x, s.x, o.x), Zs(e, i.y, s.y, o.y), Zs(e, i.z, s.z, o.z)), n;
    }
    copy(e) {
      return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this;
    }
  ...
  class Uc extends B_ {
    ...
    lineTo(e, t) {
      const n = new jd(this.currentPoint.clone(), new ee(e, t));
    ...
    bezierCurveTo(e, t, n, i, s, o) {
      const a = new $d(this.currentPoint.clone(), new ee(e, t), new ee(n, i), new ee(s, o));
    ...
    absellipse(e, t, n, i, s, o, a, l) {
      const c = new Eu(e, t, n, i, s, o, a, l);
  ...
  class _a extends Uc {
    ...
    fromJSON(e) {
      ...
      for (let t = 0, n = e.holes.length; t < n; t++) {
        const i = e.holes[t];
        this.holes.push(new Uc().fromJSON(i));
      }
      return this;
    }
  }
  ...
  function Er(r, e) {
    ...
    let t = r, n;
    do
      if (n = false, !t.steiner && (Ha(t, t.next) || xt(t.prev, t, t.next) === 0)) {
  ...
  function ho(r, e, t, n, i, s, o) {
    if (!r) return;
    !o && s && $_(r, n, i, s);
    let a = r, l, c;
    for (; r.prev !== r.next; ) {
      if (l = r.prev, c = r.next, s ? V_(r, n, i, s) : k_(r)) {
        e.push(l.i / t | 0), e.push(r.i / t | 0), e.push(c.i / t | 0), po(r), r = c.next, a = c.next;
        continue;
      }
      if (r = c, r === a) {
        o ? o === 1 ? (r = H_(Er(r), e, t), ho(r, e, t, n, i, s, 2)) : o === 2 && G_(r, e, t, n, i, s) : ho(Er(r), e, t, n, i, s, 1);
        break;
      }
    }
  }
  function k_(r) {
    ...
    let _ = n.next;
    for (; _ !== e; ) {
      if (_.x >= u && _.x <= f && _.y >= h && _.y <= d && $r(i, a, s, l, o, c, _.x, _.y) && xt(_.prev, _, _.next) >= 0) return false;
      _ = _.next;
    }
    return true;
  }
  function V_(r, e, t, n) {
    ...
    const a = i.x, l = s.x, c = o.x, u = i.y, h = s.y, f = o.y, d = a < l ? a < c ? a : c : l < c ? l : c, _ = u < h ? u < f ? u : f : h < f ? h : f, g = a > l ? a > c ? a : c : l > c ? l : c, m = u > h ? u > f ? u : f : h > f ? h : f, p = Oc(d, _, e, t, n), S = Oc(g, m, e, t, n);
    let v = r.prevZ, x = r.nextZ;
    for (; v && v.z >= p && x && x.z <= S; ) {
      if (v.x >= d && v.x <= g && v.y >= _ && v.y <= m && v !== i && v !== o && $r(a, u, l, h, c, f, v.x, v.y) && xt(v.prev, v, v.next) >= 0 || (v = v.prevZ, x.x >= d && x.x <= g && x.y >= _ && x.y <= m && x !== i && x !== o && $r(a, u, l, h, c, f, x.x, x.y) && xt(x.prev, x, x.next) >= 0)) return false;
      x = x.nextZ;
    }
    for (; v && v.z >= p; ) {
      if (v.x >= d && v.x <= g && v.y >= _ && v.y <= m && v !== i && v !== o && $r(a, u, l, h, c, f, v.x, v.y) && xt(v.prev, v, v.next) >= 0) return false;
      v = v.prevZ;
    }
    for (; x && x.z <= S; ) {
      if (x.x >= d && x.x <= g && x.y >= _ && x.y <= m && x !== i && x !== o && $r(a, u, l, h, c, f, x.x, x.y) && xt(x.prev, x, x.next) >= 0) return false;
      x = x.nextZ;
    }
    return true;
  }
  function H_(r, e, t) {
    ...
    do {
      ...
      !Ha(i, s) && ep(i, n, n.next, s) && fo(i, s) && fo(s, i) && (e.push(i.i / t | 0), e.push(n.i / t | 0), e.push(s.i / t | 0), po(n), po(n.next), n = r = s), n = n.next;
    } while (n !== r);
    return Er(n);
  }
  function G_(r, e, t, n, i, s) {
    let o = r;
    do {
      let a = o.next.next;
      for (; a !== o.prev; ) {
        if (o.i !== a.i && J_(o, a)) {
          let l = tp(o, a);
          o = Er(o, o.next), l = Er(l, l.next), ho(o, e, t, n, i, s, 0), ho(l, e, t, n, i, s, 0);
          return;
        }
        a = a.next;
      }
  ...
  function W_(r, e, t, n) {
    const i = [];
    let s, o, a, l, c;
    for (s = 0, o = e.length; s < o; s++) a = e[s] * n, l = s < o - 1 ? e[s + 1] * n : r.length, c = Qd(r, a, l, n, false), c === c.next && (c.steiner = true), i.push(Z_(c));
    for (i.sort(X_), s = 0; s < i.length; s++) t = q_(i[s], t);
    return t;
  }
  function X_(r, e) {
    return r.x - e.x;
  ...
  function q_(r, e) {
    ...
    if (!t) return e;
    const n = tp(t, r);
    return Er(n, n.next), Er(t, t.next);
  }
  function Y_(r, e) {
    let t = e, n = -1 / 0, i;
    const s = r.x, o = r.y;
    ...
    t = i;
    do
      s >= t.x && t.x >= l && s !== t.x && $r(o < c ? s : n, o, l, c, o < c ? n : s, o, t.x, t.y) && (h = Math.abs(o - t.y) / (s - t.x), fo(t, r) && (h < u || h === u && (t.x > i.x || t.x === i.x && K_(i, t))) && (i = t, u = h)), t = t.next;
    while (t !== a);
    return i;
  }
  function K_(r, e) {
  ...
  function $_(r, e, t, n) {
    let i = r;
    do
      i.z === 0 && (i.z = Oc(i.x, i.y, e, t, n)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
    while (i !== r);
    i.prevZ.nextZ = null, i.prevZ = null, j_(i);
  }
  function j_(r) {
  ...
  function $r(r, e, t, n, i, s, o, a) {
    return (i - o) * (e - a) >= (r - o) * (s - a) && (r - o) * (n - a) >= (t - o) * (e - a) && (t - o) * (s - a) >= (i - o) * (n - a);
  }
  function J_(r, e) {
    return r.next.i !== e.i && r.prev.i !== e.i && !Q_(r, e) && (fo(r, e) && fo(e, r) && e0(r, e) && (xt(r.prev, r, e.prev) || xt(r, e.prev, e)) || Ha(r, e) && xt(r.prev, r, r.next) > 0 && xt(e.prev, e, e.next) > 0);
  }
  function xt(r, e, t) {
  ...
  function ep(r, e, t, n) {
    const i = ia(xt(r, e, t)), s = ia(xt(r, e, n)), o = ia(xt(t, n, r)), a = ia(xt(t, n, e));
    return !!(i !== s && o !== a || i === 0 && na(r, t, e) || s === 0 && na(r, n, e) || o === 0 && na(t, r, n) || a === 0 && na(t, e, n));
  }
  function na(r, e, t) {
  ...
  function tp(r, e) {
    const t = new Fc(r.i, r.x, r.y), n = new Fc(e.i, e.x, e.y), i = r.next, s = e.prev;
    return r.next = e, e.prev = r, t.next = i, i.prev = t, n.next = t, t.prev = n, s.next = n, n.prev = s, n;
  }
  function af(r, e, t, n) {
    const i = new Fc(r, e, t);
  ...
  class wu extends cn {
    constructor(e = new _a([
      ...
      function o(a) {
        ...
        const p = t.extrudePath, S = t.UVGenerator !== void 0 ? t.UVGenerator : n0;
        ...
        if (!ns.isClockWise(M)) {
          ...
          for (let Q = 0, J = L.length; Q < J; Q++) {
            const C = L[Q];
            ns.isClockWise(C) && (L[Q] = C.reverse());
          }
        }
        const O = ns.triangulateShape(M, L), V = M;
        for (let Q = 0, J = L.length; Q < J; Q++) {
          const C = L[Q];
          M = M.concat(C);
        }
        ...
        function Ae(Q, J, C) {
          we(Q), we(J), we(C);
          const be = i.length / 3, te = S.generateTopUV(n, i, be - 3, be - 2, be - 1);
          Qe(te[0]), Qe(te[1]), Qe(te[2]);
        }
        function $e(Q, J, C, be) {
          we(Q), we(J), we(be), we(J), we(C), we(be);
          const te = i.length / 3, xe = S.generateSideWallUV(n, i, te - 6, te - 3, te - 2, te - 1);
    ...
    static fromJSON(e, t) {
      ...
      return i !== void 0 && (e.options.extrudePath = new Nc[i.type]().fromJSON(i)), new wu(n, e.options);
    }
  }
  const n0 = {
  ...
  class bo extends cn {
    constructor(e = 1, t = 1, n = 1, i = 1) {
      ...
      for (let p = 0; p < u; p++) {
        ...
        for (let v = 0; v < c; v++) {
          const x = v * h - s;
          _.push(x, -S, 0), g.push(0, 0, 1), m.push(v / a), m.push(1 - p / l);
        }
      }
      for (let p = 0; p < l; p++) for (let S = 0; S < a; S++) {
        const v = S + c * p, x = S + c * (p + 1), b = S + 1 + c * (p + 1), w = S + 1 + c * p;
  ...
  class Au extends cn {
    constructor(e = 1, t = 32, n = 16, i = 0, s = Math.PI * 2, o = 0, a = Math.PI) {
      ...
      for (let p = 0; p <= n; p++) {
        ...
        for (let b = 0; b <= t; b++) {
          const w = b / t;
          h.x = -e * Math.cos(i + w * s) * Math.sin(o + v * a), h.y = e * Math.cos(o + v * a), h.z = e * Math.sin(i + w * s) * Math.sin(o + v * a), _.push(h.x, h.y, h.z), f.copy(h).normalize(), g.push(f.x, f.y, f.z), m.push(w + x, 1 - v), S.push(c++);
        }
        u.push(S);
      }
      for (let p = 0; p < n; p++) for (let S = 0; S < t; S++) {
        const v = u[p][S + 1], x = u[p][S], b = u[p + 1][S], w = u[p + 1][S + 1];
    ...
    static fromJSON(e) {
      return new Au(e.radius, e.widthSegments, e.heightSegments, e.phiStart, e.phiLength, e.thetaStart, e.thetaLength);
    }
  }
  class wo extends Xn {
    constructor(e) {
  ...
  class r0 extends Xn {
    constructor(e) {
      super(), this.isMeshDepthMaterial = true, this.type = "MeshDepthMaterial", this.depthPacking = pg, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = false, this.wireframeLinewidth = 1, this.setValues(e);
    }
    copy(e) {
  ...
  class l0 extends Ao {
    ...
    interpolate_(e, t, n, i) {
      const s = this.resultBuffer, o = this.sampleValues, a = this.valueSize, l = e * a, c = l - a, u = this._offsetPrev, h = this._offsetNext, f = this._weightPrev, d = this._weightNext, _ = (n - t) / (i - t), g = _ * _, m = g * _, p = -f * m + 2 * f * g - f * _, S = (1 + f) * m + (-1.5 - 2 * f) * g + (-0.5 + f) * _ + 1, v = (-1 - d) * m + (1.5 + d) * g + 0.5 * _, x = d * m - d * g;
      for (let b = 0; b !== a; ++b) s[b] = p * o[u + b] + S * o[c + b] + v * o[l + b] + x * o[h + b];
      return s;
    }
  }
  class c0 extends Ao {
  ...
  class Jn {
    constructor(e, t, n, i) {
      ...
      this.name = e, this.times = ra(t, this.TimeBufferType), this.values = ra(n, this.ValueBufferType), this.setInterpolation(i || this.DefaultInterpolation);
    }
    static toJSON(e) {
    ...
    validate() {
      ...
      if (i !== void 0 && o0(i)) for (let a = 0, l = i.length; a !== l; ++a) {
        const c = i[a];
        if (isNaN(c)) {
    ...
    optimize() {
      const e = this.times.slice(), t = this.values.slice(), n = this.getValueSize(), i = this.getInterpolation() === Ja, s = e.length - 1;
      let o = 1;
      for (let a = 1; a < s; ++a) {
        let l = false;
        const c = e[a], u = e[a + 1];
  ...
  Jn.prototype.TimeBufferType = Float32Array;
  Jn.prototype.ValueBufferType = Float32Array;
  Jn.prototype.DefaultInterpolation = co;
  class Rs extends Jn {
    constructor(e, t, n) {
      super(e, t, n);
    }
  ...
  Rs.prototype.DefaultInterpolation = lo;
  ...
  class _s extends Jn {
    InterpolantFactoryMethodLinear(e) {
      return new h0(this.times, this.values, this.getValueSize(), e);
    }
  }
  ...
  Cs.prototype.DefaultInterpolation = lo;
  ...
  class f0 {
    ...
    static toJSON(e) {
      ...
      for (let s = 0, o = n.length; s !== o; ++s) t.push(Jn.toJSON(n[s]));
      return i;
    }
    static CreateFromMorphTargetSequence(e, t, n, i) {
      ...
      for (let a = 0; a < s; a++) {
        ...
        const u = a0(l);
        l = uf(l, 1, u), c = uf(c, 1, u), !i && l[0] === 0 && (l.push(s), c.push(c[0])), o.push(new gs(".morphTargetInfluences[" + t[a].name + "]", l, c).scale(1 / n));
      }
    ...
    static parseAnimation(e, t) {
      ...
      for (let h = 0; h < c.length; h++) {
        ...
        if (!(!f || f.length === 0)) if (f[0].morphTargets) {
          ...
          for (const g in d) {
            const m = [], p = [];
            for (let S = 0; S !== f[_].morphTargets.length; ++S) {
              const v = f[_];
  ...
  class Ar {
    constructor(e) {
      this.manager = e !== void 0 ? e : g0, this.crossOrigin = "anonymous", this.withCredentials = false, this.path = "", this.resourcePath = "", this.requestHeader = {};
    }
    load() {
    }
    loadAsync(e, t) {
    ...
    load(e, t, n, i) {
      ...
      fetch(o).then((c) => {
        if (c.status === 200 || c.status === 0) {
          ...
          const u = si[e], h = c.body.getReader(), f = c.headers.get("X-File-Size") || c.headers.get("Content-Length"), d = f ? parseInt(f) : 0, _ = d !== 0;
          let g = 0;
        ...
        } else throw new _0(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`, c);
      }).then((c) => {
        switch (l) {
          case "arraybuffer":
  ...
  class v0 extends Ar {
    ...
    load(e, t, n, i) {
      const s = new Ct(), o = new x0(this.manager);
  ...
  const wl = new Fe(), hf = new D(), ff = new D();
  class Cu {
    constructor(e) {
      this.camera = e, this.intensity = 1, this.bias = 0, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new ee(512, 512), this.map = null, this.mapPass = null, this.matrix = new Fe(), this.autoUpdate = true, this.needsUpdate = false, this._frustum = new Su(), this._frameExtents = new ee(1, 1), this._viewportCount = 1, this._viewports = [
        new et(0, 0, 1, 1)
      ];
    }
    getViewportCount() {
    ...
    updateMatrices(e) {
      ...
      hf.setFromMatrixPosition(e.matrixWorld), t.position.copy(hf), ff.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(ff), t.updateMatrixWorld(), wl.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(wl), n.set(0.5, 0, 0, 0.5, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0.5, 0, 0, 0, 1), n.multiply(wl);
    }
    getViewport(e) {
  ...
  class S0 extends Ga {
    constructor(e, t, n = 0, i = Math.PI / 3, s = 0, o = 2) {
      super(e, t), this.isSpotLight = true, this.type = "SpotLight", this.position.copy(gt.DEFAULT_UP), this.updateMatrix(), this.target = new gt(), this.distance = n, this.angle = i, this.penumbra = s, this.decay = o, this.map = null, this.shadow = new y0();
    }
    get power() {
  ...
  const df = new Fe(), zs = new D(), Al = new D();
  class M0 extends Cu {
    constructor() {
    ...
    updateMatrices(e, t = 0) {
      ...
      s !== n.far && (n.far = s, n.updateProjectionMatrix()), zs.setFromMatrixPosition(e.matrixWorld), n.position.copy(zs), Al.copy(n.position), Al.add(this._cubeDirections[t]), n.up.copy(this._cubeUps[t]), n.lookAt(Al), n.updateMatrixWorld(), i.makeTranslation(-zs.x, -zs.y, -zs.z), df.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse), this._frustum.setFromProjectionMatrix(df);
    }
  }
  class Pu extends Ga {
    constructor(e, t, n = 0, i = 2) {
      super(e, t), this.isPointLight = true, this.type = "PointLight", this.distance = n, this.decay = i, this.shadow = new M0();
    }
    get power() {
  ...
  class Da extends Ga {
    constructor(e, t) {
      super(e, t), this.isDirectionalLight = true, this.type = "DirectionalLight", this.position.copy(gt.DEFAULT_UP), this.updateMatrix(), this.target = new gt(), this.shadow = new T0();
    }
    dispose() {
      this.shadow.dispose();
    }
  ...
  const Lu = "\\[\\]\\.:\\/", A0 = new RegExp("[" + Lu + "]", "g"), Du = "[^" + Lu + "]", R0 = "[^" + Lu.replace("\\.", "") + "]", C0 = /((?:WC+[\/:])*)/.source.replace("WC", Du), P0 = /(WCOD+)?/.source.replace("WCOD", R0), L0 = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", Du), D0 = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", Du), I0 = new RegExp("^" + C0 + P0 + L0 + D0 + "$"), N0 = [
    "material",
    "materials",
    "bones",
    "map"
  ...
  class ot {
    ...
    static sanitizeNodeName(e) {
      return e.replace(/\s/g, "_").replace(A0, "");
    }
    static parseTrackName(e) {
      ...
      if (i !== void 0 && i !== -1) {
        ...
        N0.indexOf(s) !== -1 && (n.nodeName = n.nodeName.substring(0, i), n.objectName = s);
      }
  ...
  class Rr {
    constructor(e, t, n = 0, i = 1 / 0) {
      this.ray = new Eo(e, t), this.near = n, this.far = i, this.camera = null, this.layers = new xu(), this.params = {
        Mesh: {},
        Line: {
          threshold: 1
        },
    ...
    intersectObject(e, t = true, n = []) {
      return Bc(e, this, n, t), n.sort(gf), n;
    }
    intersectObjects(e, t = true, n = []) {
      for (let i = 0, s = e.length; i < s; i++) Bc(e[i], this, n, t);
      return n.sort(gf), n;
    }
  }
  function gf(r, e) {
  ...
  function Bc(r, e, t, n) {
    ...
    if (r.layers.test(e.layers) && r.raycast(e, t) === false && (i = false), i === true && n === true) {
      const s = r.children;
      for (let o = 0, a = s.length; o < a; o++) Bc(s[o], e, t, true);
    }
  }
  class O0 {
    constructor() {
    ...
    moveTo(e, t) {
      return this.currentPath = new Uc(), this.subPaths.push(this.currentPath), this.currentPath.moveTo(e, t), this;
    }
    lineTo(e, t) {
    ...
    toShapes(e) {
      function t(p) {
        ...
        for (let v = 0, x = p.length; v < x; v++) {
          const b = p[v], w = new _a();
          w.curves = b.curves, S.push(w);
        }
        return S;
      }
      function n(p, S) {
        ...
        for (let b = v - 1, w = 0; w < v; b = w++) {
          let A = S[b], P = S[w], y = P.x - A.x, M = P.y - A.y;
          if (Math.abs(M) > Number.EPSILON) {
            if (M < 0 && (A = S[w], y = -y, P = S[b], M = -M), p.y < A.y || p.y > P.y) continue;
            if (p.y === A.y) {
              if (p.x === A.x) return true;
            } else {
              const L = M * (p.x - A.x) - y * (p.y - A.y);
              if (L === 0) return true;
              if (L < 0) continue;
              x = !x;
            }
      ...
      const i = ns.isClockWise, s = this.subPaths;
      if (s.length === 0) return [];
      let o, a, l;
      const c = [];
      if (s.length === 1) return a = s[0], l = new _a(), l.curves = a.curves, c.push(l), c;
      let u = !i(s[0].getPoints());
      u = e ? !u : u;
      const h = [], f = [];
      let d = [], _ = 0, g;
      f[_] = void 0, d[_] = [];
      for (let p = 0, S = s.length; p < S; p++) a = s[p], g = a.getPoints(), o = i(g), o = e ? !o : o, o ? (!u && f[_] && _++, f[_] = {
        s: new _a(),
        p: g
      ...
      if (f.length > 1) {
        ...
        for (let v = 0, x = f.length; v < x; v++) {
          ...
          for (let w = 0; w < b.length; w++) {
            const A = b[w];
            let P = true;
            for (let y = 0; y < f.length; y++) n(A.p, f[y].p) && (v !== y && S++, P ? (P = false, h[y].push(A)) : p = true);
            P && h[v].push(A);
          }
        }
        S > 0 && p === false && (d = h);
...
void main() {
    ...
    alphahash_fragment: z0,
    alphahash_pars_fragment: k0,
    alphamap_fragment: V0,
    alphamap_pars_fragment: H0,
    alphatest_fragment: G0,
    alphatest_pars_fragment: W0,
    aomap_fragment: X0,
    aomap_pars_fragment: q0,
    batching_pars_vertex: Y0,
    batching_vertex: K0,
    begin_vertex: $0,
    beginnormal_vertex: j0,
    bsdfs: Z0,
    iridescence_fragment: J0,
    bumpmap_pars_fragment: Q0,
    clipping_planes_fragment: ex,
    clipping_planes_pars_fragment: tx,
    clipping_planes_pars_vertex: nx,
    clipping_planes_vertex: ix,
    color_fragment: rx,
    color_pars_fragment: sx,
    color_pars_vertex: ox,
    color_vertex: ax,
    common: lx,
    cube_uv_reflection_fragment: cx,
    defaultnormal_vertex: ux,
    displacementmap_pars_vertex: hx,
    displacementmap_vertex: fx,
    emissivemap_fragment: dx,
    emissivemap_pars_fragment: px,
    colorspace_fragment: mx,
    colorspace_pars_fragment: gx,
    envmap_fragment: _x,
    envmap_common_pars_fragment: xx,
    envmap_pars_fragment: vx,
    envmap_pars_vertex: yx,
    envmap_physical_pars_fragment: Lx,
    envmap_vertex: Sx,
    fog_vertex: Mx,
    fog_pars_vertex: Tx,
    fog_fragment: Ex,
    fog_pars_fragment: bx,
    gradientmap_pars_fragment: wx,
    lightmap_pars_fragment: Ax,
    lights_lambert_fragment: Rx,
    lights_lambert_pars_fragment: Cx,
    lights_pars_begin: Px,
    lights_toon_fragment: Dx,
    lights_toon_pars_fragment: Ix,
    lights_phong_fragment: Nx,
    lights_phong_pars_fragment: Ux,
    lights_physical_fragment: Ox,
    lights_physical_pars_fragment: Fx,
    lights_fragment_begin: Bx,
    lights_fragment_maps: zx,
    lights_fragment_end: kx,
    logdepthbuf_fragment: Vx,
    logdepthbuf_pars_fragment: Hx,
    logdepthbuf_pars_vertex: Gx,
    logdepthbuf_vertex: Wx,
    map_fragment: Xx,
    map_pars_fragment: qx,
    map_particle_fragment: Yx,
    map_particle_pars_fragment: Kx,
    metalnessmap_fragment: $x,
    metalnessmap_pars_fragment: jx,
    morphinstance_vertex: Zx,
    morphcolor_vertex: Jx,
    morphnormal_vertex: Qx,
    morphtarget_pars_vertex: ev,
    morphtarget_vertex: tv,
    normal_fragment_begin: nv,
    normal_fragment_maps: iv,
    normal_pars_fragment: rv,
    normal_pars_vertex: sv,
    normal_vertex: ov,
    normalmap_pars_fragment: av,
    clearcoat_normal_fragment_begin: lv,
    clearcoat_normal_fragment_maps: cv,
    clearcoat_pars_fragment: uv,
    iridescence_pars_fragment: hv,
    opaque_fragment: fv,
    packing: dv,
    premultiplied_alpha_fragment: pv,
    project_vertex: mv,
    dithering_fragment: gv,
    dithering_pars_fragment: _v,
    roughnessmap_fragment: xv,
    roughnessmap_pars_fragment: vv,
    shadowmap_pars_fragment: yv,
    shadowmap_pars_vertex: Sv,
    shadowmap_vertex: Mv,
    shadowmask_pars_fragment: Tv,
    skinbase_vertex: Ev,
    skinning_pars_vertex: bv,
    skinning_vertex: wv,
    skinnormal_vertex: Av,
    specularmap_fragment: Rv,
    specularmap_pars_fragment: Cv,
    tonemapping_fragment: Pv,
    tonemapping_pars_fragment: Lv,
    transmission_fragment: Dv,
    transmission_pars_fragment: Iv,
    uv_pars_fragment: Nv,
    uv_pars_vertex: Uv,
    uv_vertex: Ov,
    worldpos_vertex: Fv,
    background_vert: Bv,
    background_frag: zv,
    backgroundCube_vert: kv,
    backgroundCube_frag: Vv,
    cube_vert: Hv,
    cube_frag: Gv,
    depth_vert: Wv,
    depth_frag: Xv,
  ...
  function vy(r, e, t, n, i, s, o) {
    ...
    function m(v, x) {
      const b = _(x);
      b && (b.isCubeTexture || b.mapping === Va) ? (u === void 0 && (u = new Rt(new wr(1, 1, 1), new Gt({
        name: "BackgroundCubeMaterial",
        uniforms: ms(kn.backgroundCube.uniforms),
      ...
      }), i.update(u)), nr.copy(x.backgroundRotation), nr.x *= -1, nr.y *= -1, nr.z *= -1, b.isCubeTexture && b.isRenderTargetTexture === false && (nr.y *= -1, nr.z *= -1), u.material.uniforms.envMap.value = b, u.material.uniforms.flipEnvMap.value = b.isCubeTexture && b.isRenderTargetTexture === false ? -1 : 1, u.material.uniforms.backgroundBlurriness.value = x.backgroundBlurriness, u.material.uniforms.backgroundIntensity.value = x.backgroundIntensity, u.material.uniforms.backgroundRotation.value.setFromMatrix4(xy.makeRotationFromEuler(nr)), u.material.toneMapped = Ye.getTransfer(b.colorSpace) !== lt, (h !== b || f !== b.version || d !== r.toneMapping) && (u.material.needsUpdate = true, h = b, f = b.version, d = r.toneMapping), u.layers.enableAll(), v.unshift(u, u.geometry, u.material, 0, 0, null)) : b && b.isTexture && (c === void 0 && (c = new Rt(new bo(2, 2), new Gt({
        name: "BackgroundMaterial",
        uniforms: ms(kn.background.uniforms),
    ...
    function p(v, x) {
      v.getRGB(sa, Vd(r)), n.buffers.color.setClear(sa.r, sa.g, sa.b, x, o);
    }
    function S() {
      ...
      for (const $ in q) {
        ...
        if (H.location >= 0) {
          ...
          if (oe === void 0 && ($ === "instanceMatrix" && M.instanceMatrix && (oe = M.instanceMatrix), $ === "instanceColor" && M.instanceColor && (oe = M.instanceColor)), oe !== void 0) {
            ...
            const Ke = Le.buffer, X = Le.type, ie = Le.bytesPerElement, Te = X === r.INT || X === r.UNSIGNED_INT || oe.gpuType === uu;
  ...
  function My(r, e, t, n) {
    ...
    function a(A) {
      const P = A === vi && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
      return !(A !== Mi && n.convert(A) !== r.getParameter(r.IMPLEMENTATION_COLOR_READ_TYPE) && A !== Un && !P);
    }
    function l(A) {
      if (A === "highp") {
  ...
  function Ty(r) {
    ...
    this.uniform = l, this.numPlanes = 0, this.numIntersection = 0, this.init = function(h, f) {
      ...
      if (!i || _ === null || _.length === 0 || s && !m) s ? u(null) : c();
        ...
        p.clippingState = x, this.numIntersection = g ? this.numPlanes : 0, this.numPlanes += S;
      }
    };
    function c() {
    ...
    function u(h, f, d, _) {
      ...
      if (g !== 0) {
        if (m = l.value, _ !== true || m === null) {
          const p = d + g * 4, S = f.matrixWorldInverse;
          a.getNormalMatrix(S), (m === null || m.length < p) && (m = new Float32Array(p));
          for (let v = 0, x = d; v !== g; ++v, x += 4) o.copy(h[v]).applyMatrix4(S, a), o.normal.toArray(m, x), m[x + 3] = o.constant;
        }
  ...
  function Ey(r) {
    ...
    function t(o, a) {
      return a === nc ? o.mapping = cs : a === ic && (o.mapping = us), o;
    }
    function n(o) {
      if (o && o.isTexture) {
        const a = o.mapping;
        if (a === nc || a === ic) if (e.has(o)) {
          const l = e.get(o).texture;
          return t(l, o.mapping);
        } else {
          const l = o.image;
          if (l && l.height > 0) {
            const c = new f_(l.height);
  ...
  const jr = 4, xf = [
    ...
    0.526,
    0.582
  ], dr = 20, Rl = new Wa(), vf = new Re();
  let Cl = null, Pl = 0, Ll = 0, Dl = false;
  const cr = (1 + Math.sqrt(5)) / 2, qr = 1 / cr, yf = [
    new D(-cr, qr, 0),
    new D(cr, qr, 0),
    new D(-qr, 0, cr),
    new D(qr, 0, cr),
  ...
  class Sf {
    ...
    fromScene(e, t = 0, n = 0.1, i = 100) {
      Cl = this._renderer.getRenderTarget(), Pl = this._renderer.getActiveCubeFace(), Ll = this._renderer.getActiveMipmapLevel(), Dl = this._renderer.xr.enabled, this._renderer.xr.enabled = false, this._setSize(256);
    ...
    compileCubemapShader() {
      this._cubemapMaterial === null && (this._cubemapMaterial = Ef(), this._compileMaterial(this._cubemapMaterial));
    }
    compileEquirectangularShader() {
      this._equirectMaterial === null && (this._equirectMaterial = Tf(), this._compileMaterial(this._equirectMaterial));
    }
    dispose() {
    ...
    _cleanup(e) {
      this._renderer.setRenderTarget(Cl, Pl, Ll), this._renderer.xr.enabled = Dl, e.scissorTest = false, oa(e, 0, 0, e.width, e.height);
    }
    _fromTexture(e, t) {
      e.mapping === cs || e.mapping === us ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Cl = this._renderer.getRenderTarget(), Pl = this._renderer.getActiveCubeFace(), Ll = this._renderer.getActiveMipmapLevel(), Dl = this._renderer.xr.enabled, this._renderer.xr.enabled = false;
    ...
    _allocateTargets() {
      ...
      if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
        ...
        ({ sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas } = by(s)), this._blurMaterial = wy(s, e, t);
      }
      return i;
    }
    _compileMaterial(e) {
      const t = new Rt(this._lodPlanes[0], e);
      this._renderer.compile(t, Rl);
    }
    _sceneToCubeUV(e, t, n, i) {
      ...
      for (let p = 0; p < 6; p++) {
        ...
        oa(i, S * v, p > 2 ? v : 0, v, v), u.setRenderTarget(i), g && u.render(_, a), u.render(e, a);
      }
    ...
    _textureToCubeUV(e, t) {
      ...
      i ? (this._cubemapMaterial === null && (this._cubemapMaterial = Ef()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === false ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Tf());
      const s = i ? this._cubemapMaterial : this._equirectMaterial, o = new Rt(this._lodPlanes[0], s), a = s.uniforms;
      a.envMap.value = e;
      const l = this._cubeSize;
      oa(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(o, Rl);
    }
    _applyPMREM(e) {
    ...
    _halfBlur(e, t, n, i, s, o, a) {
      ...
      const u = 3, h = new Rt(this._lodPlanes[i], c), f = c.uniforms, d = this._sizeLods[n] - 1, _ = isFinite(s) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * dr - 1), g = s / _, m = isFinite(s) ? 1 + Math.floor(u * g) : dr;
      m > dr && console.warn(`sigmaRadians, ${s}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${dr}`);
      const p = [];
      let S = 0;
      for (let A = 0; A < dr; ++A) {
        const P = A / g, y = Math.exp(-P * P / 2);
        p.push(y), A === 0 ? S += y : A < m && (S += 2 * y);
      }
      for (let A = 0; A < p.length; A++) p[A] = p[A] / S;
      ...
      const x = this._sizeLods[i], b = 3 * x * (i > v - jr ? i - v + jr : 0), w = 4 * (this._cubeSize - x);
      oa(t, b, w, 3 * x, 2 * x), l.setRenderTarget(t), l.render(h, Rl);
    }
  }
  function by(r) {
    const e = [], t = [], n = [];
    let i = r;
    const s = r - jr + 1 + xf.length;
    for (let o = 0; o < s; o++) {
      const a = Math.pow(2, i);
      t.push(a);
      let l = 1 / a;
      o > r - jr ? l = xf[o - r + jr - 1] : o === 0 && (l = 0), n.push(l);
      const c = 1 / (a - 2), u = -c, h = 1 + c, f = [
        ...
        u,
        h
      ], d = 6, _ = 6, g = 3, m = 2, p = 1, S = new Float32Array(g * _ * d), v = new Float32Array(m * _ * d), x = new Float32Array(p * _ * d);
      for (let w = 0; w < d; w++) {
      ...
      const b = new cn();
      b.setAttribute("position", new Jt(S, g)), b.setAttribute("uv", new Jt(v, m)), b.setAttribute("faceIndex", new Jt(x, p)), e.push(b), i > jr && i--;
    }
    return {
      lodPlanes: e,
      sizeLods: t,
  ...
  function Mf(r, e, t) {
    ...
    return n.texture.mapping = Va, n.texture.name = "PMREM.cubeUv", n.scissorTest = true, n;
  }
  function oa(r, e, t, n, i) {
    r.viewport.set(e, t, n, i), r.scissor.set(e, t, n, i);
  }
  function wy(r, e, t) {
    const n = new Float32Array(dr), i = new D(0, 1, 0);
    return new Gt({
  ...
  function Ay(r) {
    ...
    function n(a) {
      if (a && a.isTexture) {
        const l = a.mapping, c = l === nc || l === ic, u = l === cs || l === us;
        if (c || u) {
          let h = e.get(a);
  ...
  function Ry(r) {
    ...
    return {
      ...
      get: function(n) {
        const i = t(n);
        return i === null && Kr("THREE.WebGLRenderer: " + n + " extension not supported."), i;
      }
    };
  }
  function Cy(r, e, t, n) {
    ...
    function c(h) {
      ...
      if (d !== null) {
        const S = d.array;
        g = d.version;
        for (let v = 0, x = S.length; v < x; v += 3) {
          const b = S[v + 0], w = S[v + 1], A = S[v + 2];
          f.push(b, w, w, A, A, b);
        }
      } else if (_ !== void 0) {
        const S = _.array;
        g = _.version;
        for (let v = 0, x = S.length / 3 - 1; v < x; v += 3) {
  ...
  function Dy(r, e, t) {
    ...
    function s(o, a, l) {
      ...
      if (f === void 0 || f.count !== h) {
        ...
        const d = a.morphAttributes.position !== void 0, _ = a.morphAttributes.normal !== void 0, g = a.morphAttributes.color !== void 0, m = a.morphAttributes.position || [], p = a.morphAttributes.normal || [], S = a.morphAttributes.color || [];
        let v = 0;
        ...
        const w = new Float32Array(x * b * 4 * h), A = new Fd(w, x, b, h);
        A.type = Un, A.needsUpdate = true;
        const P = v * 4;
        for (let M = 0; M < h; M++) {
          const L = m[M], G = p[M], O = S[M], V = x * b * 4 * M;
  ...
  const op = new Ct(), bf = new Kd(1, 1), ap = new Fd(), lp = new jg(), cp = new Gd(), wf = [], Af = [], Rf = new Float32Array(16), Cf = new Float32Array(9), Pf = new Float32Array(4);
  function Ps(r, e, t) {
    const n = r[0];
    if (n <= 0 || n > 0) return r;
    const i = e * t;
  ...
  function mS(r, e, t) {
    const n = this.cache, i = e.length, s = Xa(t, i);
  ...
  function TS(r, e, t) {
    ...
    for (Il.lastIndex = 0; ; ) {
      const s = Il.exec(n), o = Il.lastIndex;
      let a = s[1];
      const l = s[2] === "]", c = s[3];
      if (l && (a = a | 0), c === void 0 || c === "[" && o + 2 === i) {
        Lf(t, c === void 0 ? new yS(a, r, e) : new SS(a, r, e));
        break;
      } else {
        let h = t.map[a];
        h === void 0 && (h = new MS(a), Lf(t, h)), t = h;
      }
    }
  }
  class xa {
...
`);
  ...
  const aa = new D();
  function PS() {
    Ye.getLuminanceCoefficients(aa);
...
#define LOW_PRECISION`), e;
  ...
  function zS(r) {
    ...
    return r.shadowMapType === vd ? e = "SHADOWMAP_TYPE_PCF" : r.shadowMapType === Fm ? e = "SHADOWMAP_TYPE_PCF_SOFT" : r.shadowMapType === ai && (e = "SHADOWMAP_TYPE_VSM"), e;
  }
  function kS(r) {
  ...
  function WS(r, e, t, n) {
    ...
    const l = zS(t), c = kS(t), u = VS(t), h = HS(t), f = GS(t), d = LS(t), _ = DS(s), g = i.createProgram();
...
`), p = [
      ...
      t.toneMapping !== ki ? CS("toneMapping", t.toneMapping) : "",
      t.dithering ? "#define DITHERING" : "",
      t.opaque ? "#define OPAQUE" : "",
      Ve.colorspace_pars_fragment,
      RS("linearToOutputTexel", t.outputColorSpace),
      PS(),
      t.useDepthPacking ? "#define DEPTH_PACKING " + t.depthPacking : "",
      `
`
    ].filter(Gs).join(`
`)), o = zc(o), o = Uf(o, t), o = Of(o, t), a = zc(a), a = Uf(a, t), a = Of(a, t), o = Ff(o), a = Ff(a), t.isRawShaderMaterial !== true && (S = `#version 300 es
`, m = [
      d,
      "#define attribute in",
      "#define varying out",
...
`) + `
` + p);
    const v = S + m + o, x = S + p + a, b = Df(i, i.VERTEX_SHADER, v), w = Df(i, i.FRAGMENT_SHADER, x);
    ...
    function A(L) {
      if (r.debug.checkShaderErrors) {
        ...
        if (i.getProgramParameter(g, i.LINK_STATUS) === false) if (q = false, typeof r.debug.onShaderError == "function") r.debug.onShaderError(i, g, b, w);
          ...
          const $ = Nf(i, b, "vertex"), H = Nf(i, w, "fragment");
...
` + H);
      ...
      i.deleteShader(b), i.deleteShader(w), P = new xa(i, g), y = IS(i, g);
    }
    let P;
    ...
    return this.isReady = function() {
      return M === false && (M = i.getProgramParameter(g, ES)), M;
    }, this.destroy = function() {
      n.releaseStatesOfProgram(this), i.deleteProgram(g), this.program = void 0;
    }, this.type = t.shaderType, this.name = t.shaderName, this.id = bS++, this.cacheKey = e, this.usedTimes = 1, this.program = g, this.vertexShader = b, this.fragmentShader = w, this;
  }
  let XS = 0;
  class qS {
    constructor() {
  ...
  function KS(r, e, t, n, i, s, o) {
    const a = new xu(), l = new qS(), c = /* @__PURE__ */ new Set(), u = [], h = i.logarithmicDepthBuffer, f = i.vertexTextures;
    let d = i.precision;
    const _ = {
    ...
    function m(y, M, L, G, O) {
      const V = G.fog, q = O.geometry, B = y.isMeshStandardMaterial ? G.environment : null, $ = (y.isMeshStandardMaterial ? t : e).get(y.envMap || B), H = $ && $.mapping === Va ? $.image.height : null, oe = _[y.type];
      ...
      } else Ke = y.vertexShader, X = y.fragmentShader, l.update(y), ie = l.getVertexShaderID(y), Te = l.getFragmentShaderID(y);
      const ae = r.getRenderTarget(), Ae = r.state.buffers.depth.getReversed(), $e = O.isInstancedMesh === true, we = O.isBatchedMesh === true, Qe = !!y.map, Q = !!y.matcap, J = !!$, C = !!y.aoMap, be = !!y.lightMap, te = !!y.bumpMap, xe = !!y.normalMap, se = !!y.displacementMap, Ie = !!y.emissiveMap, de = !!y.metalnessMap, R = !!y.roughnessMap, T = y.anisotropy > 0, F = y.clearcoat > 0, Y = y.dispersion > 0, Z = y.iridescence > 0, K = y.sheen > 0, Ee = y.transmission > 0, ue = T && !!y.anisotropyMap, _e = F && !!y.clearcoatMap, We = F && !!y.clearcoatNormalMap, re = F && !!y.clearcoatRoughnessMap, ye = Z && !!y.iridescenceMap, De = Z && !!y.iridescenceThicknessMap, Ne = K && !!y.sheenColorMap, Se = K && !!y.sheenRoughnessMap, qe = !!y.specularMap, ke = !!y.specularColorMap, ht = !!y.specularIntensityMap, I = Ee && !!y.transmissionMap, he = Ee && !!y.thicknessMap, W = !!y.gradientMap, j = !!y.alphaMap, me = y.alphaTest > 0, pe = !!y.alphaHash, Be = !!y.extensions;
      let yt = ki;
      y.toneMapped && (ae === null || ae.isXRRenderTarget === true) && (yt = r.toneMapping);
      const Bt = {
        shaderID: oe,
        shaderType: y.type,
        shaderName: y.name,
        ...
        emissiveMap: Ie,
        normalMapObjectSpace: xe && y.normalMapType === gg,
        normalMapTangentSpace: xe && y.normalMapType === Id,
        metalnessMap: de,
        roughnessMap: R,
        anisotropy: T,
        anisotropyMap: ue,
        ...
        thicknessMap: he,
        gradientMap: W,
        opaque: y.transparent === false && y.blending === Qr && y.alphaToCoverage === false,
        alphaMap: j,
        alphaTest: me,
        alphaHash: pe,
        combine: y.combine,
        mapUv: Qe && g(y.map.channel),
        aoMapUv: C && g(y.aoMap.channel),
        lightMapUv: be && g(y.lightMap.channel),
        bumpMapUv: te && g(y.bumpMap.channel),
        normalMapUv: xe && g(y.normalMap.channel),
        displacementMapUv: se && g(y.displacementMap.channel),
        emissiveMapUv: Ie && g(y.emissiveMap.channel),
        metalnessMapUv: de && g(y.metalnessMap.channel),
        roughnessMapUv: R && g(y.roughnessMap.channel),
        anisotropyMapUv: ue && g(y.anisotropyMap.channel),
        clearcoatMapUv: _e && g(y.clearcoatMap.channel),
        clearcoatNormalMapUv: We && g(y.clearcoatNormalMap.channel),
        clearcoatRoughnessMapUv: re && g(y.clearcoatRoughnessMap.channel),
        iridescenceMapUv: ye && g(y.iridescenceMap.channel),
        iridescenceThicknessMapUv: De && g(y.iridescenceThicknessMap.channel),
        sheenColorMapUv: Ne && g(y.sheenColorMap.channel),
        sheenRoughnessMapUv: Se && g(y.sheenRoughnessMap.channel),
        specularMapUv: qe && g(y.specularMap.channel),
        specularColorMapUv: ke && g(y.specularColorMap.channel),
        specularIntensityMapUv: ht && g(y.specularIntensityMap.channel),
        transmissionMapUv: I && g(y.transmissionMap.channel),
        ...
        vertexAlphas: y.vertexColors === true && !!q.attributes.color && q.attributes.color.itemSize === 4,
        ...
        toneMapping: yt,
        decodeVideoTexture: Qe && y.map.isVideoTexture === true && Ye.getTransfer(y.map.colorSpace) === lt,
        decodeVideoTextureEmissive: Ie && y.emissiveMap.isVideoTexture === true && Ye.getTransfer(y.emissiveMap.colorSpace) === lt,
        ...
        extensionClipCullDistance: Be && y.extensions.clipCullDistance === true && n.has("WEBGL_clip_cull_distance"),
        extensionMultiDraw: (Be && y.extensions.multiDraw === true || we) && n.has("WEBGL_multi_draw"),
    ...
    function p(y) {
      const M = [];
      if (y.shaderID ? M.push(y.shaderID) : (M.push(y.customVertexShaderID), M.push(y.customFragmentShaderID)), y.defines !== void 0) for (const L in y.defines) M.push(L), M.push(y.defines[L]);
      return y.isRawShaderMaterial === false && (S(M, y), v(M, y), M.push(r.outputColorSpace)), M.push(y.customProgramCacheKey), M.join();
    }
    function S(y, M) {
    ...
    function b(y, M) {
      ...
      return L === void 0 && (L = new WS(r, M, y, s), u.push(L)), L;
    }
    function w(y) {
      if (--y.usedTimes === 0) {
        const M = u.indexOf(y);
  ...
  function kf() {
    ...
    function c(h, f) {
      t.length > 1 && t.sort(h || jS), n.length > 1 && n.sort(f || zf), i.length > 1 && i.sort(f || zf);
    }
    function u() {
  ...
  function nM(r) {
    ...
    function a(c) {
      ...
      let d = 0, _ = 0, g = 0, m = 0, p = 0, S = 0, v = 0, x = 0, b = 0, w = 0, A = 0;
      c.sort(tM);
      for (let y = 0, M = c.length; y < M; y++) {
        const L = c[y], G = L.color, O = L.intensity, V = L.distance, q = L.shadow && L.shadow.map ? L.shadow.map.texture : null;
        if (L.isAmbientLight) u += G.r * O, h += G.g * O, f += G.b * O;
          ...
          if (B.color.copy(L.color).multiplyScalar(L.intensity), L.castShadow) {
            ...
            H.shadowIntensity = $.intensity, H.shadowBias = $.bias, H.shadowNormalBias = $.normalBias, H.shadowRadius = $.radius, H.shadowMapSize = $.mapSize, n.directionalShadow[d] = H, n.directionalShadowMap[d] = q, n.directionalShadowMatrix[d] = L.shadow.matrix, S++;
          }
          n.directional[d] = B, d++;
      ...
      const P = n.hash;
      (P.directionalLength !== d || P.pointLength !== _ || P.spotLength !== g || P.rectAreaLength !== m || P.hemiLength !== p || P.numDirectionalShadows !== S || P.numPointShadows !== v || P.numSpotShadows !== x || P.numSpotMaps !== b || P.numLightProbes !== A) && (n.directional.length = d, n.spot.length = g, n.rectArea.length = m, n.point.length = _, n.hemi.length = p, n.directionalShadow.length = S, n.directionalShadowMap.length = S, n.pointShadow.length = v, n.pointShadowMap.length = v, n.spotShadow.length = x, n.spotShadowMap.length = x, n.directionalShadowMatrix.length = S, n.pointShadowMatrix.length = v, n.spotLightMatrix.length = x + b - w, n.spotLightMap.length = b, n.numSpotLightShadowsWithMaps = w, n.numLightProbes = A, P.directionalLength = d, P.pointLength = _, P.spotLength = g, P.rectAreaLength = m, P.hemiLength = p, P.numDirectionalShadows = S, P.numPointShadows = v, P.numSpotShadows = x, P.numSpotMaps = b, P.numLightProbes = A, n.version = eM++);
    }
    function l(c, u) {
...
void main() {
  ...
  function oM(r, e, t) {
    let n = new Su();
    const i = new ee(), s = new ee(), o = new et(), a = new r0({
      depthPacking: mg
    }), l = new s0(), c = {}, u = t.maxTextureSize, h = {
      [Si]: nn,
      [nn]: Si,
      [Vn]: Vn
    }, f = new Gt({
    ...
    this.render = function(w, A, P) {
      ...
      const y = r.getRenderTarget(), M = r.getActiveCubeFace(), L = r.getActiveMipmapLevel(), G = r.state;
      G.setBlending(xi), G.buffers.color.setClear(1, 1, 1, 1), G.buffers.depth.setTest(true), G.setScissorTest(false);
      const O = p !== ai && this.type === ai, V = p === ai && this.type !== ai;
      for (let q = 0, B = w.length; q < B; q++) {
        ...
        H.isPointLightShadow !== true && this.type === ai && S(H, P), H.needsUpdate = false;
      }
      p = this.type, m.needsUpdate = false, r.setRenderTarget(y, M, L);
    };
    function S(w, A) {
      const P = e.update(g);
    ...
    function v(w, A, P, y) {
      ...
      if (M.visible = A.visible, M.wireframe = A.wireframe, y === ai ? M.side = A.shadowSide !== null ? A.shadowSide : A.side : M.side = A.shadowSide !== null ? A.shadowSide : h[A.side], M.alphaMap = A.alphaMap, M.alphaTest = A.alphaTest, M.map = A.map, M.clipShadows = A.clipShadows, M.clippingPlanes = A.clippingPlanes, M.clipIntersection = A.clipIntersection, M.displacementMap = A.displacementMap, M.displacementScale = A.displacementScale, M.displacementBias = A.displacementBias, M.wireframeLinewidth = A.wireframeLinewidth, M.linewidth = A.linewidth, P.isPointLight === true && M.isMeshDistanceMaterial === true) {
        const G = r.properties.get(M);
        G.light = P;
      }
      return M;
    }
    function x(w, A, P, y, M) {
      if (w.visible === false) return;
      if (w.layers.test(A.layers) && (w.isMesh || w.isLine || w.isPoints) && (w.castShadow || w.receiveShadow && M === ai) && (!w.frustumCulled || n.intersectsObject(w))) {
      ...
      const G = w.children;
      for (let O = 0, V = G.length; O < V; O++) x(G[O], A, P, y, M);
    }
    function b(w) {
      w.target.removeEventListener("dispose", b);
      for (const P in c) {
        const y = c[P], M = w.target.uuid;
  ...
  function lM(r, e) {
    ...
    function i() {
      ...
      return {
        ...
        setFunc: function(rt, Rn, Qn) {
          (W !== rt || j !== Rn || me !== Qn) && (r.stencilFunc(rt, Rn, Qn), W = rt, j = Rn, me = Qn);
        },
        setOp: function(rt, Rn, Qn) {
          (pe !== rt || Be !== Rn || yt !== Qn) && (r.stencilOp(rt, Rn, Qn), pe = rt, Be = Rn, yt = Qn);
        },
    ...
    let u = {}, h = {}, f = /* @__PURE__ */ new WeakMap(), d = [], _ = null, g = false, m = null, p = null, S = null, v = null, x = null, b = null, w = null, A = new Re(0, 0, 0), P = 0, y = false, M = null, L = null, G = null, O = null, V = null;
    ...
    const Q = {
      [fr]: r.FUNC_ADD,
      [zm]: r.FUNC_SUBTRACT,
      [km]: r.FUNC_REVERSE_SUBTRACT
    };
    Q[Vm] = r.MIN, Q[Hm] = r.MAX;
    const J = {
      [Gm]: r.ZERO,
      [Wm]: r.ONE,
      [Xm]: r.SRC_COLOR,
      [Yl]: r.SRC_ALPHA,
      [Zm]: r.SRC_ALPHA_SATURATE,
      [$m]: r.DST_COLOR,
      [Ym]: r.DST_ALPHA,
      [qm]: r.ONE_MINUS_SRC_COLOR,
      [Kl]: r.ONE_MINUS_SRC_ALPHA,
      [jm]: r.ONE_MINUS_DST_COLOR,
      [Km]: r.ONE_MINUS_DST_ALPHA,
      [Jm]: r.CONSTANT_COLOR,
      [Qm]: r.ONE_MINUS_CONSTANT_COLOR,
      [eg]: r.CONSTANT_ALPHA,
      [tg]: r.ONE_MINUS_CONSTANT_ALPHA
    };
    function C(I, he, W, j, me, pe, Be, yt, Bt, rt) {
      ...
      if (g === false && (ae(r.BLEND), g = true), I !== Bm) {
        if (I !== m || rt !== y) {
          if ((p !== fr || x !== fr) && (r.blendEquation(r.FUNC_ADD), p = fr, x = fr), rt) switch (I) {
            case Qr:
          ...
          S = null, v = null, b = null, w = null, A.set(0, 0, 0), P = 0, m = I, y = rt;
        }
        return;
      }
      me = me || he, pe = pe || W, Be = Be || j, (he !== p || me !== x) && (r.blendEquationSeparate(Q[he], Q[me]), p = he, x = me), (W !== S || j !== v || pe !== b || Be !== w) && (r.blendFuncSeparate(J[W], J[j], J[pe], J[Be]), S = W, v = j, b = pe, w = Be), (yt.equals(A) === false || Bt !== P) && (r.blendColor(yt.r, yt.g, yt.b, Bt), A.copy(yt), P = Bt), m = I, y = false;
    }
    function be(I, he) {
      I.side === Vn ? Ae(r.CULL_FACE) : ae(r.CULL_FACE);
      let W = I.side === nn;
      he && (W = !W), te(W), I.blending === Qr && I.transparent === false ? C(xi) : C(I.blending, I.blendEquation, I.blendSrc, I.blendDst, I.blendEquationAlpha, I.blendSrcAlpha, I.blendDstAlpha, I.blendColor, I.blendAlpha, I.premultipliedAlpha), o.setFunc(I.depthFunc), o.setTest(I.depthTest), o.setMask(I.depthWrite), s.setMask(I.colorWrite);
    ...
    function xe(I) {
      I !== Um ? (ae(r.CULL_FACE), I !== L && (I === xh ? r.cullFace(r.BACK) : I === Om ? r.cullFace(r.FRONT) : r.cullFace(r.FRONT_AND_BACK))) : Ae(r.CULL_FACE), L = I;
    }
    function se(I) {
  ...
  function cM(r, e, t, n, i, s, o) {
    ...
    function _(R, T) {
      return d ? new OffscreenCanvas(R, T) : uo("canvas");
    }
    function g(R, T, F) {
      let Y = 1;
      const Z = de(R);
    ...
    function v(R, T, F, Y, Z = false) {
      ...
      if (T === r.RED && (F === r.FLOAT && (K = r.R32F), F === r.HALF_FLOAT && (K = r.R16F), F === r.UNSIGNED_BYTE && (K = r.R8)), T === r.RED_INTEGER && (F === r.UNSIGNED_BYTE && (K = r.R8UI), F === r.UNSIGNED_SHORT && (K = r.R16UI), F === r.UNSIGNED_INT && (K = r.R32UI), F === r.BYTE && (K = r.R8I), F === r.SHORT && (K = r.R16I), F === r.INT && (K = r.R32I)), T === r.RG && (F === r.FLOAT && (K = r.RG32F), F === r.HALF_FLOAT && (K = r.RG16F), F === r.UNSIGNED_BYTE && (K = r.RG8)), T === r.RG_INTEGER && (F === r.UNSIGNED_BYTE && (K = r.RG8UI), F === r.UNSIGNED_SHORT && (K = r.RG16UI), F === r.UNSIGNED_INT && (K = r.RG32UI), F === r.BYTE && (K = r.RG8I), F === r.SHORT && (K = r.RG16I), F === r.INT && (K = r.RG32I)), T === r.RGB_INTEGER && (F === r.UNSIGNED_BYTE && (K = r.RGB8UI), F === r.UNSIGNED_SHORT && (K = r.RGB16UI), F === r.UNSIGNED_INT && (K = r.RGB32UI), F === r.BYTE && (K = r.RGB8I), F === r.SHORT && (K = r.RGB16I), F === r.INT && (K = r.RGB32I)), T === r.RGBA_INTEGER && (F === r.UNSIGNED_BYTE && (K = r.RGBA8UI), F === r.UNSIGNED_SHORT && (K = r.RGBA16UI), F === r.UNSIGNED_INT && (K = r.RGBA32UI), F === r.BYTE && (K = r.RGBA8I), F === r.SHORT && (K = r.RGBA16I), F === r.INT && (K = r.RGBA32I)), T === r.RGB && F === r.UNSIGNED_INT_5_9_9_9_REV && (K = r.RGB9_E5), T === r.RGBA) {
        const Ee = Z ? Aa : Ye.getTransfer(Y);
    ...
    function x(R, T) {
      let F;
      return R ? T === null || T === Tr || T === fs ? F = r.DEPTH24_STENCIL8 : T === Un ? F = r.DEPTH32F_STENCIL8 : T === ao && (F = r.DEPTH24_STENCIL8, console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : T === null || T === Tr || T === fs ? F = r.DEPTH_COMPONENT24 : T === Un ? F = r.DEPTH_COMPONENT32F : T === ao && (F = r.DEPTH_COMPONENT16), F;
    }
    function b(R, T) {
    ...
    function P(R) {
      ...
      if (Y) {
        ...
        Z.usedTimes--, Z.usedTimes === 0 && y(R), Object.keys(Y).length === 0 && f.delete(F);
      }
      n.remove(R);
    }
    function y(R) {
    ...
    const oe = {
      ...
      [mn]: r.LINEAR,
      [ha]: r.LINEAR_MIPMAP_NEAREST,
      [mi]: r.LINEAR_MIPMAP_LINEAR
    }, ge = {
      [_g]: r.NEVER,
      [Tg]: r.ALWAYS,
      [xg]: r.LESS,
    ...
    function Le(R, T) {
      if (T.type === Un && e.has("OES_texture_float_linear") === false && (T.magFilter === mn || T.magFilter === ha || T.magFilter === Hs || T.magFilter === mi || T.minFilter === mn || T.minFilter === ha || T.minFilter === Hs || T.minFilter === mi) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), r.texParameteri(R, r.TEXTURE_WRAP_S, oe[T.wrapS]), r.texParameteri(R, r.TEXTURE_WRAP_T, oe[T.wrapT]), (R === r.TEXTURE_3D || R === r.TEXTURE_2D_ARRAY) && r.texParameteri(R, r.TEXTURE_WRAP_R, oe[T.wrapR]), r.texParameteri(R, r.TEXTURE_MAG_FILTER, ce[T.magFilter]), r.texParameteri(R, r.TEXTURE_MIN_FILTER, ce[T.minFilter]), T.compareFunction && (r.texParameteri(R, r.TEXTURE_COMPARE_MODE, r.COMPARE_REF_TO_TEXTURE), r.texParameteri(R, r.TEXTURE_COMPARE_FUNC, ge[T.compareFunction])), e.has("EXT_texture_filter_anisotropic") === true) {
        if (T.magFilter === Zt || T.minFilter !== Hs && T.minFilter !== mi || T.type === Un && e.has("OES_texture_float_linear") === false) return;
    ...
    function Ke(R, T) {
      ...
      if (K !== R.__cacheKey) {
        ...
        Ee !== void 0 && (Z[R.__cacheKey].usedTimes--, Ee.usedTimes === 0 && y(T)), R.__cacheKey = K, R.__webglTexture = Z[K].texture;
      }
      return F;
    }
    function X(R, T, F) {
      ...
      if (K.version !== Ee.__version || Z === true) {
        ...
        const ue = Ye.getPrimaries(Ye.workingColorSpace), _e = T.colorSpace === Ii ? null : Ye.getPrimaries(T.colorSpace), We = T.colorSpace === Ii || ue === _e ? r.NONE : r.BROWSER_DEFAULT_WEBGL;
        ...
        if (T.isDepthTexture) Ne = x(T.format === ds, T.type), ht && (ke ? t.texStorage2D(r.TEXTURE_2D, 1, Ne, re.width, re.height) : t.texImage2D(r.TEXTURE_2D, 0, Ne, re.width, re.height, 0, ye, De, null));
          ...
          for (let W = 0, j = qe.length; W < j; W++) if (Se = qe[W], T.format !== bn) if (ye !== null) if (ke) {
            if (I) if (T.layerUpdates.size > 0) {
              const me = _f(Se.width, Se.height, T.format, T.type);
          ...
          if (ht && t.texStorage3D(r.TEXTURE_2D_ARRAY, he, Ne, re.width, re.height, re.depth), I) if (T.layerUpdates.size > 0) {
            const W = _f(re.width, re.height, T.format, T.type);
    ...
    function ie(R, T, F) {
      ...
      if (Z.version !== K.__version || Y === true) {
        t.activeTexture(r.TEXTURE0 + F);
        const Ee = Ye.getPrimaries(Ye.workingColorSpace), ue = T.colorSpace === Ii ? null : Ye.getPrimaries(T.colorSpace), _e = T.colorSpace === Ii || Ee === ue ? r.NONE : r.BROWSER_DEFAULT_WEBGL;
    ...
    function Ae(R, T) {
      ...
      if (T.depthTexture.format === es) xe(T) ? a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER, r.DEPTH_ATTACHMENT, r.TEXTURE_2D, Z, 0, K) : r.framebufferTexture2D(r.FRAMEBUFFER, r.DEPTH_ATTACHMENT, r.TEXTURE_2D, Z, 0);
    ...
    function Q(R) {
      ...
      for (let F = 0, Y = T.length; F < Y; F++) {
        const Z = T[F];
        if (m(Z)) {
          const K = S(R), Ee = n.get(Z).__webglTexture;
    ...
    function Ie(R, T) {
      ...
      return R.isCompressedTexture === true || R.isVideoTexture === true || F !== Qt && F !== Ii && (Ye.getTransfer(F) === lt ? (Y !== bn || Z !== Mi) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", F)), T;
    }
    function de(R) {
  ...
  function uM(r, e) {
    function t(n, i = Ii) {
      ...
      if (n === hu) return r.UNSIGNED_SHORT_4_4_4_4;
      if (n === fu) return r.UNSIGNED_SHORT_5_5_5_1;
      if (n === bd) return r.UNSIGNED_INT_5_9_9_9_REV;
      if (n === Td) return r.BYTE;
      if (n === Ed) return r.SHORT;
      if (n === ao) return r.UNSIGNED_SHORT;
      if (n === uu) return r.INT;
      if (n === Tr) return r.UNSIGNED_INT;
      if (n === Un) return r.FLOAT;
      if (n === vi) return r.HALF_FLOAT;
      ...
      if (n === es) return r.DEPTH_COMPONENT;
      if (n === ds) return r.DEPTH_STENCIL;
      if (n === du) return r.RED;
      if (n === pu) return r.RED_INTEGER;
      if (n === Pd) return r.RG;
      if (n === mu) return r.RG_INTEGER;
      if (n === gu) return r.RGBA_INTEGER;
      if (n === fa || n === da || n === pa || n === ma) if (o === lt) if (s = e.get("WEBGL_compressed_texture_s3tc_srgb"), s !== null) {
        if (n === fa) return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;
        if (n === da) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
        if (n === pa) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
        if (n === ma) return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
      } else return null;
      else if (s = e.get("WEBGL_compressed_texture_s3tc"), s !== null) {
        if (n === fa) return s.COMPRESSED_RGB_S3TC_DXT1_EXT;
        if (n === da) return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;
        if (n === pa) return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;
        if (n === ma) return s.COMPRESSED_RGBA_S3TC_DXT5_EXT;
      } else return null;
      if (n === rc || n === sc || n === oc || n === ac) if (s = e.get("WEBGL_compressed_texture_pvrtc"), s !== null) {
        if (n === rc) return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (n === sc) return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (n === oc) return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (n === ac) return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
      if (n === lc || n === cc || n === uc) if (s = e.get("WEBGL_compressed_texture_etc"), s !== null) {
        if (n === lc || n === cc) return o === lt ? s.COMPRESSED_SRGB8_ETC2 : s.COMPRESSED_RGB8_ETC2;
        if (n === uc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : s.COMPRESSED_RGBA8_ETC2_EAC;
      } else return null;
      if (n === hc || n === fc || n === dc || n === pc || n === mc || n === gc || n === _c || n === xc || n === vc || n === yc || n === Sc || n === Mc || n === Tc || n === Ec) if (s = e.get("WEBGL_compressed_texture_astc"), s !== null) {
        if (n === hc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : s.COMPRESSED_RGBA_ASTC_4x4_KHR;
        if (n === fc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : s.COMPRESSED_RGBA_ASTC_5x4_KHR;
        if (n === dc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : s.COMPRESSED_RGBA_ASTC_5x5_KHR;
        if (n === pc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : s.COMPRESSED_RGBA_ASTC_6x5_KHR;
        if (n === mc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : s.COMPRESSED_RGBA_ASTC_6x6_KHR;
        if (n === gc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : s.COMPRESSED_RGBA_ASTC_8x5_KHR;
        if (n === _c) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : s.COMPRESSED_RGBA_ASTC_8x6_KHR;
        if (n === xc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : s.COMPRESSED_RGBA_ASTC_8x8_KHR;
        if (n === vc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR : s.COMPRESSED_RGBA_ASTC_10x5_KHR;
        if (n === yc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR : s.COMPRESSED_RGBA_ASTC_10x6_KHR;
        if (n === Sc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR : s.COMPRESSED_RGBA_ASTC_10x8_KHR;
        if (n === Mc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR : s.COMPRESSED_RGBA_ASTC_10x10_KHR;
        if (n === Tc) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR : s.COMPRESSED_RGBA_ASTC_12x10_KHR;
        if (n === Ec) return o === lt ? s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR : s.COMPRESSED_RGBA_ASTC_12x12_KHR;
      } else return null;
      if (n === ga || n === bc || n === wc) if (s = e.get("EXT_texture_compression_bptc"), s !== null) {
        if (n === ga) return o === lt ? s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : s.COMPRESSED_RGBA_BPTC_UNORM_EXT;
        if (n === bc) return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (n === wc) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
      if (n === Ld || n === Ac || n === Rc || n === Cc) if (s = e.get("EXT_texture_compression_rgtc"), s !== null) {
        if (n === ga) return s.COMPRESSED_RED_RGTC1_EXT;
        if (n === Ac) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (n === Rc) return s.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (n === Cc) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
...
void main() {
  ...
  class dM {
    ...
    getMesh(e) {
      if (this.texture !== null && this.mesh === null) {
        ...
        this.mesh = new Rt(new bo(20, 20), n);
      }
      return this.mesh;
    }
    reset() {
  ...
  class pM extends As {
    constructor(e, t) {
      ...
      this.cameraAutoUpdate = true, this.enabled = false, this.isPresenting = false, this.getController = function(X) {
        let ie = v[X];
        return ie === void 0 && (ie = new xl(), v[X] = ie), ie.getTargetRaySpace();
      }, this.getControllerGrip = function(X) {
        let ie = v[X];
        return ie === void 0 && (ie = new xl(), v[X] = ie), ie.getGripSpace();
      }, this.getHand = function(X) {
        let ie = v[X];
        return ie === void 0 && (ie = new xl(), v[X] = ie), ie.getHandSpace();
      };
      function O(X) {
      ...
      function V() {
        ...
        L = null, G = null, g.reset(), e.setRenderTarget(p), d = null, f = null, h = null, i = null, S = null, Ke.stop(), n.isPresenting = false, e.setPixelRatio(w), e.setSize(b.width, b.height, false), n.dispatchEvent({
          type: "sessionend"
        });
      }
      this.setFramebufferScaleFactor = function(X) {
        ...
        if (i = X, i !== null) {
          if (p = e.getRenderTarget(), i.addEventListener("select", O), i.addEventListener("selectstart", O), i.addEventListener("selectend", O), i.addEventListener("squeeze", O), i.addEventListener("squeezestart", O), i.addEventListener("squeezeend", O), i.addEventListener("end", V), i.addEventListener("inputsourceschange", q), m.xrCompatible !== true && await t.makeXRCompatible(), w = e.getPixelRatio(), e.getSize(b), typeof XRWebGLBinding < "u" && "createProjectionLayer" in XRWebGLBinding.prototype) {
            ...
            m.depth && (Ae = m.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24, Te = m.stencil ? ds : es, ae = m.stencil ? fs : Tr);
            const $e = {
              colorFormat: t.RGBA8,
              depthFormat: Ae,
              scaleFactor: s
            ...
            }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, false), S = new On(f.textureWidth, f.textureHeight, {
              format: bn,
              type: Mi,
              depthTexture: new Kd(f.textureWidth, f.textureHeight, ae, void 0, void 0, void 0, void 0, void 0, void 0, Te),
            ...
            d = new XRWebGLLayer(i, t, Te), i.updateRenderState({
              baseLayer: d
            }), e.setPixelRatio(1), e.setSize(d.framebufferWidth, d.framebufferHeight, false), S = new On(d.framebufferWidth, d.framebufferHeight, {
              format: bn,
              type: Mi,
              colorSpace: e.outputColorSpace,
              stencilBuffer: m.stencil
          ...
          S.isXRRenderTarget = true, this.setFoveation(l), c = null, o = await i.requestReferenceSpace(a), Ke.setContext(i), Ke.start(), n.isPresenting = true, n.dispatchEvent({
            type: "sessionstart"
          });
        }
        ...
        if (u = ie.getViewerPose(c || o), _ = ie, u !== null) {
          ...
          for (let we = 0; we < Te.length; we++) {
            ...
            if (d !== null) Q = d.getViewport(Qe);
              ...
              Q = C.viewport, we === 0 && (e.setRenderTargetTextures(S, C.colorTexture, f.ignoreDepthValues ? void 0 : C.depthStencilTexture), e.setRenderTarget(S));
            }
            let J = y[we];
            J === void 0 && (J = new $t(), J.layers.enable(we), J.viewport = new et(), y[we] = J), J.matrix.fromArray(Qe.transform.matrix), J.matrix.decompose(J.position, J.quaternion, J.scale), J.projectionMatrix.fromArray(Qe.projectionMatrix), J.projectionMatrixInverse.copy(J.projectionMatrix).invert(), J.viewport.set(Q.x, Q.y, Q.width, Q.height), we === 0 && (M.matrix.copy(J.matrix), M.matrix.decompose(M.position, M.quaternion, M.scale)), ae === true && M.cameras.push(J);
          }
  ...
  function _M(r, e, t, n) {
    ...
    function l(S, v) {
      const x = v.program;
      n.uniformBlockBinding(S, x);
    }
    function c(S, v) {
      let x = i[S.id];
      x === void 0 && (_(S), x = u(S), i[S.id] = x, S.addEventListener("dispose", m));
      const b = v.program;
    ...
    function u(S) {
      ...
      const x = r.createBuffer(), b = S.__size, w = S.usage;
    ...
    function f(S) {
      const v = i[S.id], x = S.uniforms, b = S.__cache;
    ...
    function _(S) {
      ...
      for (let A = 0, P = v.length; A < P; A++) {
        const y = Array.isArray(v[A]) ? v[A] : [
          v[A]
        ];
        for (let M = 0, L = y.length; M < L; M++) {
          const G = y[M], O = Array.isArray(G.value) ? G.value : [
            G.value
          ];
      ...
      const w = x % b;
      return w > 0 && (x += b - w), S.__size = x, S.__cache = {}, this;
    }
    function g(S) {
      const v = {
        boundary: 0,
  ...
  class xM {
    constructor(e = {}) {
      const { canvas: t = Vg(), context: n = null, depth: i = true, stencil: s = false, alpha: o = false, antialias: a = false, premultipliedAlpha: l = true, preserveDrawingBuffer: c = false, powerPreference: u = "default", failIfMajorPerformanceCaveat: h = false, reverseDepthBuffer: f = false } = e;
      ...
      const x = this;
      let b = false, w = 0, A = 0, P = null, y = -1, M = null;
      ...
      try {
        ...
        if ("setAttribute" in t && t.setAttribute("data-engine", `three.js r${cu}`), t.addEventListener("webglcontextlost", j, false), t.addEventListener("webglcontextrestored", me, false), t.addEventListener("webglcontextcreationerror", pe, false), C === null) {
          const N = "webgl2";
      ...
      function he() {
        te = new Ry(C), te.init(), ke = new uM(C, te), xe = new My(C, te, e, ke), se = new lM(C, te), xe.reverseDepthBuffer && f && se.buffers.depth.setReversed(true), Ie = new Ly(C), de = new $S(), R = new cM(C, te, se, de, xe, ke, Ie), T = new Ey(x), F = new Ay(x), Y = new B0(C), ht = new yy(C, Y), Z = new Cy(C, Y, Ie, ht), K = new Iy(C, Z, Y, Ie), Ne = new Dy(C, xe, R), re = new Ty(de), Ee = new KS(x, T, F, te, xe, ht, re), ue = new gM(x, de), _e = new ZS(), We = new iM(te), De = new vy(x, T, F, se, K, d, l), ye = new oM(x, K, xe), I = new _M(C, Ie, xe, se), Se = new Sy(C, te, Ie), qe = new Py(C, te, Ie), Ie.programs = Ee.programs, x.capabilities = xe, x.extensions = te, x.properties = de, x.renderLists = _e, x.shadowMap = ye, x.state = se, x.info = Ie;
      }
      he();
      const W = new pM(x, C);
      this.xr = W, this.getContext = function() {
        ...
        if (E) {
          ...
          if (U) {
            const ne = P.texture.type, fe = ne === Mi || ne === Tr || ne === ao || ne === fs || ne === hu || ne === fu, ve = De.getClearColor(), Me = De.getClearAlpha(), Ue = ve.r, Oe = ve.g, Ce = ve.b;
        ...
        t.removeEventListener("webglcontextlost", j, false), t.removeEventListener("webglcontextrestored", me, false), t.removeEventListener("webglcontextcreationerror", pe, false), De.dispose(), _e.dispose(), We.dispose(), de.dispose(), T.dispose(), F.dispose(), K.dispose(), ht.dispose(), I.dispose(), Ee.dispose(), W.dispose(), W.removeEventListener("sessionstart", hh), W.removeEventListener("sessionend", fh), ji.stop();
      };
      function j(E) {
      ...
      this.renderBufferDirect = function(E, N, z, k, U, ne) {
        N === null && (N = Qe);
        const fe = U.isMesh && U.matrixWorld.determinant() < 0, ve = Cm(E, N, z, k, U);
        se.setMaterial(k, fe);
        let Me = z.index, Ue = 1;
        if (k.wireframe === true) {
        ...
        if (U.isBatchedMesh) if (U._multiDrawInstances !== null) Je.renderMultiDrawInstances(U._multiDrawStarts, U._multiDrawCounts, U._multiDrawCount, U._multiDrawInstances);
          ...
          const Pe = U._multiDrawStarts, Nt = U._multiDrawCounts, nt = U._multiDrawCount, Cn = Me ? Y.get(Me).bytesPerElement : 1, Lr = de.get(k).currentProgram.getUniforms();
          for (let un = 0; un < nt; un++) Lr.setValue(C, "_gl_DrawID", un), Je.render(Pe[un] / Cn, Nt[un]);
        }
      ...
      function rt(E, N, z) {
        E.transparent === true && E.side === Vn && E.forceSinglePass === false ? (E.side = nn, E.needsUpdate = true, Lo(E, N, z), E.side = Si, E.needsUpdate = true, Lo(E, N, z), E.side = Vn) : Lo(E, N, z);
      }
      ...
      const ji = new sp();
      ji.setAnimationLoop(Qn), typeof self < "u" && ji.setContext(self), this.setAnimationLoop = function(E) {
        Rn = E, W.setAnimationLoop(E), E === null ? ji.stop() : ji.start();
      }, W.addEventListener("sessionstart", hh), W.addEventListener("sessionend", fh), this.render = function(E, N) {
        if (N !== void 0 && N.isCamera !== true) {
          console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
          return;
        }
        if (b === true) return;
        if (E.matrixWorldAutoUpdate === true && E.updateMatrixWorld(), N.parent === null && N.matrixWorldAutoUpdate === true && N.updateMatrixWorld(), W.enabled === true && W.isPresenting === true && (W.cameraAutoUpdate === true && W.updateCamera(N), N = W.getCamera()), E.isScene === true && E.onBeforeRender(x, E, N, P), p = We.get(E, v.length), p.init(N), v.push(p), Ae.multiplyMatrices(N.projectionMatrix, N.matrixWorldInverse), X.setFromProjectionMatrix(Ae), Te = this.localClippingEnabled, ie = re.init(this.clippingPlanes, Te), m = _e.get(E, S.length), m.init(), S.push(m), W.enabled === true && W.isPresenting === true) {
          const ne = x.xr.getDepthSensingMesh();
          ne !== null && ja(ne, N, -1 / 0, x.sortObjects);
        }
        ja(E, N, 0, x.sortObjects), m.finish(), x.sortObjects === true && m.sort(oe, ce), Q = W.enabled === false || W.isPresenting === false || W.hasDepthSensing() === false, Q && De.addToRenderList(m, E), this.info.render.frame++, ie === true && re.beginShadows();
        ...
        if (p.setupLights(), N.isArrayCamera) {
          ...
          for (let fe = 0, ve = ne.length; fe < ve; fe++) {
            const Me = ne[fe];
            dh(m, E, Me, Me.viewport);
          }
        } else U.length > 0 && ph(k, U, E, N), Q && De.render(E), dh(m, E, N);
        P !== null && A === 0 && (R.updateMultisampleRenderTarget(P), R.updateRenderTargetMipmap(P)), E.isScene === true && E.onAfterRender(x, E, N), ht.resetDefaultState(), y = -1, M = null, v.pop(), v.length > 0 ? (p = v[v.length - 1], ie === true && re.setGlobalState(x.clippingPlanes, p.state.camera)) : p = null, S.pop(), S.length > 0 ? m = S[S.length - 1] : m = null;
      };
      function ja(E, N, z, k) {
        ...
        const ne = E.children;
        for (let fe = 0, ve = ne.length; fe < ve; fe++) ja(ne[fe], N, z, k);
      }
      function dh(E, N, z, k) {
        const U = E.opaque, ne = E.transmissive, fe = E.transparent;
        p.setupLightsView(z), ie === true && re.setGlobalState(x.clippingPlanes, z), k && se.viewport(L.copy(k)), U.length > 0 && Po(U, N, z), ne.length > 0 && Po(ne, N, z), fe.length > 0 && Po(fe, N, z), se.buffers.depth.setTest(true), se.buffers.depth.setMask(true), se.buffers.color.setMask(true), se.setPolygonOffset(false);
      }
      function ph(E, N, z, k) {
        ...
        p.state.transmissionRenderTarget[k.id] === void 0 && (p.state.transmissionRenderTarget[k.id] = new On(1, 1, {
          ...
          type: te.has("EXT_color_buffer_half_float") || te.has("EXT_color_buffer_float") ? vi : Mi,
          minFilter: mi,
          samples: 4,
          stencilBuffer: s,
        ...
        x.toneMapping = ki;
        const Ue = k.viewport;
        if (k.viewport !== void 0 && (k.viewport = void 0), p.setupLightsView(k), ie === true && re.setGlobalState(x.clippingPlanes, k), Po(E, z, k), R.updateMultisampleRenderTarget(ne), R.updateRenderTargetMipmap(ne), te.has("WEBGL_multisampled_render_to_texture") === false) {
          let Oe = false;
          for (let Ce = 0, je = N.length; Ce < je; Ce++) {
            const tt = N[Ce], Et = tt.object, St = tt.geometry, Je = tt.material, Pe = tt.group;
            if (Je.side === Vn && Et.layers.test(k.layers)) {
              const Nt = Je.side;
              Je.side = nn, Je.needsUpdate = true, mh(Et, z, k, St, Je, Pe), Je.side = Nt, Je.needsUpdate = true, Oe = true;
            }
          }
      ...
      function mh(E, N, z, k, U, ne) {
        E.onBeforeRender(x, N, z, k, U, ne), E.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse, E.matrixWorld), E.normalMatrix.getNormalMatrix(E.modelViewMatrix), U.onBeforeRender(x, N, z, k, E, ne), U.transparent === true && U.side === Vn && U.forceSinglePass === false ? (U.side = nn, U.needsUpdate = true, x.renderBufferDirect(z, N, k, U, E, ne), U.side = Si, U.needsUpdate = true, x.renderBufferDirect(z, N, k, U, E, ne), U.side = Vn) : x.renderBufferDirect(z, N, k, U, E, ne), E.onAfterRender(x, N, z, k, U, ne);
      }
      function Lo(E, N, z) {
        N.isScene !== true && (N = Qe);
      ...
      function Cm(E, N, z, k, U) {
        ...
        nt === true && (Cn = Lo(k, N, U));
        let Lr = false, un = false, Ls = false;
        const dt = Cn.getUniforms(), yn = Pe.uniforms;
        if (se.useProgram(Cn.program) && (Lr = true, un = true, Ls = true), k.id !== y && (y = k.id, un = true), Lr || M !== E) {
          se.buffers.depth.getReversed() ? (ae.copy(E.projectionMatrix), Gg(ae), Wg(ae), dt.setValue(C, "projectionMatrix", ae)) : dt.setValue(C, "projectionMatrix", E.projectionMatrix), dt.setValue(C, "viewMatrix", E.matrixWorldInverse);
        ...
        if ((Sn.position !== void 0 || Sn.normal !== void 0 || Sn.color !== void 0) && Ne.update(U, z, Cn), (un || Pe.receiveShadow !== U.receiveShadow) && (Pe.receiveShadow = U.receiveShadow, dt.setValue(C, "receiveShadow", U.receiveShadow)), k.isMeshGouraudMaterial && k.envMap !== null && (yn.envMap.value = Me, yn.flipEnvMap.value = Me.isCubeTexture && Me.isRenderTargetTexture === false ? -1 : 1), k.isMeshStandardMaterial && k.envMap === null && N.environment !== null && (yn.envMapIntensity.value = N.environmentIntensity), un && (dt.setValue(C, "toneMappingExposure", x.toneMappingExposure), Pe.needsLights && Pm(yn, Ls), ne && k.fog === true && ue.refreshFogUniforms(yn, ne), ue.refreshMaterialUniforms(yn, k, H, $, p.state.transmissionRenderTarget[E.id]), xa.upload(C, gh(Pe), yn, R)), k.isShaderMaterial && k.uniformsNeedUpdate === true && (xa.upload(C, gh(Pe), yn, R), k.uniformsNeedUpdate = false), k.isSpriteMaterial && dt.setValue(C, "center", U.center), dt.setValue(C, "modelViewMatrix", U.modelViewMatrix), dt.setValue(C, "normalMatrix", U.normalMatrix), dt.setValue(C, "modelMatrix", U.matrixWorld), k.isShaderMaterial || k.isRawShaderMaterial) {
          const qt = k.uniformsGroups;
          for (let en = 0, Za = qt.length; en < Za; en++) {
            const Zi = qt[en];
            I.update(Zi, Cn), I.bind(Zi, Cn);
          }
        }
        return Cn;
      }
      ...
      this.setRenderTarget = function(E, N = 0, z = 0) {
        ...
        if (z !== 0 && (U = Dm), se.bindFramebuffer(C.FRAMEBUFFER, U) && k && se.drawBuffers(E, U), se.viewport(L), se.scissor(G), se.setScissorTest(O), ne) {
        ...
        if (E.isWebGLCubeRenderTarget && fe !== void 0 && (ve = ve[fe]), ve) {
          ...
          if (N >= 0 && N <= E.width - k && z >= 0 && z <= E.height - U) {
            ...
            return C.flush(), await Hg(C, tt, 4), C.bindBuffer(C.PIXEL_PACK_BUFFER, Ce), C.getBufferSubData(C.PIXEL_PACK_BUFFER, 0, ne), C.deleteBuffer(Ce), C.deleteSync(tt), ne;
          } else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.");
        }
      }, this.copyFramebufferToTexture = function(E, N = null, z = 0) {
        E.isTexture !== true && (Kr("WebGLRenderer: copyFramebufferToTexture function signature has changed."), N = arguments[0] || null, E = arguments[1]);
      ...
      const Im = C.createFramebuffer(), Nm = C.createFramebuffer();
      this.copyTextureToTexture = function(E, N, z = null, k = null, U = 0, ne = null) {
        E.isTexture !== true && (Kr("WebGLRenderer: copyTextureToTexture function signature has changed."), k = arguments[0] || null, E = arguments[1], N = arguments[2], ne = arguments[3] || 0, z = null), ne === null && (U !== 0 ? (Kr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."), ne = U, U = 0) : ne = 0);
        ...
        const nt = C.getParameter(C.UNPACK_ROW_LENGTH), Cn = C.getParameter(C.UNPACK_IMAGE_HEIGHT), Lr = C.getParameter(C.UNPACK_SKIP_PIXELS), un = C.getParameter(C.UNPACK_SKIP_ROWS), Ls = C.getParameter(C.UNPACK_SKIP_IMAGES);
        ...
        if (E.isDepthTexture) {
          const Sn = de.get(E), qt = de.get(N), en = de.get(Sn.__renderTarget), Za = de.get(qt.__renderTarget);
          se.bindFramebuffer(C.READ_FRAMEBUFFER, en.__webglFramebuffer), se.bindFramebuffer(C.DRAW_FRAMEBUFFER, Za.__webglFramebuffer);
          for (let Zi = 0; Zi < Me; Zi++) dt && (C.framebufferTextureLayer(C.READ_FRAMEBUFFER, C.COLOR_ATTACHMENT0, de.get(E).__webglTexture, U, Ce + Zi), C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER, C.COLOR_ATTACHMENT0, de.get(N).__webglTexture, ne, Et + Zi)), C.blitFramebuffer(Ue, Oe, fe, ve, je, tt, fe, ve, C.DEPTH_BUFFER_BIT, C.NEAREST);
          ...
          se.bindFramebuffer(C.READ_FRAMEBUFFER, Im), se.bindFramebuffer(C.DRAW_FRAMEBUFFER, Nm);
        ...
        C.pixelStorei(C.UNPACK_ROW_LENGTH, nt), C.pixelStorei(C.UNPACK_IMAGE_HEIGHT, Cn), C.pixelStorei(C.UNPACK_SKIP_PIXELS, Lr), C.pixelStorei(C.UNPACK_SKIP_ROWS, un), C.pixelStorei(C.UNPACK_SKIP_IMAGES, Ls), ne === 0 && N.generateMipmaps && C.generateMipmap(Nt), se.unbindTexture();
      }, this.copyTextureToTexture3D = function(E, N, z = null, k = null, U = 0) {
        return E.isTexture !== true && (Kr("WebGLRenderer: copyTextureToTexture3D function signature has changed."), z = arguments[0] || null, k = arguments[1] || null, E = arguments[2], N = arguments[3], U = arguments[4] || 0), Kr('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'), this.copyTextureToTexture(E, N, z, k, U);
  ...
  function Hf(r, e) {
    ...
    if (e === Pc || e === Dd) {
      ...
      const n = t.count - 2, i = [];
      if (e === Pc) for (let o = 1; o <= n; o++) i.push(t.getX(0)), i.push(t.getX(o)), i.push(t.getX(o + 1));
  ...
  class vM extends Ar {
    ...
    load(e, t, n, i) {
      ...
      if (this.resourcePath !== "") o = this.resourcePath;
        ...
        o = Qs.resolveURL(c, this.path);
      } else o = Qs.extractUrlBase(e);
      this.manager.itemStart(e);
      const a = function(c) {
        i ? i(c) : console.error(c), s.manager.itemError(e), s.manager.itemEnd(e);
      }, l = new Ru(this.manager);
    ...
    _loadLight(e) {
      ...
      switch (l.type) {
        case "directional":
          ...
          break;
        case "point":
          c = new Pu(u), c.distance = h;
          break;
        case "spot":
          c = new S0(u), c.distance = h, l.spot = l.spot || {}, l.spot.innerConeAngle = l.spot.innerConeAngle !== void 0 ? l.spot.innerConeAngle : 0, l.spot.outerConeAngle = l.spot.outerConeAngle !== void 0 ? l.spot.outerConeAngle : Math.PI / 4, c.angle = l.spot.outerConeAngle, c.penumbra = 1 - l.spot.innerConeAngle / l.spot.outerConeAngle, c.target.position.set(0, 0, -1), c.add(c.target);
          break;
        default:
          throw new Error("THREE.GLTFLoader: Unexpected light type: " + l.type);
      }
      return c.position.set(0, 0, 0), hi(c, l), l.intensity !== void 0 && (c.intensity = l.intensity), c.name = t.createUniqueName(l.name || "light_" + e), i = Promise.resolve(c), t.cache.add(n, i), i;
    }
    getDependency(e, t) {
  ...
  class BM {
    ...
    createNodeMesh(e) {
      ...
      return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(e)), Promise.all(a).then((c) => {
        ...
        for (const _ of h) {
          const g = new Fe(), m = new D(), p = new qi(), S = new D(1, 1, 1), v = new y_(_.geometry, _.material, f);
          for (let x = 0; x < f; x++) l.TRANSLATION && m.fromBufferAttribute(l.TRANSLATION, x), l.ROTATION && p.fromBufferAttribute(l.ROTATION, x), l.SCALE && S.fromBufferAttribute(l.SCALE, x), v.setMatrixAt(x, g.compose(m, p, S));
          for (const x in l) if (x === "_COLOR_0") {
            const b = l[x];
            v.instanceColor = new Dc(b.array, b.itemSize, b.normalized);
  ...
  class kM {
    ...
    decodePrimitive(e, t) {
      ...
      for (const u in o) {
        const h = kc[u] || u.toLowerCase();
        a[h] = o[u];
      }
      for (const u in e.attributes) {
        const h = kc[u] || u.toLowerCase();
        if (o[u] !== void 0) {
          const f = n.accessors[e.attributes[u]], d = is[f.componentType];
  ...
  class hp extends Ao {
    ...
    interpolate_(e, t, n, i) {
      const s = this.resultBuffer, o = this.sampleValues, a = this.valueSize, l = a * 2, c = a * 3, u = i - t, h = (n - t) / u, f = h * h, d = f * h, _ = e * c, g = _ - c, m = -2 * d + 3 * f, p = d - f, S = 1 - m, v = p - f + h;
      for (let x = 0; x !== a; x++) {
  ...
  class WM extends hp {
    interpolate_(e, t, n, i) {
      ...
      return GM.fromArray(s).normalize().toArray(s), s;
    }
  }
  const En = {
    POINTS: 0,
  ...
  function qM(r) {
    return r.DefaultMaterial === void 0 && (r.DefaultMaterial = new wo({
      color: 16777215,
      emissive: 0,
      metalness: 1,
      roughness: 1,
  ...
  function $M(r) {
    ...
    if (t ? e = "draco:" + t.bufferView + ":" + t.indices + ":" + Ol(t.attributes) : e = r.indices + ":" + Ol(r.attributes) + ":" + r.mode, r.targets !== void 0) for (let n = 0, i = r.targets.length; n < i; n++) e += ":" + Ol(r.targets[n]);
    return e;
  }
  function Ol(r) {
    let e = "";
  ...
  class JM {
    constructor(e = {}, t = {}) {
      this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new yM(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = {
        refs: {},
        uses: {}
      }, this.cameraCache = {
        refs: {},
      ...
      typeof createImageBitmap > "u" || n && i < 17 || s && o < 98 ? this.textureLoader = new v0(this.options.manager) : this.textureLoader = new E0(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Ru(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(true);
    }
    setExtensions(e) {
      this.extensions = e;
    }
    ...
    parse(e, t) {
      ...
      this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(o) {
        ...
        return rr(s, a, i), hi(a, i), Promise.all(n._invokeAll(function(l) {
    ...
    loadAccessor(e) {
      ...
      if (i.bufferView === void 0 && i.sparse === void 0) {
        const o = Nl[i.type], a = is[i.componentType], l = i.normalized === true, c = new a(i.count * o);
      ...
      return i.bufferView !== void 0 ? s.push(this.getDependency("bufferView", i.bufferView)) : s.push(null), i.sparse !== void 0 && (s.push(this.getDependency("bufferView", i.sparse.indices.bufferView)), s.push(this.getDependency("bufferView", i.sparse.values.bufferView))), Promise.all(s).then(function(o) {
        const a = o[0], l = Nl[i.type], c = is[i.componentType], u = c.BYTES_PER_ELEMENT, h = u * l, f = i.byteOffset || 0, d = i.bufferView !== void 0 ? n.bufferViews[i.bufferView].byteStride : void 0, _ = i.normalized === true;
        let g, m;
        if (d && d !== h) {
          const p = Math.floor(f / d), S = "InterleavedBuffer:" + i.bufferView + ":" + i.componentType + ":" + p + ":" + i.count;
          let v = t.cache.get(S);
          v || (g = new c(a, p * d, i.count * d / u), v = new m_(g, d / u), t.cache.add(S, v)), m = new vu(v, l, f % d / u, _);
        } else a === null ? g = new c(i.count * l) : g = new c(a, f, i.count * l), m = new Jt(g, l, _);
        if (i.sparse !== void 0) {
          const p = Nl.SCALAR, S = is[i.sparse.indices.componentType], v = i.sparse.indices.byteOffset || 0, x = i.sparse.values.byteOffset || 0, b = new S(o[1], v, i.sparse.count * p), w = new c(o[2], x, i.sparse.count * l);
          a !== null && (m = new Jt(m.array.slice(), m.itemSize, m.normalized)), m.normalized = false;
          for (let A = 0, P = b.length; A < P; A++) {
            const y = b[A];
            if (m.setX(y, w[A * l]), l >= 2 && m.setY(y, w[A * l + 1]), l >= 3 && m.setZ(y, w[A * l + 2]), l >= 4 && m.setW(y, w[A * l + 3]), l >= 5) throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.");
          }
          m.normalized = _;
        }
        return m;
    ...
    loadTextureImage(e, t, n) {
      ...
      const c = this.loadImageSource(t, n).then(function(u) {
        ...
        return u.magFilter = Wf[f.magFilter] || mn, u.minFilter = Wf[f.minFilter] || mi, u.wrapS = Xf[f.wrapS] || hs, u.wrapT = Xf[f.wrapT] || hs, u.generateMipmaps = !u.isCompressedTexture && u.minFilter !== Zt && u.minFilter !== mn, i.associations.set(u, {
          textures: e
        }), u;
      }).catch(function() {
        return null;
    ...
    loadImageSource(e, t) {
      ...
      const u = Promise.resolve(l).then(function(h) {
        return new Promise(function(f, d) {
          ...
          }), t.load(Qs.resolveURL(h, s.path), _, void 0, d);
        });
      }).then(function(h) {
        return c === true && a.revokeObjectURL(l), hi(h, o), h.userData.mimeType = o.mimeType || jM(o.uri), h;
      }).catch(function(h) {
    ...
    assignFinalMaterial(e) {
      ...
      if (e.isPoints) {
        ...
        l || (l = new Tu(), Xn.prototype.copy.call(l, n), l.color.copy(n.color), l.map = n.map, l.sizeAttenuation = false, this.cache.add(a, l)), n = l;
      } else if (e.isLine) {
        const a = "LineBasicMaterial:" + n.uuid;
        let l = this.cache.get(a);
        l || (l = new qd(), Xn.prototype.copy.call(l, n), l.color.copy(n.color), l.map = n.map, this.cache.add(a, l)), n = l;
      }
      if (i || s || o) {
    ...
    loadMaterial(e) {
      ...
      s.doubleSided === true && (a.side = Vn);
      const u = s.alphaMode || Ul.OPAQUE;
      if (u === Ul.BLEND ? (a.transparent = true, a.depthWrite = false) : (a.transparent = false, u === Ul.MASK && (a.alphaTest = s.alphaCutoff !== void 0 ? s.alphaCutoff : 0.5)), s.normalTexture !== void 0 && o !== Gn && (c.push(t.assignTexture(a, "normalMap", s.normalTexture)), a.normalScale = new ee(1, 1), s.normalTexture.scale !== void 0)) {
        const h = s.normalTexture.scale;
        a.normalScale.set(h, h);
      }
      if (s.occlusionTexture !== void 0 && o !== Gn && (c.push(t.assignTexture(a, "aoMap", s.occlusionTexture)), s.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = s.occlusionTexture.strength)), s.emissiveFactor !== void 0 && o !== Gn) {
        const h = s.emissiveFactor;
        a.emissive = new Re().setRGB(h[0], h[1], h[2], Qt);
      }
      return s.emissiveTexture !== void 0 && o !== Gn && c.push(t.assignTexture(a, "emissiveMap", s.emissiveTexture, Ut)), Promise.all(c).then(function() {
        const h = new o(a);
        return s.name && (h.name = s.name), hi(h, s), t.associations.set(h, {
          materials: e
        }), s.extensions && rr(i, h, s), h;
      });
    }
    createUniqueName(e) {
    ...
    loadMesh(e) {
      ...
      for (let l = 0, c = o.length; l < c; l++) {
        const u = o[l].material === void 0 ? qM(this.cache) : this.getDependency("material", o[l].material);
        a.push(u);
      }
      return a.push(t.loadGeometries(o)), Promise.all(a).then(function(l) {
        ...
        for (let d = 0, _ = u.length; d < _; d++) {
          ...
          let p;
          const S = c[d];
          if (m.mode === En.TRIANGLES || m.mode === En.TRIANGLE_STRIP || m.mode === En.TRIANGLE_FAN || m.mode === void 0) p = s.isSkinnedMesh === true ? new __(g, S) : new Rt(g, S), p.isSkinnedMesh === true && p.normalizeSkinWeights(), m.mode === En.TRIANGLE_STRIP ? p.geometry = Hf(p.geometry, Dd) : m.mode === En.TRIANGLE_FAN && (p.geometry = Hf(p.geometry, Pc));
          else if (m.mode === En.LINES) p = new T_(g, S);
          else if (m.mode === En.LINE_STRIP) p = new Mu(g, S);
          else if (m.mode === En.LINE_LOOP) p = new E_(g, S);
          else if (m.mode === En.POINTS) p = new Yd(g, S);
          else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + m.mode);
          Object.keys(p.geometry.morphAttributes).length > 0 && KM(p, s), p.name = t.createUniqueName(s.name || "mesh_" + e), hi(p, s), m.extensions && rr(i, p, m), t.assignFinalMaterial(p), h.push(p);
        }
        for (let d = 0, _ = h.length; d < _; d++) t.associations.set(h[d], {
          meshes: e,
          primitives: d
        });
        if (h.length === 1) return s.extensions && rr(i, h[0], s), h[0];
        const f = new _r();
        s.extensions && rr(i, f, s), t.associations.set(f, {
          meshes: e
        });
    ...
    loadCamera(e) {
      ...
      return n.type === "perspective" ? t = new $t(kg.radToDeg(i.yfov), i.aspectRatio || 1, i.znear || 1, i.zfar || 2e6) : n.type === "orthographic" && (t = new Wa(-i.xmag, i.xmag, i.ymag, -i.ymag, i.znear, i.zfar)), n.name && (t.name = this.createUniqueName(n.name)), hi(t, n), Promise.resolve(t);
    }
    loadSkin(e) {
    ...
    loadAnimation(e) {
      ...
      for (let h = 0, f = i.channels.length; h < f; h++) {
        const d = i.channels[h], _ = i.samplers[d.sampler], g = d.target, m = g.node, p = i.parameters !== void 0 ? i.parameters[_.input] : _.input, S = i.parameters !== void 0 ? i.parameters[_.output] : _.output;
        g.node !== void 0 && (o.push(this.getDependency("node", m)), a.push(this.getDependency("accessor", p)), l.push(this.getDependency("accessor", S)), c.push(_), u.push(g));
      }
      return Promise.all([
        Promise.all(o),
        Promise.all(a),
        ...
        for (let S = 0, v = f.length; S < v; S++) {
          const x = f[S], b = d[S], w = _[S], A = g[S], P = m[S];
          if (x === void 0) continue;
          x.updateMatrix && x.updateMatrix();
          const y = n._createAnimationTracks(x, b, w, A, P);
          if (y) for (let M = 0; M < y.length; M++) p.push(y[M]);
        }
        return new f0(s, void 0, p);
      });
    }
    createNodeMesh(e) {
    ...
    _loadNodeShallow(e) {
      ...
      return l && a.push(l), s.camera !== void 0 && a.push(i.getDependency("camera", s.camera).then(function(c) {
        ...
        let u;
        if (s.isBone === true ? u = new Wd() : c.length > 1 ? u = new _r() : c.length === 1 ? u = c[0] : u = new gt(), u !== c[0]) for (let h = 0, f = c.length; h < f; h++) u.add(c[h]);
        if (s.name && (u.userData.name = s.name, u.name = o), hi(u, s), s.extensions && rr(n, u, s), s.matrix !== void 0) {
          const h = new Fe();
    ...
    loadScene(e) {
      const t = this.extensions, n = this.json.scenes[e], i = this, s = new _r();
      n.name && (s.name = i.createUniqueName(n.name)), hi(s, n), n.extensions && rr(t, s, n);
      const o = n.nodes || [], a = [];
      ...
      return Promise.all(a).then(function(l) {
        ...
        const c = (u) => {
          ...
          for (const [f, d] of i.associations) (f instanceof Xn || f instanceof Ct) && h.set(f, d);
          return u.traverse((f) => {
    ...
    _createAnimationTracks(e, t, n, i, s) {
      ...
      Di[s.path] === Di.weights ? e.traverse(function(f) {
      ...
      const u = i.interpolation !== void 0 ? XM[i.interpolation] : co, h = this._getArrayFromAccessor(n);
      for (let f = 0, d = l.length; f < d; f++) {
        const _ = new c(l[f] + "." + Di[s.path], t.array, h, u);
    ...
    _getArrayFromAccessor(e) {
      let t = e.array;
      if (e.normalized) {
        const n = Vc(t.constructor), i = new Float32Array(t.length);
  ...
  function qf(r, e, t) {
    ...
    return Ye.workingColorSpace !== Qt && "COLOR_0" in n && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ye.workingColorSpace}" not supported.`), hi(r, e), QM(r, e, t), Promise.all(i).then(function() {
      return e.targets !== void 0 ? YM(r, e.targets, t) : r;
    });
  }
  class fp extends Ar {
    constructor(e) {
    ...
    load(e, t, n, i) {
      const s = this, o = new Ru(this.manager);
...
`) a = 0, l -= s;
  ...
  var _n = {
    ...
    overwrite: false,
    delay: 0
  }, Nu, Ft, mt, qn = 1e8, Wt = 1 / qn, Hc = Math.PI * 2, iT = Hc / 4, rT = 0, mp = Math.sqrt, sT = Math.cos, oT = Math.sin, It = function(e) {
    ...
    return Mt(e) || It(e);
  }, gp = typeof ArrayBuffer == "function" && ArrayBuffer.isView || function() {
  }, Xt = Array.isArray, Gc = /(?:-?\.?\d|\.)+/gi, _p = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Zr = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Fl = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, xp = /[+-]=-?[.\d]+/, vp = /[^,'"\[\]\s]+/gi, aT = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, _t, zn, Wc, Fu, xn = {}, Ia = {}, yp, Sp = function(e) {
    return (Ia = ys(e, xn)) && ln;
  }, Bu = function(e, t) {
    return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
  }, mo = function(e, t) {
    return !t && console.warn(e);
  }, Mp = function(e, t) {
    return e && (xn[e] = t) && Ia && (Ia[e] = t) || xn;
  }, go = function() {
    return 0;
  }, lT = {
    suppressEvents: true,
    ...
    suppressEvents: true
  }, zu = {}, Vi = [], Xc = {}, Tp, dn = {}, Bl = {}, Yf = 30, ya = [], ku = "", Vu = function(e) {
    var t = e[0], n, i;
    if (Kn(t) || Mt(t) || (e = [
      e
    ]), !(n = (t._gsap || {}).harness)) {
      for (i = ya.length; i-- && !ya[i].targetTest(t); ) ;
      n = ya[i];
    }
    for (i = e.length; i--; ) e[i] && (e[i]._gsap || (e[i]._gsap = new Yp(e[i], n))) || e.splice(i, 1);
    return e;
  }, vr = function(e) {
    return e._gsap || Vu(wn(e))[0]._gsap;
  }, Ep = function(e, t, n) {
    return (n = e[t]) && Mt(n) ? e[t]() : Uu(n) && e.getAttribute && e.getAttribute(t) || n;
  }, sn = function(e, t) {
    ...
    for (Xc = {}, Vi.length = 0, n = 0; n < e; n++) i = t[n], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], true)._lazy = 0);
  }, bp = function(e, t, n, i) {
    Vi.length && !Ft && Na(), e.render(t, n, Ft && t < 0 && (e._initted || e._startAt)), Vi.length && !Ft && Na();
  }, wp = function(e) {
    var t = parseFloat(e);
    return (t || t === 0) && (e + "").match(vp).length < 2 ? t : It(e) ? e.trim() : e;
  }, Ap = function(e) {
    return e;
  }, vn = function(e, t) {
    ...
    for (var n in t) n !== "__proto__" && n !== "constructor" && n !== "prototype" && (e[n] = Kn(t[n]) ? r(e[n] || (e[n] = {}), t[n]) : t[n]);
    return e;
  }, Ua = function(e, t) {
    var n = {}, i;
    ...
    var t = e.parent || _t, n = e.keyframes ? hT(Xt(e.keyframes)) : vn;
    if (rn(e.inherit)) for (; t; ) n(e, t.vars.defaults), t = t.parent || t._dp;
    return e;
  }, fT = function(e, t) {
    for (var n = e.length, i = n === t.length; i && n-- && e[n] === t[n]; ) ;
    return n < 0;
  }, Rp = function(e, t, n, i, s) {
    var o = e[i], a;
    ...
    return e._startAt && (Ft ? e._startAt.revert(va) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, true, i));
  }, pT = function r(e) {
    ...
    var n = e._dp;
    return n && n.smoothChildTiming && e._ts && (e._start = At(n._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), Ya(e), n._dirty || yr(n, e)), e;
  }, Cp = function(e, t) {
    var n;
    if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (n = Oa(e.rawTime(), t), (!t._dur || Ro(0, t.totalDuration(), n) - t._tTime > Wt) && t.render(n, true)), yr(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
      if (e._dur < e.duration()) for (n = e; n._dp; ) n.rawTime() >= 0 && n.totalTime(n._tTime), n = n._dp;
      e._zTime = -1e-8;
    }
  }, Hn = function(e, t, n, i) {
    return t.parent && Gi(t), t._start = At((Ti(n) ? n : n || e !== _t ? Tn(e, n, t) : e._time) + t._delay), t._end = At(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Rp(e, t, "_first", "_last", e._sort ? "_start" : 0), Yc(t) || (e._recent = t), i || Cp(e, t), e._ts < 0 && Ka(e, e._tTime), e;
  }, Pp = function(e, t) {
    return (xn.ScrollTrigger || Bu("scrollTrigger", t)) && xn.ScrollTrigger.create(t, e);
  }, Lp = function(e, t, n, i, s) {
    if (Gu(e, t, s), !e._initted) return 1;
    if (!n && e._pt && !Ft && (e._dur && e.vars.lazy !== false || !e._dur && e.vars.lazy) && Tp !== pn.frame) return Vi.push(e), e._lazy = [
      s,
      i
    ], 1;
  }, mT = function r(e) {
    ...
    var s = e.ratio, o = t < 0 || !t && (!e._start && mT(e) && !(!e._initted && Yc(e)) || (e._ts < 0 || e._dp._ts < 0) && !Yc(e)) ? 0 : 1, a = e._rDelay, l = 0, c, u, h;
    if (a && e._repeat && (l = Ro(0, e._tDur, t), u = Ss(l, a), e._yoyo && u & 1 && (o = 1 - o), u !== Ss(e._tTime, a) && (s = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== s || Ft || i || e._zTime === Wt || !t && e._zTime) {
      if (!e._initted && Lp(e, t, i, n, l)) return;
      for (h = e._zTime, e._zTime = t || (n ? Wt : 0), n || (n = t && !h), e.ratio = o, e._from && (o = 1 - o), e._time = 0, e._tTime = l, c = e._pt; c; ) c.r(o, c.d), c = c._next;
      t < 0 && qc(e, t, n, true), e._onUpdate && !n && gn(e, "onUpdate"), l && e._repeat && !n && e.parent && gn(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === o && (o && Gi(e, 1), !n && !Ft && (gn(e, o ? "onComplete" : "onReverseComplete", true), e._prom && e._prom()));
    ...
    return a && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = s ? s < 0 ? 1e10 : At(o * (s + 1) + e._rDelay * s) : o, a > 0 && !i && Ka(e, e._tTime = e._tDur * a), e.parent && Ya(e), n || yr(e.parent, e), e;
  }, jf = function(e) {
    return e instanceof jt ? yr(e) : Ms(e, e._dur);
  }, xT = {
    _start: 0,
    endTime: go,
    totalDuration: go
  }, Tn = function r(e, t, n) {
    var i = e.labels, s = e._recent || xT, o = e.duration() >= qn ? s.endTime(false) : e._dur, a, l, c;
    ...
    var i = Ti(t[1]), s = (i ? 2 : 1) + (e < 2 ? 0 : 1), o = t[s], a, l;
    ...
    return !It(e) || !(t = aT.exec(e)) ? "" : t[1];
  }, vT = function(e, t, n) {
    return Yi(n, function(i) {
      return Ro(e, t, i);
    });
  }, Kc = [].slice, Dp = function(e, t) {
    return e && Kn(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Kn(e[0])) && !e.nodeType && e !== zn;
  }, yT = function(e, t, n) {
    return n === void 0 && (n = []), e.forEach(function(i) {
      var s;
      return It(i) && !t || Dp(i, 1) ? (s = n).push.apply(s, wn(i)) : n.push(i);
    }) || n;
  }, wn = function(e, t, n) {
    return mt && !t && mt.selector ? mt.selector(e) : It(e) && !n && (Wc || !Ts()) ? Kc.call((t || Fu).querySelectorAll(e), 0) : Xt(e) ? yT(e, n) : Dp(e) ? Kc.call(e, 0) : e ? [
      e
    ] : [];
  }, $c = function(e) {
    return e = wn(e)[0] || mo("Invalid scope") || {}, function(t) {
      var n = e.current || e.nativeElement || e;
      return wn(t, n.querySelectorAll ? n : n === e ? mo("Invalid scope") || Fu.createElement("div") : e);
    };
  }, Ip = function(e) {
    ...
    var t = Kn(e) ? e : {
      each: e
    }, n = Sr(t.ease), i = t.from || 0, s = parseFloat(t.base) || 0, o = {}, a = i > 0 && i < 1, l = isNaN(i) || a, c = t.axis, u = i, h = i;
    return It(i) ? u = h = {
      center: 0.5,
      edges: 0.5,
      end: 1
    }[i] || 0 : !a && l && (u = i[0], h = i[1]), function(f, d, _) {
      var g = (_ || t).length, m = o[g], p, S, v, x, b, w, A, P, y;
      if (!m) {
        if (y = t.grid === "auto" ? 0 : (t.grid || [
          1,
          qn
        ])[1], !y) {
          for (A = -1e8; A < (A = _[y++].getBoundingClientRect().left) && y < g; ) ;
          y < g && y--;
        }
        for (m = o[g] = [], p = l ? Math.min(y, g) * u - 0.5 : i % y, S = y === qn ? 0 : l ? g * h / y - 0.5 : i / y | 0, A = 0, P = qn, w = 0; w < g; w++) v = w % y - p, x = S - (w / y | 0), m[w] = b = c ? Math.abs(c === "y" ? x : v) : mp(v * v + x * x), b > A && (A = b), b < P && (P = b);
        i === "random" && Ip(m), m.max = A - P, m.min = P, m.v = g = (parseFloat(t.amount) || parseFloat(t.each) * (y > g ? g - 1 : c ? c === "y" ? g / y : y : Math.max(y, g / y)) || 0) * (i === "edges" ? -1 : 1), m.b = g < 0 ? s - g : s, m.u = Ht(t.amount || t.each) || 0, n = n && g < 0 ? Wp(n) : n;
      }
    ...
    return function(n) {
      ...
      return (i - i % 1) / t + (Ti(n) ? 0 : Ht(n));
    };
  }, Up = function(e, t) {
    var n = Xt(e), i, s;
    return !n && Kn(e) && (i = n = e.radius || qn, e.values ? (e = wn(e.values), (s = !Ti(e[0])) && (i *= i)) : e = jc(e.increment)), Yi(t, n ? Mt(e) ? function(o) {
      return s = e(o), Math.abs(s - o) <= i ? s : o;
    } : function(o) {
      for (var a = parseFloat(s ? o.x : o), l = parseFloat(s ? o.y : 0), c = qn, u = 0, h = e.length, f, d; h--; ) s ? (f = e[h].x - a, d = e[h].y - l, f = f * f + d * d) : f = Math.abs(e[h] - a), f < c && (c = f, u = h);
      return u = !i || c <= i ? e[u] : o, s || u === o || Ti(o) ? u : u + Ht(o);
    } : jc(e));
  }, Op = function(e, t, n, i) {
    return Yi(Xt(e) ? !t : n === true ? !!(n = 0) : !i, function() {
    ...
    var i = t - e;
    return Xt(e) ? Fp(e, r(0, e.length), t) : Yi(n, function(s) {
      return (i + (s - e) % i) % i + e;
    });
  }, bT = function r(e, t, n) {
    var i = t - e, s = i * 2;
    return Xt(e) ? Fp(e, r(0, e.length - 1), t) : Yi(n, function(o) {
      return o = (s + (o - e) % s) % s || 0, e + (o > i ? s - o : o);
    });
  }, _o = function(e) {
    for (var t = 0, n = "", i, s, o, a; ~(i = e.indexOf("random(", t)); ) o = e.indexOf(")", i), a = e.charAt(i + 7) === "[", s = e.substr(i + 7, o - i - 7).match(a ? vp : Gc), n += e.substr(t, i - t) + Op(a ? s : +s[0], a ? 0 : +s[1], +s[2] || 1e-5), t = o + 1;
    return n + e.substr(t, e.length - t);
  }, Bp = function(e, t, n, i, s) {
    var o = t - e, a = i - n;
    return Yi(s, function(l) {
      return n + ((l - e) / o * a || 0);
    });
  }, wT = function r(e, t, n, i) {
    ...
    if (!s) {
      ...
      if (!u) {
        for (l in t) Hu.call(a, e, l, "get", t[l]);
        s = function(_) {
          return qu(_, a) || (o ? e.p : e);
        };
      }
    }
    return Yi(n, s);
    ...
    if (s) return l = i[t + "Params"], c = i.callbackScope || e, n && Vi.length && Na(), a && (mt = a), u = l ? s.apply(c, l) : s.call(c), mt = o, u;
  }, Ws = function(e) {
    return Gi(e), e.scrollTrigger && e.scrollTrigger.kill(!!Ft), e.progress() < 1 && gn(e, "onInterrupt"), e;
  }, Jr, zp = [], kp = function(e) {
    if (e) if (e = !e.name && e.default || e, Ou() || e.headless) {
      ...
      if (Ts(), e !== i) {
        if (dn[t]) return;
        vn(i, vn(Ua(e, s), o)), ys(i.prototype, ys(s, Ua(e, o))), dn[i.prop = t] = i, e.targetTest && (ya.push(i), zu[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Mp(t, i), e.register && e.register(ln, i, on);
    } else zp.push(e);
  }, ct = 255, Xs = {
    aqua: [
      0,
    ...
    if (!i) {
      if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Xs[e]) i = Xs[e];
        ...
        if (i = _ = e.match(Gc), !t) l = +i[0] % 360 / 360, c = +i[1] / 100, u = +i[2] / 100, o = u <= 0.5 ? u * (c + 1) : u + c - u * c, s = u * 2 - o, i.length > 3 && (i[3] *= 1), i[0] = zl(l + 1 / 3, s, o), i[1] = zl(l, s, o), i[2] = zl(l - 1 / 3, s, o);
        else if (~e.indexOf("=")) return i = e.match(_p), n && i.length < 4 && (i[3] = 1), i;
      } else i = e.match(Gc) || Xs.transparent;
      i = i.map(Number);
    }
    ...
    if (s = s.map(function(f) {
      return (f = Vp(f, t, 1)) && o + (t ? f[0] + "," + f[1] + "%," + f[2] + "%," + f[3] : f.join(",")) + ")";
    }), n && (u = Hp(e), l = n.c, l.join(i) !== u.c.join(i))) for (c = e.replace(Hi, "1").split(Zr), h = c.length - 1; a < h; a++) i += c[a] + (~l.indexOf(a) ? s.shift() || o + "0,0,0,0)" : (u.length ? u : s.length ? s : n).shift());
  ...
  }(), AT = /hsl[a]?\(/, Gp = function(e) {
    var t = e.join(" "), n;
    if (Hi.lastIndex = 0, Hi.test(t)) return n = AT.test(t), e[1] = Jf(e[1], n), e[0] = Jf(e[0], n, Hp(e[1])), true;
  }, xo, pn = function() {
    var r = Date.now, e = 500, t = 33, n = r(), i = n, s = 1e3 / 240, o = s, a = [], l, c, u, h, f, d, _ = function g(m) {
      var p = r() - i, S = m === true, v, x, b, w;
      if ((p > e || p < 0) && (n += p - t), i += p, b = i - n, v = b - o, (v > 0 || S) && (w = ++h.frame, f = b - h.time * 1e3, h.time = b = b / 1e3, o += v + (v >= s ? 4 : s - v), x = 1), S || (l = c(g)), x) for (d = 0; d < a.length; d++) a[d](b, f, w, m);
    };
    return h = {
      time: 0,
      frame: 0,
      ...
      wake: function() {
        yp && (!Wc && Ou() && (zn = Wc = window, Fu = zn.document || {}, xn.gsap = ln, (zn.gsapVersions || (zn.gsapVersions = [])).push(ln.version), Sp(Ia || zn.GreenSockGlobals || !zn.gsap && zn || {}), zp.forEach(kp)), u = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && h.sleep(), c = u || function(m) {
      ...
      add: function(m, p, S) {
        ...
        return h.remove(m), a[S ? "unshift" : "push"](v), Ts(), v;
      },
      remove: function(m, p) {
    ...
    return !xo && pn.wake();
  }, Xe = {}, RT = /^[\d.\-M][\d.\-,\s]/, CT = /["']/g, PT = function(e) {
    for (var t = {}, n = e.substr(1, e.length - 3).split(":"), i = n[0], s = 1, o = n.length, a, l, c; s < o; s++) l = n[s], a = s !== o - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, a), t[i] = isNaN(c) ? c.replace(CT, "").trim() : +c, i = l.substr(a + 1).trim();
    return t;
  }, LT = function(e) {
    ...
    return n && t.length > 1 && n.config ? n.config.apply(null, ~e.indexOf("{") ? [
      PT(t[1])
    ] : LT(e).split(",").map(wp)) : Xe._CE && RT.test(e) ? Xe._CE("", e) : n;
  }, Wp = function(e) {
    return function(t) {
      return 1 - e(1 - t);
    };
    ...
    var i = t >= 1 ? t : 1, s = (n || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = s / Hc * (Math.asin(1 / i) || 0), a = function(u) {
      return u === 1 ? 1 : i * Math.pow(2, -10 * u) * oT((u - o) * s) + 1;
    }, l = e === "out" ? a : e === "in" ? function(c) {
      return 1 - a(1 - c);
    } : qp(a);
    return s = Hc / s, l.config = function(c, u) {
      return r(e, c, u);
    }, l;
  }, Vl = function r(e, t) {
    t === void 0 && (t = 1.70158);
  ...
  Cr("Sine", function(r) {
    return r === 1 ? 1 : -sT(r * iT) + 1;
  });
  Cr("Back", Vl("in"), Vl("out"), Vl());
  Xe.SteppedEase = Xe.steps = xn.SteppedEase = {
    config: function(e, t) {
      e === void 0 && (e = 1);
      var n = 1 / e, i = e + (t ? 0 : 1), s = t ? 1 : 0, o = 1 - Wt;
      return function(a) {
        return ((i * Ro(0, o, a) | 0) + s) * n;
      };
    }
  };
  vs.ease = Xe["quad.out"];
  sn("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(r) {
    return ku += r + "," + r + "Params,";
  });
  var Yp = function(e, t) {
    this.id = rT++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Ep, this.set = t ? t.getSetter : Xu;
  }, vo = function() {
    function r(t) {
      this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Ms(this, +t.duration, 1, 1), this.data = t.data, mt && (this._ctx = mt, mt.data.push(this)), xo || pn.wake();
    }
    var e = r.prototype;
    return e.delay = function(n) {
      ...
      if (s && s.smoothChildTiming && this._ts) {
        for (Ka(this, n), !s._dp || s.parent || Cp(s, this); s && s.parent; ) s.parent._time !== s._start + (s._ts >= 0 ? s._tTime / s._ts : (s.totalDuration() - s._tTime) / -s._ts) && s.totalTime(s._tTime, true), s = s.parent;
        !this.parent && this._dp.autoRemoveChildren && (this._ts > 0 && n < this._tDur || this._ts < 0 && n > 0 || !this._tDur && !n) && Hn(this._dp, this, this._start - this._delay);
      }
      return (this._tTime !== n || !this._dur && !i || this._initted && Math.abs(this._zTime) === Wt || !n && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = n), bp(this, n, i)), this;
    }, e.time = function(n, i) {
      return arguments.length ? this.totalTime(Math.min(this.totalDuration(), n + $f(this)) % (this._dur + this._rDelay) || (n ? this._dur : 0), i) : this._time;
      ...
      return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - n : n) + $f(this), i) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
      ...
      var s = this.parent && this._ts ? Oa(this.parent._time, this) : this._tTime;
      return this._rts = +n || 0, this._ts = this._ps || n === -1e-8 ? 0 : this._rts, this.totalTime(Ro(-Math.abs(this._delay), this._tDur, s), i !== false), Ya(this), dT(this);
    }, e.paused = function(n) {
      ...
      if (arguments.length) {
        ...
        return i && (i._sort || !this.parent) && Hn(i, this, n - this._delay), this;
      }
      return this._start;
      ...
      var i = this.parent || this._dp;
      return i ? n && (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? Oa(i.rawTime(n), this) : this._tTime : this._tTime;
    }, e.revert = function(n) {
      n === void 0 && (n = cT);
      var i = Ft;
      ...
      return arguments.length ? (this._repeat = n === 1 / 0 ? -2 : n, jf(this)) : this._repeat === -2 ? 1 / 0 : this._repeat;
    }, e.repeatDelay = function(n) {
      if (arguments.length) {
        var i = this._time;
        return this._rDelay = n, jf(this), i ? this.time(i) : this;
      }
      return this._rDelay;
    }, e.yoyo = function(n) {
  ...
  var jt = function(r) {
    ...
    function e(n, i) {
      var s;
      return n === void 0 && (n = {}), s = r.call(this, n) || this, s.labels = {}, s.smoothChildTiming = !!n.smoothChildTiming, s.autoRemoveChildren = !!n.autoRemoveChildren, s._sort = rn(n.sortChildren), _t && Hn(n.parent || _t, fi(s), i), n.reversed && s.reverse(), n.paused && s.paused(true), n.scrollTrigger && Pp(fi(s), n.scrollTrigger), s;
    }
    var t = e.prototype;
    return t.to = function(i, s, o) {
      return to(0, arguments, this), this;
    }, t.from = function(i, s, o) {
      return to(1, arguments, this), this;
    }, t.fromTo = function(i, s, o, a) {
      return to(2, arguments, this), this;
    }, t.set = function(i, s, o) {
      return s.duration = 0, s.parent = this, eo(s).repeatDelay || (s.repeat = 0), s.immediateRender = !!s.immediateRender, new wt(i, s, Tn(this, o), 1), this;
    }, t.call = function(i, s, o) {
      return Hn(this, wt.delayedCall(0, i, s), o);
      ...
      return o.runBackwards = 1, eo(o).immediateRender = rn(o.immediateRender), this.staggerTo(i, s, o, a, l, c, u);
    }, t.staggerFromTo = function(i, s, o, a, l, c, u, h) {
      return a.startAt = o, eo(a).immediateRender = rn(a.immediateRender), this.staggerTo(i, s, a, l, c, u, h);
    }, t.render = function(i, s, o) {
      var a = this._time, l = this._dirty ? this.totalDuration() : this._tDur, c = this._dur, u = i <= 0 ? 0 : At(i), h = this._zTime < 0 != i < 0 && (this._initted || !c), f, d, _, g, m, p, S, v, x, b, w, A;
      if (this !== _t && u > l && i >= 0 && (u = l), u !== this._tTime || o || h) {
        if (a !== this._time && c && (u += this._time - a, i += this._time - a), f = u, x = this._start, v = this._ts, p = !v, h && (c || (a = this._zTime), (i || !s) && (this._zTime = i)), this._repeat) {
          ...
          if (f = At(u % m), u === l ? (g = this._repeat, f = c) : (b = At(u / m), g = ~~b, g && g === b && (f = c, g--), f > c && (f = c)), b = Ss(this._tTime, m), !a && this._tTime && b !== g && this._tTime - b * m - this._dur <= 0 && (b = g), w && g & 1 && (f = c - f, A = 1), g !== b && !this._lock) {
            ...
            if (c = this._dur, l = this._tDur, y && (this._lock = 2, a = P ? c : -1e-4, this.render(a, true), this.vars.repeatRefresh && !A && this.invalidate()), this._lock = 0, !this._ts && !p) return this;
            Xp(this, A);
          }
        }
        if (this._hasPause && !this._forcing && this._lock < 2 && (S = _T(this, At(a), At(f)), S && (u -= f - (f = S._start))), this._tTime = u, this._time = f, this._act = !v, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, a = 0), !a && f && !s && !g && (gn(this, "onStart"), this._tTime !== u)) return this;
        if (f >= a && i >= 0) for (d = this._first; d; ) {
          if (_ = d._next, (d._act || f >= d._start) && d._ts && S !== d) {
          ...
          d = this._last;
          for (var M = i < 0 ? i : f; d; ) {
            if (_ = d._prev, (d._act || M <= d._end) && d._ts && S !== d) {
              if (d.parent !== this) return this.render(i, s, o);
        ...
        if (S && !s && (this.pause(), S.render(f >= a ? 0 : -1e-8)._zTime = f >= a ? 1 : -1, this._ts)) return this._start = x, Ya(this), this.render(i, s, o);
      ...
      var o = this;
      if (Ti(s) || (s = Tn(this, s, i)), !(i instanceof vo)) {
      ...
      return this !== i ? Hn(this, i, s) : this;
      ...
      return It(i) ? this.removeLabel(i) : Mt(i) ? this.killTweensOf(i) : (i.parent === this && qa(this, i), i === this._recent && (this._recent = this._last), yr(this));
      ...
      var a = wt.delayedCall(0, s || go, o);
      return a.data = "isPause", this._hasPause = 1, Hn(this, a, Tn(this, i));
    }, t.removePause = function(i) {
      var s = this._first;
      for (i = Tn(this, i); s; ) s._start === i && s.data === "isPause" && Gi(s), s = s._next;
    }, t.killTweensOf = function(i, s, o) {
      for (var a = this.getTweensOf(i, o), l = a.length; l--; ) Fi !== a[l] && a[l].kill(i, s);
      return this;
    }, t.getTweensOf = function(i, s) {
      for (var o = [], a = wn(i), l = this._first, c = Ti(s), u; l; ) l instanceof wt ? uT(l._targets, a) && (c ? (!Fi || l._initted && l._ts) && l.globalTime(0) <= s && l.globalTime(l.totalDuration()) > s : !s || l.isActive()) && o.push(l) : (u = l.getTweensOf(a, s)).length && o.push.apply(o, u), l = l._next;
      return o;
      ...
      return i === void 0 && (i = this._time), Zf(this, Tn(this, i));
    }, t.previousLabel = function(i) {
      return i === void 0 && (i = this._time), Zf(this, Tn(this, i), 1);
      ...
      if (o._dirty) {
        for (h = o.parent; a; ) c = a._prev, a._dirty && a.totalDuration(), u = a._start, u > l && o._sort && a._ts && !o._lock ? (o._lock = 1, Hn(o, a, u - a._delay, 1)._lock = 0) : l = u, u < 0 && a._ts && (s -= u, (!h && !o._dp || h && h.smoothChildTiming) && (o._start += u / o._ts, o._time -= u, o._tTime -= u), o.shiftChildren(-u, false, -1 / 0), l = 0), a._end > s && a._ts && (s = a._end), a = c;
        Ms(o, o === _t && o._time > s ? o._time : s, 1, 1), o._dirty = 0;
      }
      return o._tDur;
    }, e.updateRoot = function(i) {
      if (_t._ts && (bp(_t, Oa(i, _t)), Tp = pn.frame), pn.frame >= Yf) {
        Yf += _n.autoSleep || 120;
        var s = _t._first;
  ...
  var IT = function(e, t, n, i, s, o, a) {
    var l = new on(this._pt, e, t, 0, 1, Qp, null, s), c = 0, u = 0, h, f, d, _, g, m, p, S;
    for (l.b = n, l.e = i, n += "", i += "", (p = ~i.indexOf("random(")) && (i = _o(i)), o && (S = [
      n,
      i
    ], o(S, e, t), n = S[0], i = S[1]), f = n.match(Fl) || []; h = Fl.exec(i); ) _ = h[0], g = i.substring(c, h.index), d ? d = (d + 1) % 5 : g.substr(-5) === "rgba(" && (d = 1), _ !== f[u++] && (m = parseFloat(f[u - 1]) || 0, l._pt = {
      _next: l._pt,
      p: g || u === 1 ? g : ",",
      s: m,
      c: _.charAt(1) === "=" ? rs(m, _) - m : parseFloat(_) - m,
      m: d && d < 4 ? Math.round : 0
    }, c = Fl.lastIndex);
    return l.c = c < i.length ? i.substring(c, i.length) : "", l.fp = a, (xp.test(i) || p) && (l.e = 0), this._pt = l, l;
  }, Hu = function(e, t, n, i, s, o, a, l, c, u) {
    Mt(i) && (i = i(s || 0, e, o));
    var h = e[t], f = n !== "get" ? n : Mt(h) ? c ? e[t.indexOf("set") || !Mt(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : h, d = Mt(h) ? c ? BT : Zp : Wu, _;
    if (It(i) && (~i.indexOf("random(") && (i = _o(i)), i.charAt(1) === "=" && (_ = rs(f, i) + (Ht(f) || 0), (_ || _ === 0) && (i = _))), !u || f !== i || Zc) return !isNaN(f * i) && i !== "" ? (_ = new on(this._pt, e, t, +f || 0, i - (f || 0), typeof h == "boolean" ? kT : Jp, 0, d), c && (_.fp = c), a && _.modifier(a, this, e), this._pt = _) : (!h && !(t in e) && Bu(t, i), IT.call(this, e, t, f, i, d, l || _n.stringFilter, c));
  }, NT = function(e, t, n, i, s) {
    if (Mt(e) && (e = no(e, s, t, n, i)), !Kn(e) || e.style && e.nodeType || Xt(e) || gp(e)) return It(e) ? no(e, s, t, n, i) : e;
    var o = {}, a;
    for (a in e) o[a] = no(e[a], s, t, n, i);
    return o;
  }, Kp = function(e, t, n, i, s, o) {
    var a, l, c, u;
    if (dn[e] && (a = new dn[e]()).init(s, a.rawVars ? t[e] : NT(t[e], i, s, o, n), n, i, o) !== false && (n._pt = l = new on(n._pt, s, e, 0, 1, a.render, a, 0, a.priority), n !== Jr)) for (c = n._ptLookup[n._targets.indexOf(s)], u = a._props.length; u--; ) c[a._props[u]] = l;
    return a;
  }, Fi, Zc, Gu = function r(e, t, n) {
    var i = e.vars, s = i.ease, o = i.startAt, a = i.immediateRender, l = i.lazy, c = i.onUpdate, u = i.runBackwards, h = i.yoyoEase, f = i.keyframes, d = i.autoRevert, _ = e._dur, g = e._startAt, m = e._targets, p = e.parent, S = p && p.data === "nested" ? p.vars.targets : m, v = e._overwrite === "auto" && !Nu, x = e.timeline, b, w, A, P, y, M, L, G, O, V, q, B, $;
    if (x && (!f || !s) && (s = "none"), e._ease = Sr(s, vs.ease), e._yEase = h ? Wp(Sr(h === true ? s : h, vs.ease)) : 0, h && e._yoyo && !e._repeat && (h = e._yEase, e._yEase = e._ease, e._ease = h), e._from = !x && !!i.runBackwards, !x || f && !i.stagger) {
      if (G = m[0] ? vr(m[0]).harness : 0, B = G && i[G.prop], b = Ua(i, zu), g && (g._zTime < 0 && g.progress(1), t < 0 && u && a && !d ? g.render(-1, true) : g.revert(u && _ ? va : lT), g._lazy = 0), o) {
        if (Gi(e._startAt = wt.set(m, vn({
          data: "isStart",
          overwrite: false,
          parent: p,
          ...
          stagger: 0
        }, o))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Ft || !a && !d) && e._startAt.revert(va), a && _ && t <= 0 && n <= 0) {
          t && (e._zTime = t);
          return;
        }
      } else if (u && _ && !g) {
        if (t && (a = false), A = vn({
          ...
          stagger: 0,
          parent: p
        }, b), B && (A[G.prop] = B), Gi(e._startAt = wt.set(m, A)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Ft ? e._startAt.revert(va) : e._startAt.render(-1, true)), e._zTime = t, !a) r(e._startAt, Wt, Wt);
        else if (!t) return;
      }
      for (e._pt = e._ptCache = 0, l = _ && rn(l) || l && !_, w = 0; w < m.length; w++) {
        if (y = m[w], L = y._gsap || Vu(m)[w]._gsap, e._ptLookup[w] = V = {}, Xc[L.id] && Vi.length && Na(), q = S === m ? w : S.indexOf(y), G && (O = new G()).init(y, B || b, e, q, S) !== false && (e._pt = P = new on(e._pt, y, O.name, 0, 1, O.render, O, 0, O.priority), O._props.forEach(function(H) {
          V[H] = P;
        }), O.priority && (M = 1)), !G || B) for (A in b) dn[A] && (O = Kp(A, b, e, q, y, S)) ? O.priority && (M = 1) : V[A] = P = Hu.call(e, y, A, "get", b[A], q, S, 0, i.stringFilter);
        e._op && e._op[w] && e.kill(y, e._op[w]), v && e._pt && (Fi = e, _t.killTweensOf(y, V, e.globalTime(t)), $ = !e.parent, Fi = 0), e._pt && l && (Xc[L.id] = 1);
      }
      M && em(e), e._onInit && e._onInit(e);
    }
    e._onUpdate = c, e._initted = (!e._op || e._pt) && !$, f && t <= 0 && x.render(qn, true, true);
  }, UT = function(e, t, n, i, s, o, a, l) {
    ...
    if (!c) for (c = e._ptCache[t] = [], f = e._ptLookup, d = e._targets.length; d--; ) {
      ...
      if (!u) return Zc = 1, e.vars[t] = "+=0", Gu(e, a), Zc = 0, l ? mo(t + " not eligible for reset") : 1;
      c.push(u);
    }
    for (d = c.length; d--; ) h = c[d], u = h._pt || h, u.s = (i || i === 0) && !s ? i : u.s + (i || 0) + o * u.c, u.c = n - u.s, h.e && (h.e = Tt(n) + Ht(h.e)), h.b && (h.b = u.s + Ht(h.b));
  }, OT = function(e, t) {
    var n = e[0] ? vr(e[0]).harness : 0, i = n && n.aliases, s, o, a, l;
    if (!i) return t;
    s = ys({}, t);
  ...
  }, no = function(e, t, n, i, s) {
    return Mt(e) ? e.call(t, n, i, s) : It(e) && ~e.indexOf("random(") ? _o(e) : e;
  }, $p = ku + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert", jp = {};
  sn($p + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
    return jp[r] = 1;
  });
  var wt = function(r) {
    pp(e, r);
    function e(n, i, s, o) {
      var a;
      typeof i == "number" && (s.duration = i, i = s, s = null), a = r.call(this, o ? i : eo(i)) || this;
      var l = a.vars, c = l.duration, u = l.delay, h = l.immediateRender, f = l.stagger, d = l.overwrite, _ = l.keyframes, g = l.defaults, m = l.scrollTrigger, p = l.yoyoEase, S = i.parent || _t, v = (Xt(n) || gp(n) ? Ti(n[0]) : "length" in i) ? [
        n
      ] : wn(n), x, b, w, A, P, y, M, L;
      if (a._targets = v.length ? Vu(v) : mo("GSAP target " + n + " not found. https://gsap.com", !_n.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, _ || f || la(c) || la(u)) {
        if (i = a.vars, x = a.timeline = new jt({
          data: "nested",
          defaults: g || {},
          targets: S && S.data === "nested" ? S.vars.targets : v
        }), x.kill(), x.parent = x._dp = fi(a), x._start = 0, f || la(c) || la(u)) {
          if (A = v.length, M = f && Np(f), Kn(f)) for (P in f) ~$p.indexOf(P) && (L || (L = {}), L[P] = f[P]);
          for (b = 0; b < A; b++) w = Ua(i, jp), w.stagger = 0, p && (w.yoyoEase = p), L && ys(w, L), y = v[b], w.duration = +no(c, fi(a), b, y, v), w.delay = (+no(u, fi(a), b, y, v) || 0) - a._delay, !f && A === 1 && w.delay && (a._delay = u = w.delay, a._start += u, w.delay = 0), x.to(y, w, M ? M(b, y, v) : 0), x._ease = Xe.none;
          x.duration() ? c = u = 0 : a.timeline = 0;
        } else if (_) {
          eo(vn(x.vars.defaults, {
            ease: "none"
          })), x._ease = Sr(_.ease || i.ease || "none");
          var G = 0, O, V, q;
          if (Xt(_)) _.forEach(function(B) {
            ...
            w = {};
            for (P in _) P === "ease" || P === "easeEach" || FT(P, _[P], w, _.easeEach);
      ...
      return d === true && !Nu && (Fi = fi(a), _t.killTweensOf(v), Fi = 0), Hn(S, fi(a), s), i.reversed && a.reverse(), i.paused && a.paused(true), (h || !c && !_ && a._start === At(S._time) && rn(h) && pT(fi(a)) && S.data !== "nested") && (a._tTime = -1e-8, a.render(Math.max(0, -u) || 0)), m && Pp(fi(a), m), a;
    }
    var t = e.prototype;
    return t.render = function(i, s, o) {
      var a = this._time, l = this._tDur, c = this._dur, u = i < 0, h = i > l - Wt && !u ? l : i < Wt ? 0 : i, f, d, _, g, m, p, S, v, x;
      if (!c) gT(this, i, s, o);
        ...
        if (f = h, v = this.timeline, this._repeat) {
          ...
          _ !== m && (v && this._yEase && Xp(v, p), this.vars.repeatRefresh && !p && !this._lock && f !== g && this._initted && (this._lock = o = 1, this.render(At(g * _), true).invalidate()._lock = 0));
        }
        if (!this._initted) {
          if (Lp(this, u ? i : f, o, s, h)) return this._tTime = 0, this;
          if (a !== this._time && !(o && this.vars.repeatRefresh && _ !== m)) return this;
          if (c !== this._dur) return this.render(i, s, o);
        }
        if (this._tTime = h, this._time = f, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = S = (x || this._ease)(f / c), this._from && (this.ratio = S = 1 - S), f && !a && !s && !_ && (gn(this, "onStart"), this._tTime !== h)) return this;
        for (d = this._pt; d; ) d.r(S, d.d), d = d._next;
        v && v.render(i < 0 ? i : v._dur * v._ease(f / this._dur), s, o) || this._startAt && (this._zTime = i), this._onUpdate && !s && (u && qc(this, i, s, o), gn(this, "onUpdate")), this._repeat && _ !== m && this.vars.onRepeat && !s && this.parent && gn(this, "onRepeat"), (h === this._tDur || !h) && this._tTime === h && (u && !this._onUpdate && qc(this, i, true, true), (i || !c) && (h === this._tDur && this._ts > 0 || !h && this._ts < 0) && Gi(this, 1), !s && !(u && !a) && (h || a || p) && (gn(this, h === l ? "onComplete" : "onReverseComplete", true), this._prom && !(h < l && this.timeScale() > 0) && this._prom()));
      }
      return this;
    }, t.targets = function() {
      ...
      xo || pn.wake(), this._ts || this.play();
      var c = Math.min(this._dur, (this._dp._time - this._start) * this._ts), u;
      return this._initted || Gu(this, c), u = this._ease(c / this._dur), UT(this, i, s, o, a, u, c, l) ? this.resetTo(i, s, o, a, 1) : (Ka(this, 0), this.parent || Rp(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
    }, t.kill = function(i, s) {
      ...
      if (this.timeline) {
        ...
        return this.timeline.killTweensOf(i, s, Fi && Fi.vars.overwrite !== true)._first || Ws(this), this.parent && o !== this.timeline.totalDuration() && Ms(this, this._dur * this.timeline._tDur / o, 0, 1), this;
      }
      var a = this._targets, l = i ? wn(i) : a, c = this._ptLookup, u = this._pt, h, f, d, _, g, m, p;
      if ((!s || s === "all") && fT(a, l)) return s === "all" && (this._pt = 0), Ws(this);
      for (h = this._op = this._op || [], s !== "all" && (It(s) && (g = {}, sn(s, function(S) {
        return g[S] = 1;
      }), s = g), s = OT(a, s)), p = a.length; p--; ) if (~l.indexOf(a[p])) {
        f = c[p], s === "all" ? (h[p] = s, _ = f, d = {}) : (d = h[p] = h[p] || {}, _ = s);
        for (g in _) m = f && f[g], m && ((!("kill" in m.d) || m.d.kill(g) === true) && qa(this, m, "_pt"), delete f[g]), d !== "all" && (d[g] = 1);
      }
      return this._initted && !this._pt && u && Ws(this), this;
    }, e.to = function(i, s) {
      return new e(i, s, arguments[2]);
    }, e.from = function(i, s) {
      return to(1, arguments);
  ...
  sn("staggerTo,staggerFrom,staggerFromTo", function(r) {
    wt[r] = function() {
      var e = new jt(), t = Kc.call(arguments, 0);
  ...
  var Wu = function(e, t, n) {
    ...
    return Mt(e[t]) ? Zp : Uu(e[t]) && e.setAttribute ? zT : Wu;
  }, Jp = function(e, t) {
    ...
    for (var t = this._pt, n, i; t; ) i = t._next, t.p === e && !t.op || t.op === e ? qa(this, t, "_pt") : t.dep || (n = 1), t = i;
    return !n;
  }, GT = function(e, t, n, i) {
    ...
    function r(t, n, i, s, o, a, l, c, u) {
      this.t = n, this.s = s, this.c = o, this.p = i, this.r = a || Jp, this.d = l || this, this.set = c || Wu, this.pr = u || 0, this._next = t, t && (t._prev = this);
    }
    var e = r.prototype;
    return e.modifier = function(n, i, s) {
      this.mSet = this.mSet || this.set, this.set = GT, this.m = n, this.mt = s, this.tween = i;
    }, r;
  }();
  sn(ku + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function(r) {
    return zu[r] = 1;
  });
  ...
  _n.stringFilter = Gp;
  var Mr = [], Sa = {}, WT = [], Qf = 0, XT = 0, Hl = function(e) {
    return (Sa[e] || WT).map(function(t) {
      return t();
    });
  }, Jc = function() {
    var e = Date.now(), t = [];
    e - Qf > 2 && (Hl("matchMediaInit"), Mr.forEach(function(n) {
      var i = n.queries, s = n.conditions, o, a, l, c;
      for (a in i) o = zn.matchMedia(i[a]).matches, o && (l = 1), o !== s[a] && (s[a] = o, c = 1);
      c && (n.revert(), l && t.push(n));
    }), Hl("matchMediaRevert"), t.forEach(function(n) {
    ...
    function r(t, n) {
      this.selector = n && $c(n), this.data = [], this._r = [], this.isReverted = false, this.id = XT++, t && this.add(t);
    }
    var e = r.prototype;
    return e.add = function(n, i, s) {
      ...
      var o = this, a = function() {
        ...
        return c && c !== o && c.data.push(o), s && (o.selector = $c(s)), mt = o, h = i.apply(o, arguments), Mt(h) && o._r.push(h), mt = c, o.selector = u, o.isReverted = false, h;
      };
      ...
      }), this.clear(), i) for (var o = Mr.length; o--; ) Mr[o].id === this.id && Mr.splice(o, 1);
    }, e.revert = function(n) {
      this.kill(n || {});
    }, r;
  }(), qT = function() {
    ...
    return e.add = function(n, i, s) {
      ...
      var o = new tm(0, s || this.scope), a = o.conditions = {}, l, c, u;
      mt && !o.selector && (o.selector = mt.selector), this.contexts.push(o), i = o.add("onMatch", i), o.queries = n;
      for (c in n) c === "all" ? u = 1 : (l = zn.matchMedia(n[c]), l && (Mr.indexOf(o) < 0 && Mr.push(o), (a[c] = l.matches) && (u = 1), l.addListener ? l.addListener(Jc) : l.addEventListener("change", Jc)));
    ...
    quickSetter: function(e, t, n) {
      ...
      e = e[0] || {};
      var o = dn[t], a = vr(e), l = a.harness && (a.harness.aliases || {})[t] || t, c = o ? function(u) {
        var h = new o();
        Jr._pt = 0, h.init(e, n ? u + n : u, Jr, 0, [
          e
        ]), h.render(1, h), Jr._pt && qu(1, Jr);
      } : a.set(e, l);
    ...
    defaults: function(e) {
      return e && e.ease && (e.ease = Sr(e.ease, vs.ease)), Kf(vs, e || {});
    },
    config: function(e) {
      return Kf(_n, e || {});
    },
    registerEffect: function(e) {
      ...
      (i || "").split(",").forEach(function(a) {
        return a && !dn[a] && !xn[a] && mo(t + " effect requires " + a + " plugin.");
      }), Bl[t] = function(a, l, c) {
        return n(wn(a), vn(l || {}, s), c);
      }, o && (jt.prototype[t] = function(a, l, c) {
        return this.add(Bl[t](a, Kn(l) ? l : (c = l) && {}, this), c);
      });
    },
    ...
    parseEase: function(e, t) {
      return arguments.length ? Sr(e, t) : Xe;
    },
    getById: function(e) {
      return _t.getById(e);
    },
    exportRoot: function(e, t) {
      e === void 0 && (e = {});
      var n = new jt(e), i, s;
      for (n.smoothChildTiming = rn(e.smoothChildTiming), _t.remove(n), n._dp = 0, n._time = n._tTime = _t._time, i = _t._first; i; ) s = i._next, (t || !(!i._dur && i instanceof wt && i.vars.onComplete === i._targets[0])) && Hn(n, i, i._start - i._delay), i = s;
      return Hn(_t, n, 0), n;
    },
    context: function(e, t) {
      return e ? new tm(e, t) : mt;
    },
  ...
  var YT = function(e, t) {
    ...
    for (i in t) for (s = n.length; s--; ) o = e._ptLookup[s][i], o && (o = o.d) && (o._pt && (o = YT(o, i)), o && o.modifier && o.modifier(t[i], e, n[s], i));
  }, Gl = function(e, t) {
    return {
      name: e,
      rawVars: 1,
  ...
  }, Gl("roundProps", jc), Gl("modifiers"), Gl("snap", Up)) || Fa;
  ...
  Xe.Expo;
  Xe.Circ;
  var ed, Bi, ss, Yu, xr, td, Ku, $T = function() {
    return typeof window < "u";
  }, Ei = {}, ur = 180 / Math.PI, os = Math.PI / 180, Yr = Math.atan2, nd = 1e8, $u = /([A-Z])/g, jT = /(left|right|width|margin|padding|x)/i, ZT = /[\s,\(]\S/, Wn = {
  ...
  }, sE = function(e, t, n, i, s) {
    var o = e._gsap;
    o.scaleX = o.scaleY = n, o.renderTransform(s, o);
  }, oE = function(e, t, n, i, s) {
    var o = e._gsap;
    o[t] = n, o.renderTransform(s, o);
  }, vt = "transform", an = vt + "Origin", aE = function r(e, t) {
    var n = this, i = this.target, s = i.style, o = i._gsap;
    if (e in Ei && s) {
      if (this.tfm = this.tfm || {}, e !== "transform") e = Wn[e] || e, ~e.indexOf(",") ? e.split(",").forEach(function(a) {
        return n.tfm[a] = di(i, a);
      }) : this.tfm[e] = o.x ? o[e] : di(i, e), e === an && (this.tfm.zOrigin = o.zOrigin);
      else return Wn.transform.split(",").forEach(function(a) {
        return r.call(n, a, t);
      });
    ...
    for (s = 0; s < e.length; s += 3) e[s + 1] ? e[s + 1] === 2 ? t[e[s]](e[s + 2]) : t[e[s]] = e[s + 2] : e[s + 2] ? n[e[s]] = e[s + 2] : n.removeProperty(e[s].substr(0, 2) === "--" ? e[s] : e[s].replace($u, "-$1").toLowerCase());
    if (this.tfm) {
      for (o in this.tfm) i[o] = this.tfm[o];
      i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), s = Ku(), (!s || !s.isStart) && !n[vt] && (rm(n), i.zOrigin && n[an] && (n[an] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
    }
  }, sm = function(e, t) {
    var n = {
      target: e,
    ...
    return i[t] || i.getPropertyValue(t.replace($u, "-$1").toLowerCase()) || i.getPropertyValue(t) || !n && r(e, Es(t) || t, 1) || "";
    ...
    $T() && window.document && (ed = window, Bi = ed.document, ss = Bi.documentElement, xr = eu("div") || {
      style: {}
    }, eu("div"), vt = Es(vt), an = vt + "Origin", xr.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", om = !!Es("perspective"), Ku = ln.core.reverting, Yu = 1);
  }, rd = function(e) {
    var t = e.ownerSVGElement, n = eu("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = e.cloneNode(true), s;
    i.style.display = "block", n.appendChild(i), ss.appendChild(n);
    try {
      s = i.getBBox();
    } catch {
    }
    return n.removeChild(i), ss.removeChild(n), s;
  }, sd = function(e, t) {
    ...
    return !!(e.getCTM && (!e.parentNode || e.ownerSVGElement) && am(e));
  }, br = function(e, t) {
    if (t) {
      var n = e.style, i;
      t in Ei && t !== an && (t = vt), n.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), n.removeProperty(i === "--" ? t : t.replace($u, "-$1").toLowerCase())) : n.removeAttribute(t);
    }
  }, zi = function(e, t, n, i, s, o) {
    var a = new on(e._pt, t, n, 0, 1, o ? im : nm);
    ...
    var s = parseFloat(n) || 0, o = (n + "").trim().substr((s + "").length) || "px", a = xr.style, l = jT.test(t), c = e.tagName.toLowerCase() === "svg", u = (c ? "client" : "offset") + (l ? "Width" : "Height"), h = 100, f = i === "px", d = i === "%", _, g, m, p;
    if (i === o || !s || od[i] || od[o]) return s;
    if (o !== "px" && !f && (s = r(e, t, n, "px")), p = e.getCTM && lm(e), (d || o === "%") && (Ei[t] || ~t.indexOf("adius"))) return _ = p ? e.getBBox()[l ? "width" : "height"] : e[u], Tt(d ? s / _ * h : s / 100 * _);
    if (a[l ? "width" : "height"] = h + (f ? o : i), g = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !c ? e : e.parentNode, p && (g = (e.ownerSVGElement || {}).parentNode), (!g || g === Bi || !g.appendChild) && (g = Bi.body), m = g._gsap, m && d && m.width && l && m.time === pn.time && !m.uncache) return Tt(s / m.width * h);
    if (d && (t === "height" || t === "width")) {
      var S = e.style[t];
      e.style[t] = h + i, _ = e[u], S ? e.style[t] = S : br(e, t);
    } else (d || o === "%") && !cE[Yn(g, "display")] && (a.position = Yn(e, "position")), g === e && (a.position = "static"), g.appendChild(xr), _ = xr[u], g.removeChild(xr), a.position = "absolute";
    return l && d && (m = vr(g), m.time = pn.time, m.width = g[u]), Tt(f ? _ * s / h : _ && s ? h / _ * s : 0);
  }, di = function(e, t, n, i) {
    var s;
    return Yu || tu(), t in Wn && t !== "transform" && (t = Wn[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ei[t] && t !== "transform" ? (s = So(e, i), s = t !== "transformOrigin" ? s[t] : s.svg ? s.origin : za(Yn(e, an)) + " " + s.zOrigin + "px") : (s = e.style[t], (!s || s === "auto" || i || ~(s + "").indexOf("calc(")) && (s = Ba[t] && Ba[t](e, t, n) || Yn(e, t) || Ep(e, t) || (t === "opacity" ? 1 : 0))), n && !~(s + "").trim().indexOf(" ") ? Wi(e, t, s, n) + n : s;
  }, uE = function(e, t, n, i) {
    if (!n || n === "none") {
      var s = Es(t, e, 1), o = s && Yn(e, s, 1);
      o && o !== n ? (t = s, n = o) : t === "borderColor" && (n = Yn(e, "borderTopColor"));
    }
    var a = new on(this._pt, e.style, t, 0, 1, Qp), l = 0, c = 0, u, h, f, d, _, g, m, p, S, v, x, b;
    if (a.b = n, a.e = i, n += "", i += "", i === "auto" && (g = e.style[t], e.style[t] = i, i = Yn(e, t) || i, g ? e.style[t] = g : br(e, t)), u = [
      n,
      i
    ], Gp(u), n = u[0], i = u[1], f = n.match(Zr) || [], b = i.match(Zr) || [], b.length) {
      for (; h = Zr.exec(i); ) m = h[0], S = i.substring(l, h.index), _ ? _ = (_ + 1) % 5 : (S.substr(-5) === "rgba(" || S.substr(-5) === "hsla(") && (_ = 1), m !== (g = f[c++] || "") && (d = parseFloat(g) || 0, x = g.substr((d + "").length), m.charAt(1) === "=" && (m = rs(d, m) + x), p = parseFloat(m), v = m.substr((p + "").length), l = Zr.lastIndex - v.length, v || (v = v || _n.units[t] || x, l === i.length && (i += v, a.e += v)), x !== v && (d = Wi(e, t, g, v) || 0), a._pt = {
        _next: a._pt,
        p: S || c === 1 ? S : ",",
        s: d,
        c: p - d,
    ...
    } else a.r = t === "display" && i === "none" ? im : nm;
    return xp.test(i) && (a.e = 0), this._pt = a, a;
  }, ad = {
    top: "0%",
    bottom: "100%",
    left: "0%",
    ...
    if (t.tween && t.tween._time === t.tween._dur) {
      ...
      else for (s = s.split(","), c = s.length; --c > -1; ) a = s[c], Ei[a] && (l = 1, a = a === "transformOrigin" ? an : vt), br(n, a);
      l && (br(n, vt), o && (o.svg && n.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", So(n, 1), o.uncache = 1, rm(i)));
    }
  }, Ba = {
    clearProps: function(e, t, n, i, s) {
      if (s.data !== "isFromStart") {
        var o = e._pt = new on(e._pt, t, n, 0, 0, fE);
    ...
    var t = Yn(e, vt);
    return um(t) ? yo : t.substr(7).match(_p).map(Tt);
  }, ju = function(e, t) {
    var n = e._gsap || vr(e), i = e.style, s = ld(e), o, a, l, c;
    return n.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, s = [
      ...
      l.e,
      l.f
    ], s.join(",") === "1,0,0,1,0,0" ? yo : s) : (s === yo && !e.offsetParent && e !== ss && !n.svg && (l = i.display, i.display = "block", o = e.parentNode, (!o || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, a = e.nextElementSibling, ss.appendChild(e)), s = ld(e), l ? i.display = l : br(e, "display"), c && (a ? o.insertBefore(e, a) : o ? o.appendChild(e) : ss.removeChild(e))), t && s.length > 6 ? [
      s[0],
      s[1],
      s[4],
      s[5],
  ...
  }, nu = function(e, t, n, i, s, o) {
    var a = e._gsap, l = s || ju(e, true), c = a.xOrigin || 0, u = a.yOrigin || 0, h = a.xOffset || 0, f = a.yOffset || 0, d = l[0], _ = l[1], g = l[2], m = l[3], p = l[4], S = l[5], v = t.split(" "), x = parseFloat(v[0]) || 0, b = parseFloat(v[1]) || 0, w, A, P, y;
    n ? l !== yo && (A = d * m - _ * g) && (P = x * (m / A) + b * (-g / A) + (g * S - m * p) / A, y = x * (-_ / A) + b * (d / A) - (d * S - _ * p) / A, x = P, b = y) : (w = am(e), x = w.x + (~v[0].indexOf("%") ? x / 100 * w.width : x), b = w.y + (~(v[1] || v[0]).indexOf("%") ? b / 100 * w.height : b)), i || i !== false && a.smooth ? (p = x - c, S = b - u, a.xOffset = h + (p * d + S * g) - p, a.yOffset = f + (p * _ + S * m) - S) : a.xOffset = a.yOffset = 0, a.xOrigin = x, a.yOrigin = b, a.smooth = !!i, a.origin = t, a.originIsAbsolute = !!n, e.style[an] = "0px 0px", o && (zi(o, a, "xOrigin", c, x), zi(o, a, "yOrigin", u, b), zi(o, a, "xOffset", h, a.xOffset), zi(o, a, "yOffset", f, a.yOffset)), e.setAttribute("data-svg-origin", x + " " + b);
  }, So = function(e, t) {
    var n = e._gsap || new Yp(e);
    if ("x" in n && !t && !n.uncache) return n;
    var i = e.style, s = n.scaleX < 0, o = "px", a = "deg", l = getComputedStyle(e), c = Yn(e, an) || "0", u, h, f, d, _, g, m, p, S, v, x, b, w, A, P, y, M, L, G, O, V, q, B, $, H, oe, ce, ge, Le, Ke, X, ie;
    return u = h = f = g = m = p = S = v = x = 0, d = _ = 1, n.svg = !!(e.getCTM && lm(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[vt] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[vt] !== "none" ? l[vt] : "")), i.scale = i.rotate = i.translate = "none"), A = ju(e, n.svg), n.svg && (n.uncache ? (H = e.getBBox(), c = n.xOrigin - H.x + "px " + (n.yOrigin - H.y) + "px", $ = "") : $ = !t && e.getAttribute("data-svg-origin"), nu(e, $ || c, !!$ || n.originIsAbsolute, n.smooth !== false, A)), b = n.xOrigin || 0, w = n.yOrigin || 0, A !== yo && (L = A[0], G = A[1], O = A[2], V = A[3], u = q = A[4], h = B = A[5], A.length === 6 ? (d = Math.sqrt(L * L + G * G), _ = Math.sqrt(V * V + O * O), g = L || G ? Yr(G, L) * ur : 0, S = O || V ? Yr(O, V) * ur + g : 0, S && (_ *= Math.abs(Math.cos(S * os))), n.svg && (u -= b - (b * L + w * O), h -= w - (b * G + w * V))) : (ie = A[6], Ke = A[7], ce = A[8], ge = A[9], Le = A[10], X = A[11], u = A[12], h = A[13], f = A[14], P = Yr(ie, Le), m = P * ur, P && (y = Math.cos(-P), M = Math.sin(-P), $ = q * y + ce * M, H = B * y + ge * M, oe = ie * y + Le * M, ce = q * -M + ce * y, ge = B * -M + ge * y, Le = ie * -M + Le * y, X = Ke * -M + X * y, q = $, B = H, ie = oe), P = Yr(-O, Le), p = P * ur, P && (y = Math.cos(-P), M = Math.sin(-P), $ = L * y - ce * M, H = G * y - ge * M, oe = O * y - Le * M, X = V * M + X * y, L = $, G = H, O = oe), P = Yr(G, L), g = P * ur, P && (y = Math.cos(P), M = Math.sin(P), $ = L * y + G * M, H = q * y + B * M, G = G * y - L * M, B = B * y - q * M, L = $, q = H), m && Math.abs(m) + Math.abs(g) > 359.9 && (m = g = 0, p = 180 - p), d = Tt(Math.sqrt(L * L + G * G + O * O)), _ = Tt(Math.sqrt(B * B + ie * ie)), P = Yr(q, B), S = Math.abs(P) > 2e-4 ? P * ur : 0, x = X ? 1 / (X < 0 ? -X : X) : 0), n.svg && ($ = e.getAttribute("transform"), n.forceCSS = e.setAttribute("transform", "") || !um(Yn(e, vt)), $ && e.setAttribute("transform", $))), Math.abs(S) > 90 && Math.abs(S) < 270 && (s ? (d *= -1, S += g <= 0 ? 180 : -180, g += g <= 0 ? 180 : -180) : (_ *= -1, S += S <= 0 ? 180 : -180)), t = t || n.uncache, n.x = u - ((n.xPercent = u && (!t && n.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetWidth * n.xPercent / 100 : 0) + o, n.y = h - ((n.yPercent = h && (!t && n.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-h) ? -50 : 0))) ? e.offsetHeight * n.yPercent / 100 : 0) + o, n.z = f + o, n.scaleX = Tt(d), n.scaleY = Tt(_), n.rotation = Tt(g) + a, n.rotationX = Tt(m) + a, n.rotationY = Tt(p) + a, n.skewX = S + a, n.skewY = v + a, n.transformPerspective = x + o, (n.zOrigin = parseFloat(c.split(" ")[2]) || !t && n.zOrigin || 0) && (i[an] = za(c)), n.xOffset = n.yOffset = 0, n.force3D = _n.force3D, n.renderTransform = n.svg ? pE : om ? hm : dE, n.uncache = 0, n;
  }, za = function(e) {
    return (e = e.split(" "))[0] + " " + e[1];
  }, Wl = function(e, t, n) {
    var i = Ht(t);
    return Tt(parseFloat(t) + parseFloat(Wi(e, "x", n + "px", i))) + i;
  }, dE = function(e, t) {
    t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, hm(e, t);
  }, sr = "0deg", Vs = "0px", or = ") ", hm = function(e, t) {
    var n = t || this, i = n.xPercent, s = n.yPercent, o = n.x, a = n.y, l = n.z, c = n.rotation, u = n.rotationY, h = n.rotationX, f = n.skewX, d = n.skewY, _ = n.scaleX, g = n.scaleY, m = n.transformPerspective, p = n.force3D, S = n.target, v = n.zOrigin, x = "", b = p === "auto" && e && e !== 1 || p === true;
    if (v && (h !== sr || u !== sr)) {
      var w = parseFloat(u) * os, A = Math.sin(w), P = Math.cos(w), y;
      w = parseFloat(h) * os, y = Math.cos(w), o = Wl(S, o, A * y * -v), a = Wl(S, a, -Math.sin(w) * -v), l = Wl(S, l, P * y * -v + v);
    }
    m !== Vs && (x += "perspective(" + m + or), (i || s) && (x += "translate(" + i + "%, " + s + "%) "), (b || o !== Vs || a !== Vs || l !== Vs) && (x += l !== Vs || b ? "translate3d(" + o + ", " + a + ", " + l + ") " : "translate(" + o + ", " + a + or), c !== sr && (x += "rotate(" + c + or), u !== sr && (x += "rotateY(" + u + or), h !== sr && (x += "rotateX(" + h + or), (f !== sr || d !== sr) && (x += "skew(" + f + ", " + d + or), (_ !== 1 || g !== 1) && (x += "scale(" + _ + ", " + g + or), S.style[vt] = x || "translate(0, 0)";
  }, pE = function(e, t) {
    var n = t || this, i = n.xPercent, s = n.yPercent, o = n.x, a = n.y, l = n.rotation, c = n.skewX, u = n.skewY, h = n.scaleX, f = n.scaleY, d = n.target, _ = n.xOrigin, g = n.yOrigin, m = n.xOffset, p = n.yOffset, S = n.forceCSS, v = parseFloat(o), x = parseFloat(a), b, w, A, P, y;
    l = parseFloat(l), c = parseFloat(c), u = parseFloat(u), u && (u = parseFloat(u), c += u, l += u), l || c ? (l *= os, c *= os, b = Math.cos(l) * h, w = Math.sin(l) * h, A = Math.sin(l - c) * -f, P = Math.cos(l - c) * f, c && (u *= os, y = Math.tan(c - u), y = Math.sqrt(1 + y * y), A *= y, P *= y, u && (y = Math.tan(u), y = Math.sqrt(1 + y * y), b *= y, w *= y)), b = Tt(b), w = Tt(w), A = Tt(A), P = Tt(P)) : (b = h, P = f, w = A = 0), (v && !~(o + "").indexOf("px") || x && !~(a + "").indexOf("px")) && (v = Wi(d, "x", o, "px"), x = Wi(d, "y", a, "px")), (_ || g || m || p) && (v = Tt(v + _ - (_ * b + g * A) + m), x = Tt(x + g - (_ * w + g * P) + p)), (i || s) && (y = d.getBBox(), v = Tt(v + i / 100 * y.width), x = Tt(x + s / 100 * y.height)), y = "matrix(" + b + "," + w + "," + A + "," + P + "," + v + "," + x + ")", d.setAttribute("transform", y), S && (d.style[vt] = y);
  }, mE = function(e, t, n, i, s) {
    var o = 360, a = It(s), l = parseFloat(s) * (a && ~s.indexOf("rad") ? ur : 1), c = l - i, u = i + c + "deg", h, f;
    return a && (h = s.split("_")[1], h === "short" && (c %= o, c !== c % (o / 2) && (c += c < 0 ? o : -360)), h === "cw" && c < 0 ? c = (c + o * nd) % o - ~~(c / o) * o : h === "ccw" && c > 0 && (c = (c - o * nd) % o - ~~(c / o) * o)), e._pt = f = new on(e._pt, t, n, i, c, JT), f.e = u, f.u = "deg", e._props.push(n), f;
  }, cd = function(e, t) {
    for (var n in t) e[n] = t[n];
    return e;
  }, gE = function(e, t, n) {
    var i = cd({}, n._gsap), s = "perspective,force3D,transformOrigin,svgOrigin", o = n.style, a, l, c, u, h, f, d, _;
    i.svg ? (c = n.getAttribute("transform"), n.setAttribute("transform", ""), o[vt] = t, a = So(n, 1), br(n, vt), n.setAttribute("transform", c)) : (c = getComputedStyle(n)[vt], o[vt] = t, a = So(n, 1), o[vt] = c);
    for (l in Ei) c = i[l], u = a[l], c !== u && s.indexOf(l) < 0 && (d = Ht(c), _ = Ht(u), h = d !== _ ? Wi(n, l, c, _) : parseFloat(c), f = parseFloat(u), e._pt = new on(e._pt, a, l, h, f - h, Qc), e._pt.u = _ || 0, e._props.push(l));
    cd(a, i);
  };
  sn("padding,margin,Width,Radius", function(r, e) {
    ...
    Ba[e > 1 ? "border" + r : r] = function(a, l, c, u, h) {
      var f, d;
  ...
  var fm = {
    ...
    init: function(e, t, n, i, s) {
      var o = this._props, a = e.style, l = n.vars.startAt, c, u, h, f, d, _, g, m, p, S, v, x, b, w, A, P;
      Yu || tu(), this.styles = this.styles || sm(e), P = this.styles.props, this.tween = n;
      for (g in t) if (g !== "autoRound" && (u = t[g], !(dn[g] && Kp(g, t, n, i, e, s)))) {
        if (d = typeof u, _ = Ba[g], d === "function" && (u = u.call(n, i, e, s), d = typeof u), d === "string" && ~u.indexOf("random(") && (u = _o(u)), _) _(this, e, g, u, n) && (A = 1);
          ...
          if (l && g in l ? (c = typeof l[g] == "function" ? l[g].call(n, i, e, s) : l[g], It(c) && ~c.indexOf("random(") && (c = _o(c)), Ht(c + "") || c === "auto" || (c += _n.units[g] || Ht(di(e, g)) || ""), (c + "").charAt(1) === "=" && (c = di(e, g))) : c = di(e, g), f = parseFloat(c), S = d === "string" && u.charAt(1) === "=" && u.substr(0, 2), S && (u = u.substr(2)), h = parseFloat(u), g in Wn && (g === "autoAlpha" && (f === 1 && di(e, "visibility") === "hidden" && h && (f = 0), P.push("visibility", 0, a.visibility), zi(this, a, "visibility", f ? "inherit" : "hidden", h ? "inherit" : "hidden", !h)), g !== "scale" && g !== "transform" && (g = Wn[g], ~g.indexOf(",") && (g = g.split(",")[0]))), v = g in Ei, v) {
            if (this.styles.save(g), x || (b = e._gsap, b.renderTransform && !t.parseTransform || So(e, t.parseTransform), w = t.smoothOrigin !== false && b.smooth, x = this._pt = new on(this._pt, a, vt, 0, 1, b.renderTransform, b, 0, -1), x.dep = 1), g === "scale") this._pt = new on(this._pt, b, "scaleY", b.scaleY, (S ? rs(b.scaleY, S + h) : h) - b.scaleY || 0, Qc), this._pt.u = 0, o.push("scaleY", g), g += "X";
            else if (g === "transformOrigin") {
              P.push(an, 0, a[an]), u = hE(u), b.svg ? nu(e, u, 0, w, 0, this) : (p = parseFloat(u.split(" ")[2]) || 0, p !== b.zOrigin && zi(this, b, "zOrigin", b.zOrigin, p), zi(this, a, g, za(c), za(u)));
              continue;
            } else if (g === "svgOrigin") {
              nu(e, u, 1, w, 0, this);
              continue;
            } else if (g in cm) {
              mE(this, b, g, f, S ? rs(f, S + u) : u);
              continue;
          ...
          if (v || (h || h === 0) && (f || f === 0) && !ZT.test(u) && g in a) m = (c + "").substr((f + "").length), h || (h = 0), p = Ht(u) || (g in _n.units ? _n.units[g] : m), m !== p && (f = Wi(e, g, c, p)), this._pt = new on(this._pt, v ? b : a, g, f, (S ? rs(f, S + h) : h) - f, !v && (p === "px" || g === "zIndex") && t.autoRound !== false ? eE : Qc), this._pt.u = p || 0, m !== p && p !== "%" && (this._pt.b = c, this._pt.r = QT);
          else if (g in a) uE.call(this, e, g, c, S ? S + u : u);
          else if (g in e) this.add(e, g, c || e[g], S ? S + u : u, i, s);
    ...
    render: function(e, t) {
      if (t.tween._time || !Ku()) for (var n = t._pt; n; ) n.r(e, n.d), n = n._next;
    ...
    getSetter: function(e, t, n) {
      var i = Wn[t];
      return i && i.indexOf(",") < 0 && (t = i), t in Ei && t !== an && (e._gsap.x || di(e, "x")) ? n && td === n ? t === "scale" ? rE : iE : (td = n || {}) && (t === "scale" ? sE : oE) : e.style && !Uu(e.style[t]) ? tE : ~t.indexOf("-") ? nE : Xu(e, t);
    },
    core: {
      _removeProperty: br,
      _getMatrix: ju
  ...
  ln.core.getStyleSaver = sm;
  (function(r, e, t, n) {
    var i = sn(r + "," + e + "," + t, function(s) {
      Ei[s] = 1;
    });
    sn(e, function(s) {
      _n.units[s] = "deg", cm[s] = 1;
    }), Wn[i[13]] = r + "," + e, sn(n, function(s) {
      var o = s.split(":");
      Wn[o[1]] = i[o[0]];
    });
  ...
  ln.registerPlugin(fm);
  ft = ln.registerPlugin(fm) || ln;
  ft.core.Tween;
  function ut(r) {
    return `/iridium_23e_year_sim-se/${r}`;
  }
  const Xl = /* @__PURE__ */ new Map(), qs = [], bs = new Rr(), Ma = new ee();
  let oi = null;
  const ql = new ee(), Ki = [];
  async function ka(r) {
    return await (await fetch(r)).text();
  }
  async function iu(r, e, t, n = 1.5, i, s = 0.02, o = "#F99F00", a = 0.05, l = 0.03) {
    return new Promise((c, u) => {
      new fp().load(ut("res/font/Genos_Bold.json"), async (f) => {
        try {
          const d = new dp(r, {
            font: f,
            size: n,
            ...
            bevelOffset: 0,
            bevelSegments: 5
          }), _ = await ka(ut("res/shaders/textVertexShader.glsl")), g = await ka(ut("res/shaders/textFragmentShader.glsl")), m = new Gt({
            uniforms: {
              textColor: {
                value: new Re(o)
              },
  ...
  function Pr(r, e, t, n, i, s, o, a) {
    ...
    new vM().load(e, (c) => {
      ...
      }), Xl.set(r, u), o.add(u), ud(u, s), a && a(u);
    }, void 0, (c) => {
  ...
  function _E(r, e, t) {
    ...
    Ma.x = (r.clientX - n.left) / n.width * 2 - 1, Ma.y = -((r.clientY - n.top) / n.height) * 2 + 1, bs.setFromCamera(Ma, e);
    const i = [
      ...qs,
      ...Ki
    ...
    if (s.length > 0) {
      const o = s[0].object;
      oi !== o && (oi && qs.includes(oi) && ft.to(oi.scale, {
        x: 1,
        y: 1,
        z: 1,
        duration: 0.3
      }), oi = o, document.body.style.cursor = "pointer", qs.includes(o) && ft.to(o.scale, {
        x: 1.1,
        y: 1.1,
        z: 1.1,
        duration: 0.3
      }));
    } else oi && qs.includes(oi) && ft.to(oi.scale, {
      x: 1,
      y: 1,
      z: 1,
      duration: 0.3
    }), oi = null, document.body.style.cursor = "default";
  }
  function xE(r, e) {
    bs.setFromCamera(Ma, e);
  ...
  function vE(r, e, t) {
    window.addEventListener("mousemove", (n) => _E(n, r, t)), window.addEventListener("click", (n) => xE(n, r));
  }
  function ru(r, e) {
    r.traverse((t) => {
      t.isMesh && (t.userData.onClick = e, Ki.push(t));
    });
  }
  function yE(r, e) {
    window.addEventListener("click", (t) => {
      const n = e.domElement.getBoundingClientRect();
      ql.x = (t.clientX - n.left) / n.width * 2 - 1, ql.y = -((t.clientY - n.top) / n.height) * 2 + 1, bs.setFromCamera(ql, r);
      const i = bs.intersectObjects(Ki, true);
      if (i.length > 0) {
        const s = i[0].object;
  ...
  async function $i(r, e, t, n = 0.7, i, s, o = "center") {
    return new Promise((a, l) => {
      new fp().load(ut("res/font/GenosThin_Regular.json"), async (u) => {
        try {
          const h = new dp(r, {
            font: u,
            size: n,
          ...
          const f = await ka(ut("res/shaders/textVertexShader.glsl")), d = await ka(ut("res/shaders/textFragmentShader.glsl")), _ = new Gt({
            uniforms: {
              textColor: {
          ...
          const m = h.boundingBox.getSize(new D()), p = 0.3, S = new wr(m.x + p, m.y + p, 0.2), v = new wo({
            color: 0,
            transparent: true,
            opacity: 0.05,
            emissive: new Re(0),
  ...
  let hd = "refs-viewport", pm = "refs-wrapper", mm = "refs-iframe", fd = "";
  function ar(r) {
    gm();
    const e = document.getElementById(pm), t = document.getElementById(mm);
    !e || !t || fd !== r && (e.style.transition = "transform 1s ease-in-out", e.style.transform = "rotateY(180deg)", setTimeout(() => {
      t.onload = () => {
        e.style.transform = "rotateY(0deg)", fd = r;
      }, t.src = r;
    }, 500));
  }
  function gm() {
    ...
    e.id = pm, e.style.transform = "rotateY(0deg)", e.style.transition = "transform 1.2s cubic-bezier(0.4, 0.0, 0.2, 1)", e.style.transformStyle = "preserve-3d", e.style.backfaceVisibility = "hidden", e.style.width = "40vw", e.style.height = "70vh", e.style.marginRight = "10vw", e.style.background = "#000", e.style.border = "1px solid #007BFF80", e.style.boxShadow = `
    ...
    t.id = mm, t.src = ut("refsViewport/disclaimer.html"), t.style.width = "100%", t.style.height = "100%", t.style.border = "none", t.style.backgroundColor = "#000", e.style.backgroundColor = "#000", e.appendChild(t), r.appendChild(e), document.body.appendChild(r);
  }
  function SE() {
  ...
  function ME() {
    ...
    e.style.fontSize = "1.2rem", Vt = document.createElement("button"), Vt.textContent = "\u2715", Vt.style.background = "none", Vt.style.border = "none", Vt.style.color = "white", Vt.style.fontSize = "1.5rem", Vt.style.cursor = "pointer", Vt.style.padding = "0 5px", Vt.style.lineHeight = "1", r.appendChild(Vt), at.appendChild(r), tn = document.createElement("iframe"), tn.src = "/iridium_23e_year_sim-se/psycheName/psycheName.html", tn.style.width = "100%", tn.style.height = "100%", tn.style.border = "none", tn.style.backgroundColor = "#222", tn.onerror = () => {
      ...
      duration: 0.4,
      ease: "power2.out"
    }), Vt.addEventListener("click", Mo), document.addEventListener("keydown", TE);
  }
  document.addEventListener("DOMContentLoaded", function() {
    ...
    }), t.addEventListener("click", Mo), window.addEventListener("click", function(i) {
      i.target === e && Mo();
    });
  });
  function Mo() {
  ...
  const EE = "modulepreload", bE = function(r) {
    return "/iridium_23e_year_sim-se/" + r;
  }, dd = {}, su = function(e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      i = Promise.allSettled(t.map((l) => {
        if (l = bE(l), l in dd) return;
        dd[l] = true;
        const c = l.endsWith(".css"), u = c ? '[rel="stylesheet"]' : "";
        if (document.querySelector(`link[href="${l}"]${u}`)) return;
        const h = document.createElement("link");
        if (h.rel = c ? "stylesheet" : EE, c || (h.as = "script"), h.crossOrigin = "", h.href = l, a && h.setAttribute("nonce", a), document.head.appendChild(h), c) return new Promise((f, d) => {
  ...
  document.addEventListener("DOMContentLoaded", $a);
  setInterval($a, 1e3);
  let it = null, li = null, Ni = null, io = null;
  function xm() {
  ...
  function ro() {
    if (!it) return;
    const { width: r, maxWidth: e, height: t } = xm();
    it.style.width = r, it.style.maxWidth = e, it.style.height = t, console.log(`Viewport resized to: width=${r}, maxWidth=${e}, height=${t}`);
  }
  function AE(r) {
    if (it) {
      it.style.display = "flex", ro();
      return;
    }
    console.log("Creating games viewport"), it = document.createElement("div"), it.id = "games-viewport-container", Zu(it, {
      backgroundColor: "rgba(0, 0, 0, 0.05)",
      borderColor: "rgba(122, 95, 62, 0.3)",
      boxShadow: "0 0 15px rgba(122, 95, 62, 0.3)"
    });
    const { width: e, maxWidth: t, height: n } = xm();
    ...
    s.textContent = "Psyche Mission Games", Qu(s);
    const o = document.createElement("div");
    o.style.display = "flex", o.style.alignItems = "center";
    const a = document.createElement("button");
    a.textContent = "\u21A9", wE(a), Ni = document.createElement("button"), Ni.textContent = "\u2715", eh(Ni), o.appendChild(a), o.appendChild(Ni), i.appendChild(s), i.appendChild(o), it.appendChild(i), li = document.createElement("iframe"), li.src = ut("/games/games.html"), th(li, {
      backgroundColor: "rgba(0, 0, 0, 0.0)"
    }), nh(document), li.onerror = () => {
      console.error("Failed to load games iframe content");
    }, li.onload = () => {
      console.log("Games iframe loaded successfully"), ih(li);
    }, it.appendChild(li), document.body.appendChild(it), rh(it), sh(it), oh(it, i, li), ah(it), Ni.addEventListener("click", () => {
      RE(r);
    }), a.addEventListener("click", () => {
      lh();
    }), document.addEventListener("keydown", ym), window.addEventListener("resize", ro), io = new ResizeObserver((l) => {
      console.log("ResizeObserver detected size change"), ro();
  ...
  function lh() {
    it && (Ni && Ni.removeEventListener("click", vm), document.removeEventListener("keydown", ym), window.removeEventListener("resize", ro), io && (io.disconnect(), io = null), it.style.transition = "opacity 0.5s ease", it.style.opacity = "0", setTimeout(() => {
      document.body.removeChild(it), it = null, li = null, Ni = null;
    }, 500));
  }
  ...
  window.resetGamesViewportSize = function() {
    ...
    return ro(), "Viewport size reset to responsive mode";
  };
  function RE(r) {
    lh(), ft.to(r.position, {
      duration: 1.5,
  ...
  let CE = false, _i = new D(), as = new Fn();
  function PE(r, e, t, n) {
    return new Promise((i, s) => {
      ...
      try {
        Pr("controller", ut("res/models/arcade_controller.glb"), l, 2, u, {
          rotation: {
            x: 0,
            y: -40,
            z: 0,
        ...
        const { buttonMesh: h } = $i("TRY SOME PSYCHE INSPIRED GAMES!", a, c, 0.7, r, () => {
          _i.copy(e.position), as.copy(e.rotation);
  ...
  let pt = null, ci = null, pr = null, hr = null, Ys = null, pi = null;
  function LE() {
    if (pt) {
      pt.style.display = "flex";
      return;
    }
    console.log("Creating Year viewport"), pt = document.createElement("div"), pt.id = "year-viewport-container", Zu(pt, {
      backgroundColor: "rgba(0, 0, 0, 0.9)",
      borderColor: "rgb(255, 255, 255)",
      boxShadow: "0 0 20px rgba(255, 255, 204, 0.6)"
    }), pt.style.width = "80%", pt.style.maxWidth = "1440px", pt.style.height = "95vh", hr = document.createElement("div"), Ju(hr, {
      backgroundColor: "#f9a000",
      gradientStart: "#f9a000",
      gradientEnd: "#f9a000"
    }), Ys = document.createElement("h2"), Ys.textContent = "Compare Earth and Psyche", Qu(Ys), pr = document.createElement("button"), pr.textContent = "\u2715", eh(pr), hr.appendChild(Ys), hr.appendChild(pr), pt.appendChild(hr), ci = document.createElement("iframe"), ci.src = ut("/year/year.html"), th(ci, {
      backgroundColor: "#222"
    }), ci.onerror = () => {
      console.error("Failed to load iframe content");
    }, ci.onload = () => {
      console.log("Iframe loaded successfully"), ih(ci);
    }, pt.appendChild(ci), document.body.appendChild(pt), rh(pt), sh(pt, 80), oh(pt, hr, ci), pi = ah(pt, {
      color: "rgba(255, 255, 255, 0.6)",
      intensity: "25px"
    }), nh(document), pr.addEventListener("click", ch), document.addEventListener("keydown", Sm);
  }
  function ch() {
    pt && (pi && pi.kill(), _m(pt, () => {
      pt.style.display = "none", pt.style.opacity = 1, pt.style.transform = "translate(-50%, -50%) scale(1)", document.body.classList.add("overlay-open"), pi && (pi.restart(), pi.pause());
    }).play());
  }
  function Sm(r) {
    r.key === "Escape" && ch();
  ...
  function DE() {
    pt ? (pi && pi.kill(), ft.to(pt, {
      y: "100%",
      duration: 0.5,
      ease: "power1.in",
      onComplete: () => {
        pr.removeEventListener("click", ch), document.removeEventListener("keydown", Sm), document.body.removeChild(pt), pt = null, ci = null, pr = null, hr = null, Ys = null, pi = null;
      }
  ...
  function IE(r, e, t, n) {
    ...
    return new Promise((c, u) => {
      try {
        Pr("balance", ut("res/models/balance_scale.glb"), o, 0.9, l, null, r, () => {
          console.log("loaded model");
        });
        const { buttonMesh: h } = $i("THE COSMIC COMPARISON OF EARTH AND PSYCHE", s, a, 0.7, r, () => {
          LE(), console.log("Cosmic Comparison button clicked.");
        }), f = new Rr(), d = new ee();
        window.addEventListener("mousemove", (_) => {
          const g = n.domElement.getBoundingClientRect();
          d.x = (_.clientX - g.left) / g.width * 2 - 1, d.y = -((_.clientY - g.top) / g.height) * 2 + 1, f.setFromCamera(d, e);
  ...
  let Ze = null, ui = null, mr = null, so = null;
  function Mm() {
    const r = window.innerWidth, e = window.innerHeight, t = window.devicePixelRatio || 1;
    console.log(`Screen size: ${r}x${e}, Pixel ratio: ${t}`);
    let n, i, s;
  ...
  function FE() {
    if (Ze) {
      Ze.style.display = "flex", oo();
      return;
    }
    console.log("Creating location2 viewport"), Ze = document.createElement("div"), Ze.id = "location2-viewport-container", Zu(Ze, {
      backgroundColor: "rgba(0, 0, 0, 0.05)",
      borderColor: "rgba(122, 95, 62, 0.3)",
      boxShadow: "0 0 15px rgba(122, 95, 62, 0.3)"
    });
    ...
    i.textContent = "Psyche's Location in Space", Qu(i), mr = document.createElement("button"), mr.textContent = "\u2715", eh(mr), n.appendChild(i), n.appendChild(mr), Ze.appendChild(n), ui = document.createElement("iframe"), ui.src = ut("/PsycheJR/location2.html"), th(ui, {
      backgroundColor: "rgba(0, 0, 0, 0.0)"
    }), nh(document), ui.onerror = () => {
      console.error("Failed to load location2 iframe content");
    }, ui.onload = () => {
      console.log("Location2 iframe loaded successfully"), ih(ui);
    }, Ze.appendChild(ui), document.body.appendChild(Ze), rh(Ze), sh(Ze), oh(Ze, n, ui), ah(Ze), mr.addEventListener("click", uh), document.addEventListener("keydown", Tm), window.addEventListener("resize", oo), so = new ResizeObserver((s) => {
      console.log("ResizeObserver detected size change"), oo();
    }), so.observe(document.body);
  }
  function uh() {
    Ze && _m(Ze, () => {
  ...
  function BE() {
    Ze && (mr.removeEventListener("click", uh), document.removeEventListener("keydown", Tm), window.removeEventListener("resize", oo), so && (so.disconnect(), so = null), document.body.removeChild(Ze), Ze = null, ui = null, mr = null);
  }
  ...
  window.resetLocation2ViewportSize = function() {
    ...
    return oo(), "Viewport size reset to responsive mode";
  };
  let gr, pd, ou, To = 1, Ta = false, au = 0, Em = false;
  function Ea() {
    return Em;
  }
  function Bn(r) {
  ...
  const md = {
    ...
    3: () => {
      su(async () => {
        const { hideKidsViewport: r } = await import("./kidsViewport-CxsEjIHO.js");
        return {
          hideKidsViewport: r
        };
  ...
  let ca = To;
  function zE(r) {
    au = r.touches[0].clientY;
  }
  function kE(r) {
    const e = r.touches[0].clientY, t = au - e;
    au = e, bm({
      deltaY: t
    }), r.preventDefault();
  }
  function VE(r, e, t) {
    gr = r, pd = t, ou = e, window.addEventListener("wheel", bm, {
      passive: false
    }), window.addEventListener("touchstart", zE, {
      passive: false
    }), window.addEventListener("touchmove", kE, {
      passive: false
    }), window.addEventListener("resize", () => HE(gr, pd));
  }
  function HE(r, e) {
    if (!r || !e) {
  ...
  function bm(r) {
    ...
    let t = To + e;
    console.log("Swipe Direction: ", e), t > 8 ? t = 0 : t < 0 && (t = 8), Ta = true, Bn(true), Ks(t).then(() => {
      Ta = false, Bn(false);
    });
  }
  function Ks(r, e = null) {
    return new Promise((t) => {
      ...
      md[ca] && md[ca](), ca === 6 && r !== 6 && ft.to(gr.rotation, {
        x: as.x,
        y: as.y,
        z: as.z,
        duration: 1,
      ...
      ft.to(gr.position, {
        ...
        onComplete: () => {
          r !== 6 && (new D(gr.position.x, gr.position.y, gr.position.z - 1), r === 0 && gm()), Ta = false, console.log("Moved to Section:", To), t();
        }
      });
    });
  }
  ...
  function WE(r, e, t) {
    return new Promise((n) => {
      ...
      iu("REFERENCES", s, a, 1, r, 0.02, "#FFA500", 0.07, 0.03), [
        {
          text: "Disclaimer",
          onClick: () => ar(ut("refsViewport/disclaimer.html"))
        },
        {
          text: "Dev & Contributors",
          onClick: () => ar(ut("refsViewport/dev.html"))
        },
        {
          text: "Acknowledgments",
          onClick: () => ar(ut("refsViewport/thanks.html"))
        },
        {
          text: "Licensing",
          onClick: () => ar(ut("refsViewport/license.html"))
        },
        {
          text: "Third Party Assets",
          onClick: () => ar(ut("refsViewport/assets.html"))
        },
        {
          text: "Technical References",
          onClick: () => ar(ut("refsViewport/technical.html"))
        },
        {
          text: "Contact / Support",
          onClick: () => ar(ut("refsViewport/contact.html"))
        }
      ].forEach((c, u) => {
        const h = {
          x: o.x,
        ...
        $i(c.text, h, a, 0.5, r, c.onClick, "right");
      }), n();
    });
  }
  function XE(r, e, t) {
    ...
    return new Promise(async (l, c) => {
      iu("YEAR ON PSYCHE", i, s, 1.5, r, 0.02, "#FFA500", 0.07, 0.03);
      const h = await iu(`16 PSYCHE IS AN ASTEROID IN OUR SOLAR SYSTEM.
...
`, o, a, 0.4, r, null, "#FFA500");
      h.material.uniforms.opacity.value = 0, ft.to(h.material.uniforms.opacity, {
        ...
        duration: 2.5,
        delay: 4
      }), Pr("asteroid", ut("res/models/psyche_new.glb"), {
        x: 80,
        y: 60,
        z: 20
      }, 6, {
  ...
  function qE(r, e, t, n) {
    ...
    return new Promise((a, l) => {
      try {
        const { buttonMesh: c } = $i("CLICK HERE TO LEARN HOW PSYCHE GOT ITS NAME!", s, o, 0.7, r, () => {
          console.log("Origin button clicked."), ME();
        }), u = new Rr(), h = new ee();
  ...
  function KE(r, e, t, n) {
    return new Promise((i, s) => {
      ...
      try {
        Pr("Jr", ut("res/models/Jr.glb"), u, 9, f, null, r, (_) => {
          lu = _, wm = _.position.y;
        }), $i("EXPLORE THE PSYCHE Jr KIDS EXPERIENCE", c, h, 0.7, r, () => {
  ...
  function $E(r, e) {
    ...
    if (lu && n) {
      const i = (Date.now() - YE) * 1e-3;
      lu.position.y = wm + Math.sin(i * 2) * 0.2;
    }
  }
  function jE(r, e, t, n) {
    var _a2;
    ...
    return new Promise((c, u) => {
      try {
        Pr("Satellite", ut("res/models/satellite.glb"), o, 0.75, l, {
          rotation: {
            x: 20,
            y: 0,
            z: 10,
        ...
        const { buttonMesh: h } = $i("EXPLORE THE MISSION WEBSITE", s, a, 0.7, r, () => {
  ...
  function ZE(r, e, t, n) {
    return new Promise((i, s) => {
      ...
      try {
        Pr("Surface Slice", ut("res/models/PsycheSlice.glb"), l, 1.4, u, null, r, () => {
          console.log("loaded model");
        }), $i("Explore the Surface of Psyche", a, c, 0.7, r, () => {
          window.open(ut("/PsycheJR/surface2.html")), console.log("Surface button clicked.");
        }).then(({ textMesh: h, buttonMesh: f }) => {
          const d = f.material.emissive.clone(), _ = f.material.emissiveIntensity, g = new Rr(), m = new ee();
        }), i();
      } catch (h) {
  ...
  function QE(r, e, t, n) {
    ...
    return new Promise((c, u) => {
      try {
        Pr("location pin", ut("res/models/navigation_pin.glb"), o, 1, l, {
          rotation: {
            x: 0,
            y: -40,
            z: 0,
        ...
        const { buttonMesh: h } = $i("EXPLORE PSYCHE'S LOCATION", s, a, 0.7, r, () => {
          FE(), console.log("Location button clicked.");
        });
        dm(h, {
          color: "#ff9900",
          intensity: 2
  ...
  function tb(r, e, t, n) {
    return new Promise((i, s) => {
      try {
        const o = new wr(40, 20, 5), a = new Gn({
          color: 31743,
          transparent: false
        }), l = new Rt(o, a);
        ...
        const f = new b_(u), d = new Gn({
          map: f,
          transparent: true
        }), _ = new bo(50, 25), g = new Rt(_, d);
        g.position.set(200, 300, -107), g.userData.section9Element = true, r.add(g), c.push(g);
        const m = new Pu(16777215, 2, 200);
        ...
        p.userData.section9Element = true, r.add(p), c.push(p), ru(l, () => {
          su(async () => {
            const { showEscapeVelocityViewport: v } = await import("./viewportescapevelocity-BDSMG8Kw.js");
            return {
  ...
  function nb(r, e) {
    ...
    _d.forEach((i) => {
      ...
      showEscapeVelocityViewport(), ua = true;
    }, 500) : !n && ua && (hideEscapeVelocityViewport(), ua = false);
  }
  const Am = {
    name: "CopyShader",
    uniforms: {
  ...
  class Rm {
    constructor(e) {
      this._mesh = new Rt(sb, e);
    }
    dispose() {
      this._mesh.geometry.dispose();
    }
    render(e) {
      e.render(this._mesh, ib);
    }
    get material() {
  ...
  class ob extends Co {
    constructor(e, t) {
      super(), this.textureID = t !== void 0 ? t : "tDiffuse", e instanceof Gt ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = Ca.clone(e.uniforms), this.material = new Gt({
  ...
  class lb {
    constructor(e, t) {
      ...
      this.renderTarget1 = t, this.renderTarget2 = t.clone(), this.renderTarget2.texture.name = "EffectComposer.rt2", this.writeBuffer = this.renderTarget1, this.readBuffer = this.renderTarget2, this.renderToScreen = true, this.passes = [], this.copyPass = new ob(Am), this.copyPass.material.blending = xi, this.clock = new w0();
    }
    swapBuffers() {
    ...
    render(e) {
      ...
      for (let i = 0, s = this.passes.length; i < s; i++) {
        ...
        if (o.enabled !== false) {
          ...
          xd !== void 0 && (o instanceof xd ? n = true : o instanceof ab && (n = false));
        }
      }
  ...
  class ws extends Co {
    constructor(e, t, n, i) {
      ...
      const a = ub;
      this.highPassUniforms = Ca.clone(a.uniforms), this.highPassUniforms.luminosityThreshold.value = i, this.highPassUniforms.smoothWidth.value = 0.01, this.materialHighPassFilter = new Gt({
      ...
      const u = Am;
      this.copyUniforms = Ca.clone(u.uniforms), this.blendMaterial = new Gt({
        ...
        depthWrite: false,
        transparent: true
      }), this.enabled = true, this.needsSwap = false, this._oldClearColor = new Re(), this.oldClearAlpha = 1, this.basic = new Gn(), this.fsQuad = new Rm(null);
    }
    dispose() {
  ...
  function fb(r, e, t, n = 2) {
    const i = new Au(6, 32, 32), s = new wo({
      emissive: new Re(16777164),
      emissiveIntensity: 3,
      roughness: 0.1
    }), o = new Rt(i, s);
    o.position.set(-400, 250, -900), r.add(o);
    const a = new Pu(16755200, 10, 500);
    a.position.copy(o.position), r.add(a);
    const l = new lb(e);
    l.addPass(new cb(r, t));
    const c = new ws(new ee(window.innerWidth, window.innerHeight), n, 0.5, 1);
  ...
  function db(r) {
    ...
    function n() {
      ...
      for (let c = -3; c <= l; c++) {
        ...
        f.className = "carousel-item", f.textContent = r[u].name, c === 0 ? f.classList.add("active") : (f.style.opacity = `${1 - h * 0.2}`, f.style.transform = `scale(${1 - h * 0.05})`), f.addEventListener("click", async () => {
          Ea() || (Bn(true), await Ks(u, r[u].position), t = u, n(), Bn(false));
        }), e.appendChild(f);
      }
    }
    window.addEventListener("keydown", async (l) => {
      if (!Ea()) {
        if (l.key === "ArrowDown") {
          const c = (t + 1) % r.length;
          Bn(true), await Ks(c, r[c].position), t = c, n(), Bn(false);
        } else if (l.key === "ArrowUp") {
          const c = (t - 1 + r.length) % r.length;
          Bn(true), await Ks(c, r[c].position), t = c, n(), Bn(false);
        }
      }
    });
    ...
    o.id = "ref-label", o.textContent = "REFERENCES", o.style.fontSize = "0.9rem", o.style.fontWeight = "bold", o.style.fontFamily = "sans-serif", o.style.color = "#fff", o.style.opacity = "0", o.style.transform = "translateX(-10px)", o.style.transition = "opacity 0.3s ease, transform 0.3s ease", o.style.whiteSpace = "nowrap", i.appendChild(s), i.appendChild(o), document.body.appendChild(i), i.addEventListener("mouseenter", () => {
      ...
      Ea() || (Bn(true), await Ks(0, r[0].position), t = 0, n(), Bn(false));
    }), n();
    function a() {
      const l = Xi();
  ...
  function gb() {
    ...
    db(e);
    const t = new p_(), n = new $t(75, window.innerWidth / window.innerHeight, 0.1, 5e3);
    ...
    t.add(s);
    const o = new Da(10264748, 3);
    o.position.set(-15, 5, 5), t.add(o), VE(n, e, i);
    ...
    function d() {
      switch (requestAnimationFrame(d), h.hidden || f(), _ ? _.render() : i.render(t, n), Xi()) {
        case 3:
          $E(n, t);
          break;
        case 4:
    ...
    g.forEach((S, v) => {
      S.then(() => {
        ...
        const x = m / p * 100;
        r.style.width = `${x}%`, m === p && (console.log("All sections loaded."), hb(t, {
          density: c
        }), yE(n, i), GE(), d(), _b(), document.getElementById("cn-icon-wrapper").style.display = "flex");
      }).catch((x) => {
  ...
  xb();
  window._hasUnifiedMouseMoveListener || (window.addEventListener("mousemove", (r) => onMouseMove(r, pb, mb)), window._hasUnifiedMouseMoveListener = true);
  gb();
  function xb() {

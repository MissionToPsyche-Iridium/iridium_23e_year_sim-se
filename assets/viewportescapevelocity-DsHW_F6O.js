import { g as c, m as p } from "./index-CZhFkIMp.js";
...
function f() {
  ...
  console.log("Creating escape velocity viewport"), e = document.createElement("div"), e.id = "escape-velocity-viewport-container", e.style.position = "fixed", e.style.top = "50%", e.style.left = "50%", e.style.transform = "translate(-50%, -50%)", e.style.width = "80%", e.style.maxWidth = "1440px", e.style.height = "80vh", e.style.backgroundColor = "rgba(0, 0, 0, 0.9)", e.style.border = "2px solid #007bff", e.style.borderRadius = "10px", e.style.boxShadow = "0 0 20px rgba(0, 123, 255, 0.5)", e.style.zIndex = "900", e.style.display = "flex", e.style.flexDirection = "column", e.style.overflow = "hidden";
  ...
  r.from(e, { opacity: 0, scale: 0.8, duration: 0.4, ease: "power2.out" }), r.from(t, { y: -50, duration: 0.3, ease: "back.out(1.7)" }, "-=0.2"), r.from(n, { opacity: 0, y: 20, duration: 0.3, ease: "power2.out" }, "-=0.1"), o.addEventListener("click", a), l.addEventListener("click", function(d) {
    d.preventDefault(), d.stopPropagation(), i.textContent = "Psyche Mission Games", n.src = "./games/games.html", console.log("Loading games HTML in escape velocity viewport");
  }), document.addEventListener("keydown", y), setTimeout(p, 100);
}
function a() {
  e && c.to(e, { opacity: 0, scale: 0.8, duration: 0.3, ease: "power2.in", onComplete: () => {
    u(), document.body.classList.add("overlay-open");
  } });
}
function y(t) {
  t.key === "Escape" && a();
...
function u() {
  e && (o.removeEventListener("click", a), document.removeEventListener("keydown", y), document.body.removeChild(e), e = null, n = null, o = null);
}
export {
  u as destroyEscapeVelocityViewport,
  a as hideEscapeVelocityViewport,
  f as showEscapeVelocityViewport
};
